...
var Outfit = /*#__PURE__*/function () {
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function _dress(refreshed) {
      ...
      for (var _i5 = 0, _arr2 = [[$slot(_templateObject51 || (_templateObject51 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), template_string_$item(_templateObject52 || (_templateObject52 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))), external_kolmafia_namespaceObject.myBjornedFamiliar], [$slot(_templateObject53 || (_templateObject53 = outfit_taggedTemplateLiteral(["crown-of-thrones"]))), template_string_$item(_templateObject54 || (_templateObject54 = outfit_taggedTemplateLiteral(["Crown of Thrones"]))), external_kolmafia_namespaceObject.myEnthronedFamiliar]]; _i5 < _arr2.length; _i5++) {
...
function oomfieOutfit(options) {
  ...
  if (options !== null && options !== void 0 && options.modifier) {
    var _options$hatOverride, _options$backOverride, _options$shirtOverrid, _options$weaponOverri, _options$offhandOverr, _options$pantsOverrid, _options$acc1Override, _options$acc2Override, _options$acc3Override, _ref, _famOverride, _options$famequipOver, _options$modesOverrid;
    return {
      ...
      famequip: (_options$famequipOver = options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _options$famequipOver !== void 0 ? _options$famequipOver : template_string_$item(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
    ...
    var _options$hatOverride2, _options$backOverride2, _options$shirtOverrid2, _options$weaponOverri2, _options$offhandOverr2, _options$pantsOverrid2, _options$acc1Override2, _options$acc2Override2, _options$acc3Override2, _ref2, _famOverride2, _options$famequipOver2, _options$modesOverrid2;
    return {
      hat: (_options$hatOverride2 = options === null || options === void 0 ? void 0 : options.hatOverride) !== null && _options$hatOverride2 !== void 0 ? _options$hatOverride2 : template_string_$item(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
      back: (_options$backOverride2 = options === null || options === void 0 ? void 0 : options.backOverride) !== null && _options$backOverride2 !== void 0 ? _options$backOverride2 : template_string_$item(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      shirt: (_options$shirtOverrid2 = options === null || options === void 0 ? void 0 : options.shirtOverride) !== null && _options$shirtOverrid2 !== void 0 ? _options$shirtOverrid2 : template_string_$item(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["Jurassic Parka"]))),
      weapon: (_options$weaponOverri2 = options === null || options === void 0 ? void 0 : options.weaponOverride) !== null && _options$weaponOverri2 !== void 0 ? _options$weaponOverri2 : template_string_$item(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["June cleaver"]))),
      offhand: (_options$offhandOverr2 = options === null || options === void 0 ? void 0 : options.offhandOverride) !== null && _options$offhandOverr2 !== void 0 ? _options$offhandOverr2 : template_string_$item(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["unbreakable umbrella"]))),
      pants: (_options$pantsOverrid2 = options === null || options === void 0 ? void 0 : options.pantsOverride) !== null && _options$pantsOverrid2 !== void 0 ? _options$pantsOverrid2 : template_string_$item(lib_templateObject17 || (lib_templateObject17 = lib_taggedTemplateLiteral(["designer sweatpants"]))),
      acc1: (_options$acc1Override2 = options === null || options === void 0 ? void 0 : options.acc1Override) !== null && _options$acc1Override2 !== void 0 ? _options$acc1Override2 : template_string_$item(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["backup camera"]))),
      acc2: (_options$acc2Override2 = options === null || options === void 0 ? void 0 : options.acc2Override) !== null && _options$acc2Override2 !== void 0 ? _options$acc2Override2 : template_string_$item(lib_templateObject19 || (lib_templateObject19 = lib_taggedTemplateLiteral(["your cowboy boots"]))),
      acc3: (_options$acc3Override2 = options === null || options === void 0 ? void 0 : options.acc3Override) !== null && _options$acc3Override2 !== void 0 ? _options$acc3Override2 : template_string_$item(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["combat lover's locket"]))),
      familiar: (_ref2 = (_famOverride2 = famOverride) !== null && _famOverride2 !== void 0 ? _famOverride2 : options === null || options === void 0 ? void 0 : options.familiarOverride) !== null && _ref2 !== void 0 ? _ref2 : familiarChoice(),
      famequip: (_options$famequipOver2 = options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _options$famequipOver2 !== void 0 ? _options$famequipOver2 : template_string_$item(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
...
var runStartQuest = {
  ...
  tasks: [loss, {
    ...
    completed: () => have(template_string_$item(preSkeletons_templateObject7 || (preSkeletons_templateObject7 = preSkeletons_taggedTemplateLiteral(["your cowboy boots"])))),
    do: () => {
    ...
    completed: () => !have(template_string_$item(preSkeletons_templateObject8 || (preSkeletons_templateObject8 = preSkeletons_taggedTemplateLiteral(["letter from King Ralph XI"])))) && property_get("questM05Toot") === "finished",
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject9 || (preSkeletons_templateObject9 = preSkeletons_taggedTemplateLiteral(["letter from King Ralph XI"]))))
  }, {
    name: "Get that bag oomfie!!!",
    completed: () => !have(template_string_$item(preSkeletons_templateObject10 || (preSkeletons_templateObject10 = preSkeletons_taggedTemplateLiteral(["pork elf goodies sack"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject11 || (preSkeletons_templateObject11 = preSkeletons_taggedTemplateLiteral(["pork elf goodies sack"]))))
  }, {
    name: "Sell Non-porquoise",
    completed: () => [template_string_$item(preSkeletons_templateObject12 || (preSkeletons_templateObject12 = preSkeletons_taggedTemplateLiteral(["baconstone"]))), template_string_$item(preSkeletons_templateObject13 || (preSkeletons_templateObject13 = preSkeletons_taggedTemplateLiteral(["hamethyst"])))].every(I => !have(I)),
    do: () => [template_string_$item(preSkeletons_templateObject14 || (preSkeletons_templateObject14 = preSkeletons_taggedTemplateLiteral(["baconstone"]))), template_string_$item(preSkeletons_templateObject15 || (preSkeletons_templateObject15 = preSkeletons_taggedTemplateLiteral(["hamethyst"])))].forEach(I => (0,external_kolmafia_namespaceObject.autosell)((0,external_kolmafia_namespaceObject.availableAmount)(I), I))
  }, {
    name: "Sell Porquoise",
    completed: () => !have(template_string_$item(preSkeletons_templateObject16 || (preSkeletons_templateObject16 = preSkeletons_taggedTemplateLiteral(["porquoise"])))) || (0,external_kolmafia_namespaceObject.myMeat)() >= 250,
    do: () => (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(preSkeletons_templateObject17 || (preSkeletons_templateObject17 = preSkeletons_taggedTemplateLiteral(["porquoise"]))))
  }, {
    name: "Acquire Buff Tools",
    completed: () => [template_string_$item(preSkeletons_templateObject18 || (preSkeletons_templateObject18 = preSkeletons_taggedTemplateLiteral(["toy accordion"]))), template_string_$item(preSkeletons_templateObject19 || (preSkeletons_templateObject19 = preSkeletons_taggedTemplateLiteral(["turtle totem"]))), template_string_$item(preSkeletons_templateObject20 || (preSkeletons_templateObject20 = preSkeletons_taggedTemplateLiteral(["saucepan"])))].every(i => have(i)),
    do: () => [template_string_$item(preSkeletons_templateObject21 || (preSkeletons_templateObject21 = preSkeletons_taggedTemplateLiteral(["toy accordion"]))), template_string_$item(preSkeletons_templateObject22 || (preSkeletons_templateObject22 = preSkeletons_taggedTemplateLiteral(["turtle totem"]))), template_string_$item(preSkeletons_templateObject23 || (preSkeletons_templateObject23 = preSkeletons_taggedTemplateLiteral(["saucepan"])))].forEach(i => (0,external_kolmafia_namespaceObject.retrieveItem)(i)),
    outfit: {
      pants: template_string_$item(preSkeletons_templateObject24 || (preSkeletons_templateObject24 = preSkeletons_taggedTemplateLiteral(["designer sweatpants"])))
    }
  }, {
    name: "Open Astral Drinks",
    completed: () => !have(template_string_$item(preSkeletons_templateObject25 || (preSkeletons_templateObject25 = preSkeletons_taggedTemplateLiteral(["astral six-pack"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject26 || (preSkeletons_templateObject26 = preSkeletons_taggedTemplateLiteral(["astral six-pack"]))))
  }, {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(preSkeletons_templateObject27 || (preSkeletons_templateObject27 = preSkeletons_taggedTemplateLiteral(["borrowed time"]))));
      (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(preSkeletons_templateObject28 || (preSkeletons_templateObject28 = preSkeletons_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    }
  }, {
    name: "Borrow Time",
    completed: () => property_get("_borrowedTimeUsed"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject29 || (preSkeletons_templateObject29 = preSkeletons_taggedTemplateLiteral(["borrowed time"]))))
  }, {
    name: "Mummery",
    completed: () => property_get("_mummeryUses") !== "",
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject30 || (preSkeletons_templateObject30 = preSkeletons_taggedTemplateLiteral(["mumming trunk"])))),
    choices: {
      1071: 3
    },
    outfit: () => oomfieOutfit()
    ...
    completed: () => have(template_string_$item(preSkeletons_templateObject31 || (preSkeletons_templateObject31 = preSkeletons_taggedTemplateLiteral(["ebony epee"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.visitUrl)("shop.php?whichshop=lathe");
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(preSkeletons_templateObject32 || (preSkeletons_templateObject32 = preSkeletons_taggedTemplateLiteral(["ebony epee"]))));
    }
  }, {
    name: "DRINKME",
...
var skeletonsQuest = {
  ...
  tasks: [loss, {
    ...
    post: () => {
      if (have($effect(skeletons_templateObject3 || (skeletons_templateObject3 = skeletons_taggedTemplateLiteral(["Beaten Up"]))))) {
        uneffect($effect(skeletons_templateObject4 || (skeletons_templateObject4 = skeletons_taggedTemplateLiteral(["Beaten Up"]))));
      }
    }
  }, {
    ...
    do: () => guildZone,
    post: () => {
      if (have($effect(skeletons_templateObject5 || (skeletons_templateObject5 = skeletons_taggedTemplateLiteral(["Beaten Up"])))) && !have(template_string_$item(skeletons_templateObject6 || (skeletons_templateObject6 = skeletons_taggedTemplateLiteral(["magical sausage casing"]))))) {
        (0,external_kolmafia_namespaceObject.abort)("Died on first sosig attempt?");
      }
    },
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(skeletons_templateObject7 || (skeletons_templateObject7 = skeletons_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      modesOverride: {
        parka: "kachungasaur",
        backupcamera: "init"
      }
    ...
    name: "Red Skeleton",
    prepare: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject8 || (skeletons_templateObject8 = skeletons_taggedTemplateLiteral(["red rocket"])))),
    completed: () => property_get("lastCopyableMonster") === $monster(skeletons_templateObject9 || (skeletons_templateObject9 = skeletons_taggedTemplateLiteral(["red skeleton"]))) || property_get("_locketMonstersFought").includes("1521"),
    do: () => {
      reminisce($monster(skeletons_templateObject10 || (skeletons_templateObject10 = skeletons_taggedTemplateLiteral(["red skeleton"]))));
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(skeletons_templateObject11 || (skeletons_templateObject11 = skeletons_taggedTemplateLiteral(["Feel Hatred"])))).abort())
  }, {
    name: "Novelty Tropical Skeleton",
    ready: () => property_get("lastCopyableMonster") === $monster(skeletons_templateObject12 || (skeletons_templateObject12 = skeletons_taggedTemplateLiteral(["red skeleton"]))),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have($effect(skeletons_templateObject13 || (skeletons_templateObject13 = skeletons_taggedTemplateLiteral(["Everything Looks Yellow"])))) && have(template_string_$item(skeletons_templateObject14 || (skeletons_templateObject14 = skeletons_taggedTemplateLiteral(["cherry"])))),
    do: () => {
      mapMonster($location(skeletons_templateObject15 || (skeletons_templateObject15 = skeletons_taggedTemplateLiteral(["The Skeleton Store"]))), $monster(skeletons_templateObject16 || (skeletons_templateObject16 = skeletons_taggedTemplateLiteral(["novelty tropical skeleton"]))));
    },
    combat: new CombatStrategy().macro(Macro.tryItem(template_string_$item(skeletons_templateObject17 || (skeletons_templateObject17 = skeletons_taggedTemplateLiteral(["red rocket"])))).trySkill(template_string_$skill(skeletons_templateObject18 || (skeletons_templateObject18 = skeletons_taggedTemplateLiteral(["Feel Nostalgic"])))).trySkill(template_string_$skill(skeletons_templateObject19 || (skeletons_templateObject19 = skeletons_taggedTemplateLiteral(["Spit jurassic acid"])))).abort()),
    outfit: {
      offhand: template_string_$item(skeletons_templateObject20 || (skeletons_templateObject20 = skeletons_taggedTemplateLiteral(["latte lovers member's mug"]))),
      shirt: template_string_$item(skeletons_templateObject21 || (skeletons_templateObject21 = skeletons_taggedTemplateLiteral(["Jurassic Parka"]))),
      acc1: template_string_$item(skeletons_templateObject22 || (skeletons_templateObject22 = skeletons_taggedTemplateLiteral(["backup camera"]))),
      modes: {
        parka: "dilophosaur",
        backupcamera: "ml"
      }
    ...
    name: "Red May Day",
    completed: () => [template_string_$item(skeletons_templateObject23 || (skeletons_templateObject23 = skeletons_taggedTemplateLiteral(["red box"]))), template_string_$item(skeletons_templateObject24 || (skeletons_templateObject24 = skeletons_taggedTemplateLiteral(["MayDay\u2122 supply package"])))].every(i => !have(i)),
    do: () => {
      [template_string_$item(skeletons_templateObject25 || (skeletons_templateObject25 = skeletons_taggedTemplateLiteral(["red box"]))), template_string_$item(skeletons_templateObject26 || (skeletons_templateObject26 = skeletons_taggedTemplateLiteral(["MayDay\u2122 supply package"])))].forEach(i => (0,external_kolmafia_namespaceObject.use)(1, i));
      if (have(template_string_$item(skeletons_templateObject27 || (skeletons_templateObject27 = skeletons_taggedTemplateLiteral(["space blanket"]))))) {
        (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(skeletons_templateObject28 || (skeletons_templateObject28 = skeletons_taggedTemplateLiteral(["space blanket"]))));
      }
    }
  }, {
    name: "Purchase Fireworks Hat",
    completed: () => have(template_string_$item(skeletons_templateObject29 || (skeletons_templateObject29 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject30 || (skeletons_templateObject30 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))))
  }, {
    name: "Guild Unlock",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished" || args.fam,
    do: guildZone,
    outfit: {
      offhand: template_string_$item(skeletons_templateObject31 || (skeletons_templateObject31 = skeletons_taggedTemplateLiteral(["latte lovers member's mug"]))),
      hat: template_string_$item(skeletons_templateObject32 || (skeletons_templateObject32 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      familiar: template_string_$familiar(skeletons_templateObject33 || (skeletons_templateObject33 = skeletons_taggedTemplateLiteral(["Pair of Stomping Boots"]))),
      famequip: template_string_$item(skeletons_templateObject34 || (skeletons_templateObject34 = skeletons_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        parka: "spikolodon"
      }
    },
    combat: new CombatStrategy().macro(Macro.runaway().abort()),
    effects: [$effect(skeletons_templateObject35 || (skeletons_templateObject35 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject36 || (skeletons_templateObject36 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), $effect(skeletons_templateObject37 || (skeletons_templateObject37 = skeletons_taggedTemplateLiteral(["Empathy"]))), $effect(skeletons_templateObject38 || (skeletons_templateObject38 = skeletons_taggedTemplateLiteral(["Blood Bond"])))]
  }, {
    name: "Guild Unlock (100% Familiar)",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished",
    do: () => guildZone,
    effects: [$effect(skeletons_templateObject39 || (skeletons_templateObject39 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject40 || (skeletons_templateObject40 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"])))],
    outfit: () => ({
      offhand: template_string_$item(skeletons_templateObject41 || (skeletons_templateObject41 = skeletons_taggedTemplateLiteral(["latte lovers member's mug"]))),
      hat: template_string_$item(skeletons_templateObject42 || (skeletons_templateObject42 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      acc1: property_get("_reflexHammerUsed") >= 3 ? template_string_$item(skeletons_templateObject43 || (skeletons_templateObject43 = skeletons_taggedTemplateLiteral(["backup camera"]))) : template_string_$item(skeletons_templateObject44 || (skeletons_templateObject44 = skeletons_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
      familiar: args.familiar,
    ...
    combat: new CombatStrategy().macro(() => Macro.externalIf(property_get("_reflexHammerUsed") < 3, Macro.trySkill(template_string_$skill(skeletons_templateObject46 || (skeletons_templateObject46 = skeletons_taggedTemplateLiteral(["Reflex Hammer"]))))).trySkill(template_string_$skill(skeletons_templateObject47 || (skeletons_templateObject47 = skeletons_taggedTemplateLiteral(["Feel Hatred"])))).abort())
  }, {
    name: "Cemetery Unlock",
    completed: () => (0,external_kolmafia_namespaceObject.canAdventure)($location(skeletons_templateObject48 || (skeletons_templateObject48 = skeletons_taggedTemplateLiteral(["The Unquiet Garves"])))),
    do: () => {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject49 || (skeletons_templateObject49 = skeletons_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(skeletons_templateObject50 || (skeletons_templateObject50 = skeletons_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.adv1)($location(skeletons_templateObject51 || (skeletons_templateObject51 = skeletons_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
      ensureEffect($effect(skeletons_templateObject52 || (skeletons_templateObject52 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(skeletons_templateObject53 || (skeletons_templateObject53 = skeletons_taggedTemplateLiteral(["distilled fortified wine"]))));
      uneffect($effect(skeletons_templateObject54 || (skeletons_templateObject54 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
    }
  }]
};
...
var levellingQuest = {
  ...
  tasks: [loss, {
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject85 || (_templateObject85 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Angry Agate",
    ...
    ready: () => have($effect(_templateObject94 || (_templateObject94 = levelling_taggedTemplateLiteral(["Everything Looks Red"])))),
    completed: () => property_get("pizzaOfLegendEaten") && property_get("calzoneOfLegendEaten") || !have(template_string_$item(_templateObject95 || (_templateObject95 = levelling_taggedTemplateLiteral(["Pizza of Legend"])))) && !have(template_string_$item(_templateObject96 || (_templateObject96 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))),
    do: () => [template_string_$item(_templateObject97 || (_templateObject97 = levelling_taggedTemplateLiteral(["Pizza of Legend"]))), template_string_$item(_templateObject98 || (_templateObject98 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))].forEach(i => (0,external_kolmafia_namespaceObject.eat)(1, i))
  }, {
    name: "Lyle Buff",
    ...
    completed: () => have(template_string_$item(_templateObject99 || (_templateObject99 = levelling_taggedTemplateLiteral(["Catherine Wheel"])))) || have(template_string_$item(_templateObject100 || (_templateObject100 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject101 || (_templateObject101 = levelling_taggedTemplateLiteral(["Catherine Wheel"]))))
  }, {
    name: "Boxing Daycare Buff",
    completed: () => [$effect(_templateObject102 || (_templateObject102 = levelling_taggedTemplateLiteral(["Muddled"]))), $effect(_templateObject103 || (_templateObject103 = levelling_taggedTemplateLiteral(["Ten out of Ten"]))), $effect(_templateObject104 || (_templateObject104 = levelling_taggedTemplateLiteral(["Uncucumbered"])))].some(ef => have(ef)) || property_get("_daycareSpa"),
    ...
    completed: () => !args.fam || have($effect(_templateObject105 || (_templateObject105 = levelling_taggedTemplateLiteral(["A Contender"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect A Contender")
  }, {
    name: "Wish for New and Improved",
    completed: () => have($effect(_templateObject106 || (_templateObject106 = levelling_taggedTemplateLiteral(["New and Improved"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect New and Improved")
  }, {
    name: "Use Market Consumables",
    completed: () => [$effect(_templateObject107 || (_templateObject107 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject108 || (_templateObject108 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject109 || (_templateObject109 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].every(ef => have(ef)),
    do: () => [$effect(_templateObject110 || (_templateObject110 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject111 || (_templateObject111 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject112 || (_templateObject112 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].forEach(ef => ensureEffect(ef, 9))
  }, {
    name: "Use Wasabi Marble Soda",
    completed: () => !have(template_string_$item(_templateObject113 || (_templateObject113 = levelling_taggedTemplateLiteral(["wasabi marble soda"])))) || have($effect(_templateObject114 || (_templateObject114 = levelling_taggedTemplateLiteral(["Wasabi With You"])))),
    ...
    name: "Eat sosig",
    ready: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject116 || (_templateObject116 = levelling_taggedTemplateLiteral(["magical sausage casing"])))) > 0,
    completed: () => property_get("_sausagesEaten") > 0,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject117 || (_templateObject117 = levelling_taggedTemplateLiteral(["magical sausage"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject118 || (_templateObject118 = levelling_taggedTemplateLiteral(["magical sausage"]))));
    }
  }, {
    name: "Summon Reagents",
    completed: () => property_get("reagentSummons") > 0,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject119 || (_templateObject119 = levelling_taggedTemplateLiteral(["Advanced Saucecrafting"]))))
  }, {
    name: "Summon Limes",
    completed: () => property_get("_preventScurvy"),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject120 || (_templateObject120 = levelling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))
  }, {
    name: "Become Occultic",
    completed: () => have($effect(_templateObject121 || (_templateObject121 = levelling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject122 || (_templateObject122 = levelling_taggedTemplateLiteral(["ointment of the occult"]))));
      ensureEffect($effect(_templateObject123 || (_templateObject123 = levelling_taggedTemplateLiteral(["Mystically Oiled"]))));
    }
  }, {
    name: "Become Phorceful",
    completed: () => have($effect(_templateObject124 || (_templateObject124 = levelling_taggedTemplateLiteral(["Phorcefullness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject125 || (_templateObject125 = levelling_taggedTemplateLiteral(["philter of phorce"]))));
      ensureEffect($effect(_templateObject126 || (_templateObject126 = levelling_taggedTemplateLiteral(["Phorcefullness"]))));
    }
  }, {
    name: "Stabilize your Oils",
    completed: () => have($effect(_templateObject127 || (_templateObject127 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject128 || (_templateObject128 = levelling_taggedTemplateLiteral(["oil of stability"]))));
      ensureEffect($effect(_templateObject129 || (_templateObject129 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"]))));
    }
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 1000 || property_get("_latteRefillsUsed") >= 2 || have($effect(_templateObject130 || (_templateObject130 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject131 || (_templateObject131 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      if (property_get("_latteDrinkUsed")) {
        fill("pumpkin", "cinnamon", "vanilla");
      }
    },
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject132 || (_templateObject132 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modifier: "mp"
    }),
    effects: [$effect(_templateObject133 || (_templateObject133 = levelling_taggedTemplateLiteral(["Big"]))), $effect(_templateObject134 || (_templateObject134 = levelling_taggedTemplateLiteral(["Song of Bravado"]))), $effect(_templateObject135 || (_templateObject135 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject136 || (_templateObject136 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject137 || (_templateObject137 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject138 || (_templateObject138 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))],
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject139 || (_templateObject139 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject140 || (_templateObject140 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 1000 || property_get("_latteRefillsUsed") >= 2,
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject141 || (_templateObject141 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      //Latte.fill(`pumpkin`, `cinnamon`, `vanilla`);
    },

    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject142 || (_templateObject142 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modesOverride: {
        parka: "spikolodon",
        backupcamera: "ml",
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject143 || (_templateObject143 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject144 || (_templateObject144 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    name: "Remove Bloodsugar",
    completed: () => !have($effect(_templateObject145 || (_templateObject145 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have($effect(_templateObject146 || (_templateObject146 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject147 || (_templateObject147 = levelling_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))))
  }, {
    name: "Flapper Mapper",
    completed: () => property_get("_monstersMapped") >= 2 || have(template_string_$item(_templateObject148 || (_templateObject148 = levelling_taggedTemplateLiteral(["imported taffy"])))),
    do: () => mapMonster($location(_templateObject149 || (_templateObject149 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject150 || (_templateObject150 = levelling_taggedTemplateLiteral(["goblin flapper"])))),
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject151 || (_templateObject151 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject152 || (_templateObject152 = levelling_taggedTemplateLiteral(["Feel Envy"])))).attack().repeat())
  }, {
    name: "Oliver's Place (Nanorhino)",
    completed: () => property_get("_speakeasyFreeFights") >= 3 || !have(template_string_$familiar(_templateObject153 || (_templateObject153 = levelling_taggedTemplateLiteral(["Nanorhino"])))) || [$effect(_templateObject154 || (_templateObject154 = levelling_taggedTemplateLiteral(["Nanobrawny"]))), $effect(_templateObject155 || (_templateObject155 = levelling_taggedTemplateLiteral(["Nanobrainy"])))].some(ef => have(ef)),
    do: () => $location(_templateObject156 || (_templateObject156 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject157 || (_templateObject157 = levelling_taggedTemplateLiteral(["Nanorhino"])))
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject158 || (_templateObject158 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject159 || (_templateObject159 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"])))).attack().repeat())
  }, {
    name: "Oliver's Place",
    completed: () => property_get("_speakeasyFreeFights") === 3,
    do: $location(_templateObject160 || (_templateObject160 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject161 || (_templateObject161 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Pick up a club!",
    completed: () => args.fam || have(template_string_$item(_templateObject162 || (_templateObject162 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))))
  }, {
    name: "Seal Fights",
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject165 || (_templateObject165 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(3, template_string_$item(_templateObject166 || (_templateObject166 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject167 || (_templateObject167 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
    },
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject168 || (_templateObject168 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject169 || (_templateObject169 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Get Payphone Quest",
    completed: () => property_get("_shadowAffinityToday"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject170 || (_templateObject170 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 1
    }
  }, {
    name: "Payphone Freefights (extingo)",
    ready: () => have($effect(_templateObject171 || (_templateObject171 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject172 || (_templateObject172 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_fireExtinguisherCharge") <= 10,
    do: shadowRiftChoice,
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject173 || (_templateObject173 = levelling_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().macro(() => customMacro.if_(shadowRiftPocketTarget(), customMacro.polarpocket(9).trySkill(template_string_$skill(_templateObject174 || (_templateObject174 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).trySkill(template_string_$skill(_templateObject175 || (_templateObject175 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Payphone Freefights (cleaver)",
    ready: () => have($effect(_templateObject176 || (_templateObject176 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject177 || (_templateObject177 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject178 || (_templateObject178 = levelling_taggedTemplateLiteral(["Sing Along"])))).if_(shadowRiftPocketTarget(), Macro.trySkill(template_string_$skill(_templateObject179 || (_templateObject179 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).attack().repeat())
  }, {
    name: "Payphone Freefights (bossa)",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    ready: () => property_get("encountersUntilSRChoice") === 0,
    completed: () => have(template_string_$item(_templateObject180 || (_templateObject180 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("questRufus") === "step1",
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject181 || (_templateObject181 = levelling_taggedTemplateLiteral(["Machine Elf"])))
    }),
    combat: new CombatStrategy().macro(Macro.if_($monster(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["shadow matrix"]))), Macro.trySkill(template_string_$skill(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkillRepeat(template_string_$skill(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["Saucegeyser"]))))).trySkillRepeat(template_string_$skill(_templateObject185 || (_templateObject185 = levelling_taggedTemplateLiteral(["Northern Explosion"])))))
  }, {
    name: "Retrieve Spooky Lodestone",
    ready: () => property_get("questRufus") === "step1",
    completed: () => have(template_string_$item(_templateObject186 || (_templateObject186 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject187 || (_templateObject187 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    post: () => (0,external_kolmafia_namespaceObject.cliExecute)("fold garbage shirt")
  }, {
    name: "Set Snojo Controls",
    completed: () => property_get("snojoSetting") === $stat(_templateObject188 || (_templateObject188 = levelling_taggedTemplateLiteral(["Moxie"]))),
    do: () => {
    ...
    do: $location(_templateObject189 || (_templateObject189 = levelling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject190 || (_templateObject190 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject191 || (_templateObject191 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject192 || (_templateObject192 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Visit Hottub",
    completed: () => [$effect(_templateObject193 || (_templateObject193 = levelling_taggedTemplateLiteral(["Snowballed"]))), $effect(_templateObject194 || (_templateObject194 = levelling_taggedTemplateLiteral(["Bruised"]))), $effect(_templateObject195 || (_templateObject195 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), $effect(_templateObject196 || (_templateObject196 = levelling_taggedTemplateLiteral(["Hypnotized"]))), $effect(_templateObject197 || (_templateObject197 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
    ...
    do: () => fightPiece($monster(_templateObject198 || (_templateObject198 = levelling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject199 || (_templateObject199 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject200 || (_templateObject200 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject201 || (_templateObject201 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Deep Machine Fights",
    completed: () => args.fam && args.familiar !== template_string_$familiar(_templateObject202 || (_templateObject202 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || property_get("_machineTunnelsAdv") >= 5,
    do: () => $location(_templateObject203 || (_templateObject203 = levelling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    outfit: {
      offhand: template_string_$item(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject205 || (_templateObject205 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject206 || (_templateObject206 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "broken"
      }
    },
    combat: new CombatStrategy().macro(() => Macro.externalIf(property_get("lastCopyableMonster") === $monster(_templateObject207 || (_templateObject207 = levelling_taggedTemplateLiteral(["Witchess Bishop"]))), Macro.trySkill(template_string_$skill(_templateObject208 || (_templateObject208 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).if_($monster(_templateObject209 || (_templateObject209 = levelling_taggedTemplateLiteral(["Perceiver of Sensations"]))), Macro.tryItem(template_string_$item(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["abstraction: thought"]))))).if_($monster(_templateObject211 || (_templateObject211 = levelling_taggedTemplateLiteral(["Thinker of Thoughts"]))), Macro.tryItem(template_string_$item(_templateObject212 || (_templateObject212 = levelling_taggedTemplateLiteral(["abstraction: action"]))))).trySkill(template_string_$skill(_templateObject213 || (_templateObject213 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Neverending Free Fights",
    completed: () => property_get("_neverendingPartyFreeTurns") >= 10,
    do: $location(_templateObject214 || (_templateObject214 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().macro(() => Macro.trySkill(template_string_$skill(_templateObject215 || (_templateObject215 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject216 || (_templateObject216 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject217 || (_templateObject217 = levelling_taggedTemplateLiteral(["sausage goblin"]))), Macro.trySkill(template_string_$skill(_templateObject218 || (_templateObject218 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).trySkill(template_string_$skill(_templateObject219 || (_templateObject219 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkillRepeat(template_string_$skill(_templateObject220 || (_templateObject220 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject221 || (_templateObject221 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Witch",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject222 || (_templateObject222 = levelling_taggedTemplateLiteral(["battle broom"])))),
    do: () => fightPiece($monster(_templateObject223 || (_templateObject223 = levelling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject224 || (_templateObject224 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject225 || (_templateObject225 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkillRepeat(template_string_$skill(_templateObject226 || (_templateObject226 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject227 || (_templateObject227 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Queen",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["very pointy crown"])))),
    do: () => fightPiece($monster(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
    ...
    do: $location(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject233 || (_templateObject233 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      weaponOverride: have(template_string_$item(_templateObject234 || (_templateObject234 = levelling_taggedTemplateLiteral(["fish hatchet"])))) ? template_string_$item(_templateObject235 || (_templateObject235 = levelling_taggedTemplateLiteral(["fish hatchet"]))) : template_string_$item(_templateObject236 || (_templateObject236 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      acc2Override: template_string_$item(_templateObject237 || (_templateObject237 = levelling_taggedTemplateLiteral(["Cincho de Mayo"]))),
      modesOverride: {
        umbrella: "broken",
        backupcamera: "ml"
      }
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject238 || (_templateObject238 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject239 || (_templateObject239 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject240 || (_templateObject240 = levelling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject241 || (_templateObject241 = levelling_taggedTemplateLiteral(["Cincho: Confetti Extravaganza"])))).trySkill(template_string_$skill(_templateObject242 || (_templateObject242 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject243 || (_templateObject243 = levelling_taggedTemplateLiteral(["Shattering Punch"])))).abort())
  }, {
    name: "Chest X-rays",
    completed: () => property_get("_chestXRayUsed") >= 3,
    do: $location(_templateObject244 || (_templateObject244 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      acc2: template_string_$item(_templateObject245 || (_templateObject245 = levelling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject246 || (_templateObject246 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject247 || (_templateObject247 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject248 || (_templateObject248 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject249 || (_templateObject249 = levelling_taggedTemplateLiteral(["Chest X-Ray"])))).abort())
  }, {
    name: "Mob-Hit",
    completed: () => property_get("_gingerbreadMobHitUsed"),
    do: $location(_templateObject250 || (_templateObject250 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject251 || (_templateObject251 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject252 || (_templateObject252 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject253 || (_templateObject253 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject254 || (_templateObject254 = levelling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort())
  }]
};
...
var hotres_templateObject, hotres_templateObject2, hotres_templateObject3, hotres_templateObject4, hotres_templateObject5, hotres_templateObject6, hotres_templateObject7, hotres_templateObject8, hotres_templateObject9, hotres_templateObject10, hotres_templateObject11, hotres_templateObject12, hotres_templateObject13;
...
var hotresQuest = {
  ...
  tasks: [{
    ...
    effects: [$effect(hotres_templateObject8 || (hotres_templateObject8 = hotres_taggedTemplateLiteral(["Elemental Saucesphere"]))), $effect(hotres_templateObject9 || (hotres_templateObject9 = hotres_taggedTemplateLiteral(["Feeling Peaceful"]))), $effect(hotres_templateObject10 || (hotres_templateObject10 = hotres_taggedTemplateLiteral(["Astral Shell"]))), $effect(hotres_templateObject11 || (hotres_templateObject11 = hotres_taggedTemplateLiteral(["Blood Bond"]))), $effect(hotres_templateObject12 || (hotres_templateObject12 = hotres_taggedTemplateLiteral(["Empathy"]))), $effect(hotres_templateObject13 || (hotres_templateObject13 = hotres_taggedTemplateLiteral(["Leash of Linguini"])))],
    limit: {
      tries: 1
    }
  }]
...
var wdmgQuest = {
  ...
  tasks: [{
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(wdmg_templateObject6 || (wdmg_templateObject6 = wdmg_taggedTemplateLiteral(["Snokebomb"])))).abort())
  }, {
...
var sdmgQuest = {
  ...
  tasks: [{
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(sdmg_templateObject19 || (sdmg_templateObject19 = sdmg_taggedTemplateLiteral(["Snokebomb"])))).abort())
  }, {
...
var famwtQuest = {
  ...
  tasks: [{
    ...
    name: "\u2665 Rocks",
    ready: () => have(template_string_$item(famwt_templateObject9 || (famwt_templateObject9 = famwt_taggedTemplateLiteral(["lump of loyal latite"])))),
    completed: () => have($effect(famwt_templateObject10 || (famwt_templateObject10 = famwt_taggedTemplateLiteral(["Loyal as a Rock"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject11 || (famwt_templateObject11 = famwt_taggedTemplateLiteral(["lump of loyal latite"]))))
  }, {
    name: "Hatter Buff",
    completed: () =>  true || 0,
    ...
    effects: [$effect(famwt_templateObject15 || (famwt_templateObject15 = famwt_taggedTemplateLiteral(["Empathy"]))), $effect(famwt_templateObject16 || (famwt_templateObject16 = famwt_taggedTemplateLiteral(["Blood Bond"]))), $effect(famwt_templateObject17 || (famwt_templateObject17 = famwt_taggedTemplateLiteral(["Leash of Linguini"])))]
  }]
};
...
var postFinaleQuest = {
  ...
  tasks: [{
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myName)() !== "Moon Moon" || property_get("_gwa_breakfast", false),
