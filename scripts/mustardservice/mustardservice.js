...
var named_references_1 = __webpack_require__(229);
var numeric_unicode_map_1 = __webpack_require__(969);
var surrogate_pairs_1 = __webpack_require__(665);
 ...
 */
var lib_byStat = makeByXFunction(() => (0,external_kolmafia_namespaceObject.myPrimestat)().toString());
/**
...
function route_toPropertyKey(t) { var i = route_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function route_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var BARRELS = template_string_$items(BarrelShrine_templateObject || (BarrelShrine_templateObject = BarrelShrine_taggedTemplateLiteral(["little firkin, normal barrel, big tun, weathered barrel, dusty barrel, disintegrating barrel, moist barrel, rotting barrel, mouldering barrel, barnacled barrel"])));
/**
 * @returns Whether we have the barrel shrine
 */
function BarrelShrine_have() {
  return property_get("barrelShrineUnlocked");
}
/**
...
function smashParty() {
  ...
  var total = sum(BARRELS, availableAmount);
  if (total <= 0) return;
...
function CommunityService_toPropertyKey(t) { var i = CommunityService_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function CommunityService_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var statCommunityServicePredictor = stat => {
  return () => 60 - Math.floor(1 / 30 * ((0,external_kolmafia_namespaceObject.myBuffedstat)(stat) - (0,external_kolmafia_namespaceObject.myBasestat)(thralls.get(stat) === (0,external_kolmafia_namespaceObject.myThrall)() && !have(template_string_$effect(CommunityService_templateObject5 || (CommunityService_templateObject5 = CommunityService_taggedTemplateLiteral(["Expert Oiliness"])))) ? $stat(CommunityService_templateObject6 || (CommunityService_templateObject6 = CommunityService_taggedTemplateLiteral(["mysticality"]))) : stat)));
};
var visitCouncil = () => (0,external_kolmafia_namespaceObject.visitUrl)("council.php");
var baseWeight = () => have(template_string_$effect(CommunityService_templateObject7 || (CommunityService_templateObject7 = CommunityService_taggedTemplateLiteral(["Fidoxene"])))) ? 20 : (0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)());
...
CommunityService_defineProperty(CommunityService, "HP", new _CommunityService(1, "HP", "Donate Blood", () => 60 - Math.floor(((0,external_kolmafia_namespaceObject.myMaxhp)() - (0,external_kolmafia_namespaceObject.myBuffedstat)($stat(CommunityService_templateObject8 || (CommunityService_templateObject8 = CommunityService_taggedTemplateLiteral(["muscle"])))) - 3) / 30), new Requirement(["HP"], {})));
CommunityService_defineProperty(CommunityService, "Muscle", new _CommunityService(2, "Muscle", "Feed The Children", statCommunityServicePredictor($stat(CommunityService_templateObject9 || (CommunityService_templateObject9 = CommunityService_taggedTemplateLiteral(["Muscle"])))), new Requirement(["Muscle"], {})));
CommunityService_defineProperty(CommunityService, "Mysticality", new _CommunityService(3, "Mysticality", "Build Playground Mazes", statCommunityServicePredictor($stat(CommunityService_templateObject10 || (CommunityService_templateObject10 = CommunityService_taggedTemplateLiteral(["Mysticality"])))), new Requirement(["Mysticality"], {})));
CommunityService_defineProperty(CommunityService, "Moxie", new _CommunityService(4, "Moxie", "Feed Conspirators", statCommunityServicePredictor($stat(CommunityService_templateObject11 || (CommunityService_templateObject11 = CommunityService_taggedTemplateLiteral(["Moxie"])))), new Requirement(["Moxie"], {})));
...
CommunityService_defineProperty(CommunityService, "WeaponDamage", new _CommunityService(6, "Weapon Damage", "Reduce Gazelle Population", function () {
  ...
  var multiplier = have(template_string_$effect(CommunityService_templateObject19 || (CommunityService_templateObject19 = CommunityService_taggedTemplateLiteral(["Bow-Legged Swagger"])))) ? 2 : 1;
...
CommunityService_defineProperty(CommunityService, "Noncombat", new _CommunityService(8, "Non-Combat", "Be a Living Statue", function () {
  ...
  var currentFamiliarModifier = -1 * (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Combat Rate", (0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)()) + (0,external_kolmafia_namespaceObject.numericModifier)("Familiar Weight"), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject22 || (CommunityService_templateObject22 = CommunityService_taggedTemplateLiteral(["familiar"])))));
  var newFamiliarModifier = -1 * (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Combat Rate", (0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)()) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects)), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject23 || (CommunityService_templateObject23 = CommunityService_taggedTemplateLiteral(["familiar"])))));
...
CommunityService_defineProperty(CommunityService, "BoozeDrop", new _CommunityService(9, "Item Drop", "Make Margaritas", function () {
  ...
  var familiarItemDrop = (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Item Drop", baseWeight() + (0,external_kolmafia_namespaceObject.weightAdjustment)(), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject24 || (CommunityService_templateObject24 = CommunityService_taggedTemplateLiteral(["familiar"]))))) + mummingBuff - (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject25 || (CommunityService_templateObject25 = CommunityService_taggedTemplateLiteral(["familiar"])))), "Item Drop");
  var familiarBoozeDrop = (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Booze Drop", baseWeight() + (0,external_kolmafia_namespaceObject.weightAdjustment)(), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject26 || (CommunityService_templateObject26 = CommunityService_taggedTemplateLiteral(["familiar"]))))) - (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject27 || (CommunityService_templateObject27 = CommunityService_taggedTemplateLiteral(["familiar"])))), "Booze Drop");
  // Champagne doubling does NOT count for CS, so we undouble
  var multiplier = (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(CommunityService_templateObject28 || (CommunityService_templateObject28 = CommunityService_taggedTemplateLiteral(["broken champagne bottle"])))) && property_get("garbageChampagneCharge") > 0 ? 0.5 : 1;
  // We add 0.001 because the floor function sometimes introduces weird rounding errors
  ...
  preventEquip: template_string_$items(CommunityService_templateObject29 || (CommunityService_templateObject29 = CommunityService_taggedTemplateLiteral(["broken champagne bottle"])))
})));
CommunityService_defineProperty(CommunityService, "HotRes", new _CommunityService(10, "Hot Resistance", "Clean Steam Tunnels", function () {
  var currentFamiliarModifier = (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Hot Resistance", (0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)()) + (0,external_kolmafia_namespaceObject.numericModifier)("Familiar Weight"), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject30 || (CommunityService_templateObject30 = CommunityService_taggedTemplateLiteral(["familiar"])))));
  for (var _len7 = arguments.length, effects = new Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
    effects[_key7] = arguments[_key7];
  }
  var newFamiliarModifier = (0,external_kolmafia_namespaceObject.numericModifier)((0,external_kolmafia_namespaceObject.myFamiliar)(), "Hot Resistance", (0,external_kolmafia_namespaceObject.familiarWeight)((0,external_kolmafia_namespaceObject.myFamiliar)()) + hypotheticalModifier.apply(void 0, ["Familiar Weight"].concat(effects)), (0,external_kolmafia_namespaceObject.equippedItem)($slot(CommunityService_templateObject31 || (CommunityService_templateObject31 = CommunityService_taggedTemplateLiteral(["familiar"])))));
...
CommunityService_defineProperty(CommunityService, "path", $path(CommunityService_templateObject32 || (CommunityService_templateObject32 = CommunityService_taggedTemplateLiteral(["Community Service"]))));
...
function src_lib_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, src_lib_toPropertyKey(descriptor.key), descriptor); } }
function src_lib_createClass(Constructor, protoProps, staticProps) { if (protoProps) src_lib_defineProperties(Constructor.prototype, protoProps); if (staticProps) src_lib_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function src_lib_toPropertyKey(t) { var i = src_lib_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function src_lib_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function src_lib_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function lib_callSuper(t, o, e) { return o = lib_getPrototypeOf(o), lib_possibleConstructorReturn(t, lib_isNativeReflectConstruct() ? Reflect.construct(o, e || [], lib_getPrototypeOf(t).constructor) : o.apply(t, e)); }
...
function lib_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (lib_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var lib_CombatStrategy = /*#__PURE__*/function (_GrimoireCombatStrate) {
  function CombatStrategy() {
    src_lib_classCallCheck(this, CombatStrategy);
    return lib_callSuper(this, CombatStrategy, arguments);
  }
  lib_inherits(CombatStrategy, _GrimoireCombatStrate);
  return src_lib_createClass(CombatStrategy);
}(CombatStrategy);
var customMacro = /*#__PURE__*/function (_Macro) {
  function customMacro() {
    src_lib_classCallCheck(this, customMacro);
    return lib_callSuper(this, customMacro, arguments);
  }
  lib_inherits(customMacro, _Macro);
  return src_lib_createClass(customMacro, [{
    key: "polarpocket",
    value: function polarpocket(pockets) {
      var test = this.trySkill(template_string_$skill(lib_templateObject || (lib_templateObject = lib_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"]))));
      while (pockets > 1) {
        test = test.trySkill(template_string_$skill(lib_templateObject2 || (lib_templateObject2 = lib_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"]))));
        pockets--;
      }
      return test;
    }
...
var loss = {
  name: "Lost Combat!",
  completed: () => property_get("_lastCombatLost") === false,
  do: () => (0,external_kolmafia_namespaceObject.abort)("Lost your most recent combat!")
};
var _byStat = lib_byStat({
    Muscle: {
      guildQuest: "questG09Muscle",
      guildURL: "guild.php?guild=f",
      guildZone: $location(lib_templateObject3 || (lib_templateObject3 = lib_taggedTemplateLiteral(["The Outskirts of Cobb's Knob"])))
    },
    Mysticality: {
      guildQuest: "questG07Myst",
      guildURL: "guild.php?guild=m",
      guildZone: $location(lib_templateObject4 || (lib_templateObject4 = lib_taggedTemplateLiteral(["The Haunted Pantry"])))
    },
    Moxie: {
      guildQuest: "questG08Moxie",
      guildURL: "guild.php?guild=t",
      guildZone: $location(lib_templateObject5 || (lib_templateObject5 = lib_taggedTemplateLiteral(["The Sleazy Back Alley"])))
    }
  }),
...
var barrelItems = [template_string_$item(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["strongness elixir"]))), template_string_$item(lib_templateObject7 || (lib_templateObject7 = lib_taggedTemplateLiteral(["enchanted barbell"]))), template_string_$item(lib_templateObject8 || (lib_templateObject8 = lib_taggedTemplateLiteral(["extra-strength strongness elixir"]))), template_string_$item(lib_templateObject9 || (lib_templateObject9 = lib_taggedTemplateLiteral(["magicalness-in-a-can"]))), template_string_$item(lib_templateObject10 || (lib_templateObject10 = lib_taggedTemplateLiteral(["concentrated magicalness pill"]))), template_string_$item(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["jug-o-magicalness"]))), template_string_$item(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["moxie weed"]))), template_string_$item(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["suntan lotion of moxiousness"]))), template_string_$item(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["bottle of gin"]))), template_string_$item(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["bottle of rum"]))), template_string_$item(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["bottle of tequila"]))), template_string_$item(lib_templateObject17 || (lib_templateObject17 = lib_taggedTemplateLiteral(["bottle of vodka"]))), template_string_$item(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["bottle of whiskey"]))), template_string_$item(lib_templateObject19 || (lib_templateObject19 = lib_taggedTemplateLiteral(["boxed wine"]))), template_string_$item(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["fine wine"]))), template_string_$item(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["shot of grapefruit schnapps"]))), template_string_$item(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["shot of orange schnapps"]))), template_string_$item(lib_templateObject23 || (lib_templateObject23 = lib_taggedTemplateLiteral(["shot of tomato schnapps"]))), template_string_$item(lib_templateObject24 || (lib_templateObject24 = lib_taggedTemplateLiteral(["margarita"]))), template_string_$item(lib_templateObject25 || (lib_templateObject25 = lib_taggedTemplateLiteral(["martini"]))), template_string_$item(lib_templateObject26 || (lib_templateObject26 = lib_taggedTemplateLiteral(["monkey wrench"]))), template_string_$item(lib_templateObject27 || (lib_templateObject27 = lib_taggedTemplateLiteral(["salty dog"]))), template_string_$item(lib_templateObject28 || (lib_templateObject28 = lib_taggedTemplateLiteral(["screwdriver"]))), template_string_$item(lib_templateObject29 || (lib_templateObject29 = lib_taggedTemplateLiteral(["strawberry daiquiri"]))), template_string_$item(lib_templateObject30 || (lib_templateObject30 = lib_taggedTemplateLiteral(["strawberry wine"]))), template_string_$item(lib_templateObject31 || (lib_templateObject31 = lib_taggedTemplateLiteral(["tequila sunrise"]))), template_string_$item(lib_templateObject32 || (lib_templateObject32 = lib_taggedTemplateLiteral(["vodka martini"]))), template_string_$item(lib_templateObject33 || (lib_templateObject33 = lib_taggedTemplateLiteral(["whiskey and soda"]))), template_string_$item(lib_templateObject34 || (lib_templateObject34 = lib_taggedTemplateLiteral(["whiskey sour"]))), template_string_$item(lib_templateObject35 || (lib_templateObject35 = lib_taggedTemplateLiteral(["wine spritzer"]))), template_string_$item(lib_templateObject36 || (lib_templateObject36 = lib_taggedTemplateLiteral(["ducha de oro"]))), template_string_$item(lib_templateObject37 || (lib_templateObject37 = lib_taggedTemplateLiteral(["calle de miel"]))), template_string_$item(lib_templateObject38 || (lib_templateObject38 = lib_taggedTemplateLiteral(["pink pony"]))), template_string_$item(lib_templateObject39 || (lib_templateObject39 = lib_taggedTemplateLiteral(["rockin' wagon"]))), template_string_$item(lib_templateObject40 || (lib_templateObject40 = lib_taggedTemplateLiteral(["roll in the hay"]))), template_string_$item(lib_templateObject41 || (lib_templateObject41 = lib_taggedTemplateLiteral(["slip 'n' slide"]))), template_string_$item(lib_templateObject42 || (lib_templateObject42 = lib_taggedTemplateLiteral(["ocean motion"]))), template_string_$item(lib_templateObject43 || (lib_templateObject43 = lib_taggedTemplateLiteral(["horizontal tango"]))), template_string_$item(lib_templateObject44 || (lib_templateObject44 = lib_taggedTemplateLiteral(["perpendicular hula"]))), template_string_$item(lib_templateObject45 || (lib_templateObject45 = lib_taggedTemplateLiteral(["slap and tickle"]))), template_string_$item(lib_templateObject46 || (lib_templateObject46 = lib_taggedTemplateLiteral(["fuzzbump"]))), template_string_$item(lib_templateObject47 || (lib_templateObject47 = lib_taggedTemplateLiteral(["a little sump'm sump'm"]))), template_string_$item(lib_templateObject48 || (lib_templateObject48 = lib_taggedTemplateLiteral(["bean burrito"]))), template_string_$item(lib_templateObject49 || (lib_templateObject49 = lib_taggedTemplateLiteral(["spicy bean burrito"]))), template_string_$item(lib_templateObject50 || (lib_templateObject50 = lib_taggedTemplateLiteral(["enchanted bean burrito"]))), template_string_$item(lib_templateObject51 || (lib_templateObject51 = lib_taggedTemplateLiteral(["spicy enchanted bean burrito"]))), template_string_$item(lib_templateObject52 || (lib_templateObject52 = lib_taggedTemplateLiteral(["jumping bean burrito"]))), template_string_$item(lib_templateObject53 || (lib_templateObject53 = lib_taggedTemplateLiteral(["spicy jumping bean burrito"]))), template_string_$item(lib_templateObject54 || (lib_templateObject54 = lib_taggedTemplateLiteral(["Doc Galaktik's Homeopathic Elixir"]))), template_string_$item(lib_templateObject55 || (lib_templateObject55 = lib_taggedTemplateLiteral(["Doc Galaktik's Ailment Ointment"]))), template_string_$item(lib_templateObject56 || (lib_templateObject56 = lib_taggedTemplateLiteral(["cast"])))];
function barrelsAreSmashed() {
  var _barrel$match$length, _barrel$match, _barrel$match$length2, _barrel$match2;
  if (!BarrelShrine_have()) return true;
  if (property_get("_barrelsPopped", false)) return true;
  var barrel = (0,external_kolmafia_namespaceObject.visitUrl)("barrel.php");
  ...
  return property_get("_barrelsPopped", false);
}
var barrelSmashing = {
  name: "Smash Barrels!",
  completed: () => barrelsAreSmashed() || (0,external_kolmafia_namespaceObject.myMeat)() >= 81,
  do: () => {
    var barrel = (0,external_kolmafia_namespaceObject.visitUrl)("barrel.php");
    var matcher = /div class="([a-z]+)".*?&slot=([0-9]+)/g;
    var matches = barrel.match(matcher);
    if (matches) {
      var _iterator = src_lib_createForOfIteratorHelper(matches),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var bar = _step.value;
          ...
          if (slot) {
            if (bar.includes("mimic")) {
              (0,external_kolmafia_namespaceObject.print)("Mimic on slot ".concat(slot[1]));
            } else {
              (0,external_kolmafia_namespaceObject.print)("No mimic on slot ".concat(slot[1]));
              (0,external_kolmafia_namespaceObject.visitUrl)("barrel.php");
              (0,external_kolmafia_namespaceObject.visitUrl)("choice.php?whichchoice=1099&pwd=".concat((0,external_kolmafia_namespaceObject.myHash)(), "&option=1&slot=").concat(slot[1]));
            }
          }
        }
      } catch (err) {
...
function familiarChoice() {
  ...
  } else if (!have(template_string_$effect(lib_templateObject57 || (lib_templateObject57 = lib_taggedTemplateLiteral(["Spit Upon"]))))) {
    return template_string_$familiar(lib_templateObject58 || (lib_templateObject58 = lib_taggedTemplateLiteral(["Melodramedary"])));
  } else if (!have(template_string_$item(lib_templateObject59 || (lib_templateObject59 = lib_taggedTemplateLiteral(["short stack of pancakes"]))))) {
    return template_string_$familiar(lib_templateObject60 || (lib_templateObject60 = lib_taggedTemplateLiteral(["Shorter-Order Cook"])));
  } else return template_string_$familiar(lib_templateObject61 || (lib_templateObject61 = lib_taggedTemplateLiteral(["Jill-of-All-Trades"])));
}
...
var juneCleaverTask = {
  ...
  do: () => $location(_templateObject62 || (_templateObject62 = lib_taggedTemplateLiteral(["The Sleazy Back Alley"]))),
  outfit: {
    weapon: template_string_$item(_templateObject63 || (_templateObject63 = lib_taggedTemplateLiteral(["June cleaver"])))
  },
  post: () => {
    if (have(template_string_$effect(_templateObject64 || (_templateObject64 = lib_taggedTemplateLiteral(["Beaten Up"]))))) {
      uneffect(template_string_$effect(_templateObject65 || (_templateObject65 = lib_taggedTemplateLiteral(["Beaten Up"]))));
    }
  },
  choices: () => ({
    1468: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject66 || (_templateObject66 = lib_taggedTemplateLiteral(["Muscle"]))) ? 2 : (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject67 || (_templateObject67 = lib_taggedTemplateLiteral(["Moxie"]))) ? 1 : property_get("_juneCleaverSkips") < 5 ? 4 : 2,
    1473: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject68 || (_templateObject68 = lib_taggedTemplateLiteral(["Muscle"]))) ? 1 : property_get("_juneCleaverSkips") < 5 ? 4 : 1,
    1469: 3,
    1474: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject69 || (_templateObject69 = lib_taggedTemplateLiteral(["Muscle"]))) ? 3 : (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject70 || (_templateObject70 = lib_taggedTemplateLiteral(["Mysticality"]))) ? 1 : property_get("_juneCleaverSkips") < 5 ? 4 : 3,
    1475: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject71 || (_templateObject71 = lib_taggedTemplateLiteral(["Muscle"]))) ? 2 : property_get("_juneCleaverSkips") < 5 ? 4 : 2,
    1471: 1,
    1467: 3,
    1472: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject72 || (_templateObject72 = lib_taggedTemplateLiteral(["Moxie"]))) ? 3 : property_get("_juneCleaverSkips") < 5 ? 4 : 1,
    1470: (0,external_kolmafia_namespaceObject.myClass)().primestat === $stat(_templateObject73 || (_templateObject73 = lib_taggedTemplateLiteral(["Muscle"]))) ? 3 : property_get("_juneCleaverSkips") < 5 ? 4 : 2
  }),
  combat: new lib_CombatStrategy().autoattack(() => Macro.abort())
};
function oomfieOutfit(options) {
  var famOverride = undefined;
  var famequipOverride = undefined;
  if (args.fam) {
    if (args.familiar === template_string_$familiar.none) {
      (0,external_kolmafia_namespaceObject.abort)("Something has gone wrong with args.familiar (".concat(args.familiar, ")"));
    } else {
      famOverride = args.familiar;
      famequipOverride = template_string_$item(_templateObject74 || (_templateObject74 = lib_taggedTemplateLiteral(["tiny stillsuit"])));
    }
  }
  if (options !== null && options !== void 0 && options.modifier) {
    ...
    return {
      hat: (_options$hatOverride = options === null || options === void 0 ? void 0 : options.hatOverride) !== null && _options$hatOverride !== void 0 ? _options$hatOverride : undefined,
      back: (_options$backOverride = options === null || options === void 0 ? void 0 : options.backOverride) !== null && _options$backOverride !== void 0 ? _options$backOverride : undefined,
      shirt: (_options$shirtOverrid = options === null || options === void 0 ? void 0 : options.shirtOverride) !== null && _options$shirtOverrid !== void 0 ? _options$shirtOverrid : undefined,
      weapon: (_options$weaponOverri = options === null || options === void 0 ? void 0 : options.weaponOverride) !== null && _options$weaponOverri !== void 0 ? _options$weaponOverri : undefined,
      offhand: (_options$offhandOverr = options === null || options === void 0 ? void 0 : options.offhandOverride) !== null && _options$offhandOverr !== void 0 ? _options$offhandOverr : undefined,
      pants: (_options$pantsOverrid = options === null || options === void 0 ? void 0 : options.pantsOverride) !== null && _options$pantsOverrid !== void 0 ? _options$pantsOverrid : undefined,
      acc1: (_options$acc1Override = options === null || options === void 0 ? void 0 : options.acc1Override) !== null && _options$acc1Override !== void 0 ? _options$acc1Override : undefined,
      acc2: (_options$acc2Override = options === null || options === void 0 ? void 0 : options.acc2Override) !== null && _options$acc2Override !== void 0 ? _options$acc2Override : undefined,
      acc3: (_options$acc3Override = options === null || options === void 0 ? void 0 : options.acc3Override) !== null && _options$acc3Override !== void 0 ? _options$acc3Override : undefined,
      ...
      famequip: ((_ref2 = (_famequipOverride = famequipOverride) !== null && _famequipOverride !== void 0 ? _famequipOverride : options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _ref2 !== void 0 ? _ref2 : [template_string_$familiar(_templateObject75 || (_templateObject75 = lib_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))), template_string_$familiar(_templateObject76 || (_templateObject76 = lib_taggedTemplateLiteral(["Ghost of Crimbo Cheer"]))), template_string_$familiar(_templateObject77 || (_templateObject77 = lib_taggedTemplateLiteral(["Ghost of Crimbo Commerce"])))].includes((0,external_kolmafia_namespaceObject.myFamiliar)())) ? template_string_$item.none : template_string_$item(_templateObject78 || (_templateObject78 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: (_options$modesOverrid = options === null || options === void 0 ? void 0 : options.modesOverride) !== null && _options$modesOverrid !== void 0 ? _options$modesOverrid : undefined
    };
  } else {
    ...
    return {
      hat: (_options$hatOverride2 = options === null || options === void 0 ? void 0 : options.hatOverride) !== null && _options$hatOverride2 !== void 0 ? _options$hatOverride2 : template_string_$item(_templateObject79 || (_templateObject79 = lib_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
      back: (_options$backOverride2 = options === null || options === void 0 ? void 0 : options.backOverride) !== null && _options$backOverride2 !== void 0 ? _options$backOverride2 : template_string_$item(_templateObject80 || (_templateObject80 = lib_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      shirt: (_options$shirtOverrid2 = options === null || options === void 0 ? void 0 : options.shirtOverride) !== null && _options$shirtOverrid2 !== void 0 ? _options$shirtOverrid2 : template_string_$item(_templateObject81 || (_templateObject81 = lib_taggedTemplateLiteral(["Jurassic Parka"]))),
      weapon: (_options$weaponOverri2 = options === null || options === void 0 ? void 0 : options.weaponOverride) !== null && _options$weaponOverri2 !== void 0 ? _options$weaponOverri2 : template_string_$item(_templateObject82 || (_templateObject82 = lib_taggedTemplateLiteral(["June cleaver"]))),
      offhand: (_options$offhandOverr2 = options === null || options === void 0 ? void 0 : options.offhandOverride) !== null && _options$offhandOverr2 !== void 0 ? _options$offhandOverr2 : template_string_$item(_templateObject83 || (_templateObject83 = lib_taggedTemplateLiteral(["unbreakable umbrella"]))),
      pants: (_options$pantsOverrid2 = options === null || options === void 0 ? void 0 : options.pantsOverride) !== null && _options$pantsOverrid2 !== void 0 ? _options$pantsOverrid2 : template_string_$item(_templateObject84 || (_templateObject84 = lib_taggedTemplateLiteral(["designer sweatpants"]))),
      acc1: (_options$acc1Override2 = options === null || options === void 0 ? void 0 : options.acc1Override) !== null && _options$acc1Override2 !== void 0 ? _options$acc1Override2 : template_string_$item(_templateObject85 || (_templateObject85 = lib_taggedTemplateLiteral(["backup camera"]))),
      acc2: (_options$acc2Override2 = options === null || options === void 0 ? void 0 : options.acc2Override) !== null && _options$acc2Override2 !== void 0 ? _options$acc2Override2 : template_string_$item(_templateObject86 || (_templateObject86 = lib_taggedTemplateLiteral(["your cowboy boots"]))),
      acc3: (_options$acc3Override2 = options === null || options === void 0 ? void 0 : options.acc3Override) !== null && _options$acc3Override2 !== void 0 ? _options$acc3Override2 : have(template_string_$item(_templateObject87 || (_templateObject87 = lib_taggedTemplateLiteral(["spring shoes"])))) ? template_string_$item(_templateObject88 || (_templateObject88 = lib_taggedTemplateLiteral(["spring shoes"]))) : have(template_string_$item(_templateObject89 || (_templateObject89 = lib_taggedTemplateLiteral(["Brutal brogues"])))) ? template_string_$item(_templateObject90 || (_templateObject90 = lib_taggedTemplateLiteral(["Brutal brogues"]))) : template_string_$item(_templateObject91 || (_templateObject91 = lib_taggedTemplateLiteral(["combat lover's locket"]))),
      ...
      famequip: ((_ref4 = (_famequipOverride2 = famequipOverride) !== null && _famequipOverride2 !== void 0 ? _famequipOverride2 : options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _ref4 !== void 0 ? _ref4 : [template_string_$familiar(_templateObject92 || (_templateObject92 = lib_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))), template_string_$familiar(_templateObject93 || (_templateObject93 = lib_taggedTemplateLiteral(["Ghost of Crimbo Cheer"]))), template_string_$familiar(_templateObject94 || (_templateObject94 = lib_taggedTemplateLiteral(["Ghost of Crimbo Commerce"])))].includes((0,external_kolmafia_namespaceObject.myFamiliar)())) ? template_string_$item.none : template_string_$item(_templateObject95 || (_templateObject95 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: (_options$modesOverrid2 = options === null || options === void 0 ? void 0 : options.modesOverride) !== null && _options$modesOverrid2 !== void 0 ? _options$modesOverrid2 : undefined
    };
  }
}
...
function printLoggedTests() {
  ...
  for (var _i = 0, _allTests = allTests; _i < _allTests.length; _i++) {
    ...
    (0,external_kolmafia_namespaceObject.print)("".concat(test.statName, ": ").concat(property_get("".concat(prefix).concat(test.id), 0), " [Predicted ").concat(property_get("".concat(prefix).concat(test.id, "p"), 0), "]"), "teal");
  }
}
...
function getCardsDrawn() {
  return utils_clamp(property_get("_deckCardsDrawn"), 0, 15);
}
/**
...
function modifier_toPropertyKey(t) { var i = modifier_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function modifier_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function modifier_get(name, subject) {
  if (arrayContains(name, booleanModifiers)) {
    return subject === undefined ? booleanModifier(name) : booleanModifier(subject, name);
  }
  ...
  if (arrayContains(name, numericModifiers)) {
    return subject === undefined ? numericModifier(name) : numericModifier(subject, name);
  }
  if (arrayContains(name, skillModifiers)) {
    return skillModifier(subject, name);
  }
  if (arrayContains(name, stringModifiers)) {
    return subject === undefined ? stringModifier(name) : stringModifier(subject, name);
  }
...
baseModifier) {
  ...
  var total = utils_sum(modtraceModifiers, modifier => {
    if (lowerCaseModifiers.includes(modifier.toLowerCase())) {
      ...
      if (have(template_string_$effect(modifier_templateObject || (modifier_templateObject = modifier_taggedTemplateLiteral(["Bow-Legged Swagger"])))) && modifier.includes("Weapon Damage")) {
...
var booze_templateObject, booze_templateObject2, booze_templateObject3, booze_templateObject4, booze_templateObject5, booze_templateObject6, booze_templateObject7, booze_templateObject8, booze_templateObject9, booze_templateObject10, booze_templateObject11, booze_templateObject12, booze_templateObject13, booze_templateObject14, booze_templateObject15, booze_templateObject16, booze_templateObject17, booze_templateObject18, booze_templateObject19, booze_templateObject20, booze_templateObject21, booze_templateObject22, booze_templateObject23, booze_templateObject24, booze_templateObject25, booze_templateObject26, booze_templateObject27, booze_templateObject28, booze_templateObject29, booze_templateObject30, booze_templateObject31, booze_templateObject32, booze_templateObject33, booze_templateObject34, booze_templateObject35, booze_templateObject36, booze_templateObject37, booze_templateObject38, booze_templateObject39, booze_templateObject40;
...
var boozeQuest = {
  ...
  tasks: [{
    ...
    ready: () => AprilingBandHelmet_have(),
    completed: () => !canChangeSong() || have(template_string_$effect(booze_templateObject || (booze_templateObject = booze_taggedTemplateLiteral(["Apriling Band Celebration Bop"])))),
    do: () => conduct("Apriling Band Celebration Bop")
  }, {
    name: "Retreive Clover",
    ready: () => property_get("_monstersMapped") >= 3 || property_get("_saberForceUses") >= 5 || ["Feast of Boris"].includes((0,external_kolmafia_namespaceObject.holiday)()),
    completed: () => have(template_string_$item(booze_templateObject2 || (booze_templateObject2 = booze_taggedTemplateLiteral(["11-leaf clover"])))) || property_get("_cloversPurchased") >= 2 || have(template_string_$effect(booze_templateObject3 || (booze_templateObject3 = booze_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"])))) || have(template_string_$effect(booze_templateObject4 || (booze_templateObject4 = booze_taggedTemplateLiteral(["Bat-Adjacent Form"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(booze_templateObject5 || (booze_templateObject5 = booze_taggedTemplateLiteral(["11-leaf clover"]))))
  }, {
    name: "Retrieve Cyclops Eyedrops",
    prepare: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(booze_templateObject6 || (booze_templateObject6 = booze_taggedTemplateLiteral(["11-leaf clover"])))),
    ready: () => property_get("_monstersMapped") >= 3 || property_get("_saberForceUses") >= 5 || ["Feast of Boris"].includes((0,external_kolmafia_namespaceObject.holiday)()),
    completed: () => have(template_string_$effect(booze_templateObject7 || (booze_templateObject7 = booze_taggedTemplateLiteral(["One Very Clear Eye"])))) || have(template_string_$item(booze_templateObject8 || (booze_templateObject8 = booze_taggedTemplateLiteral(["cyclops eyedrops"])))) || have(template_string_$effect(booze_templateObject9 || (booze_templateObject9 = booze_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"])))) || have(template_string_$effect(booze_templateObject10 || (booze_templateObject10 = booze_taggedTemplateLiteral(["Bat-Adjacent Form"])))),
    do: $location(booze_templateObject11 || (booze_templateObject11 = booze_taggedTemplateLiteral(["The Limerick Dungeon"]))),
    outfit: () => oomfieOutfit(),
    limit: {
      tries: 1
    }
    ...
    name: "Carol + Cloake",
    ready: () => have(template_string_$familiar(booze_templateObject12 || (booze_templateObject12 = booze_taggedTemplateLiteral(["Ghost of Crimbo Carols"])))) && property_get("_monstersMapped") < 3 && property_get("_saberForceUses") < 5,
    completed: () => ["Feast of Boris"].includes((0,external_kolmafia_namespaceObject.holiday)()) || have(template_string_$effect(booze_templateObject13 || (booze_templateObject13 = booze_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"])))) || have(template_string_$effect(booze_templateObject14 || (booze_templateObject14 = booze_taggedTemplateLiteral(["Bat-Adjacent Form"])))),
    do: () => mapMonster($location(booze_templateObject15 || (booze_templateObject15 = booze_taggedTemplateLiteral(["Barf Mountain"]))), $monster(booze_templateObject16 || (booze_templateObject16 = booze_taggedTemplateLiteral(["garbage tourist"])))),
    choices: {
      1387: 3
    },
    outfit: () => ({
      weapon: template_string_$item(booze_templateObject17 || (booze_templateObject17 = booze_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      back: template_string_$item(booze_templateObject18 || (booze_templateObject18 = booze_taggedTemplateLiteral(["vampyric cloake"]))),
      familiar: template_string_$familiar(booze_templateObject19 || (booze_templateObject19 = booze_taggedTemplateLiteral(["Ghost of Crimbo Carols"])))
    }),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(booze_templateObject20 || (booze_templateObject20 = booze_taggedTemplateLiteral(["Become a Bat"])))).trySkill(template_string_$skill(booze_templateObject21 || (booze_templateObject21 = booze_taggedTemplateLiteral(["Use the Force"])))).abort()),
    post: () => {
      (0,external_kolmafia_namespaceObject.runChoice)(3);
      if (property_get("_vampyreCloakeFormUses") < 10) _set("_vampyreCloakeFormUses", property_get("_vampyreCloakeFormUses") + 1);
    }
  }, {
    name: "Use Eyedrops",
    completed: () => have(template_string_$effect(booze_templateObject22 || (booze_templateObject22 = booze_taggedTemplateLiteral(["All I Want For Crimbo Is Stuff"])))) || have(template_string_$effect(booze_templateObject23 || (booze_templateObject23 = booze_taggedTemplateLiteral(["Bat-Adjacent Form"])))) || have(template_string_$effect(booze_templateObject24 || (booze_templateObject24 = booze_taggedTemplateLiteral(["One Very Clear Eye"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(booze_templateObject25 || (booze_templateObject25 = booze_taggedTemplateLiteral(["cyclops eyedrops"]))))
  }, {
    name: "Feel Lost",
    completed: () => have(template_string_$effect(booze_templateObject26 || (booze_templateObject26 = booze_taggedTemplateLiteral(["Feeling Lost"])))) || property_get("_feelLostUsed") >= 1,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(booze_templateObject27 || (booze_templateObject27 = booze_taggedTemplateLiteral(["Feel Lost"]))))
  }, {
    name: "Wheel of Fortune",
    completed: () => have(template_string_$effect(booze_templateObject28 || (booze_templateObject28 = booze_taggedTemplateLiteral(["Fortune of the Wheel"])))) || property_get("_deckCardsDrawn") > 0,
    do: () => cheatCard("X - The Wheel of Fortune")
  }, {
    name: "Infernal Thirst Wish",
    completed: () => property_get("_genieWishesUsed") >= 3 || have(template_string_$effect(booze_templateObject29 || (booze_templateObject29 = booze_taggedTemplateLiteral(["Infernal Thirst"])))),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect Infernal Thirst"),
    outfit: () => ({
      familiar: template_string_$familiar(booze_templateObject30 || (booze_templateObject30 = booze_taggedTemplateLiteral(["Left-Hand Man"])))
    })
  }, {
    name: "Bag of Grain",
    completed: () => have(template_string_$effect(booze_templateObject31 || (booze_templateObject31 = booze_taggedTemplateLiteral(["Nearly All-Natural"])))) || !have(template_string_$item(booze_templateObject32 || (booze_templateObject32 = booze_taggedTemplateLiteral(["bag of grain"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(booze_templateObject33 || (booze_templateObject33 = booze_taggedTemplateLiteral(["bag of grain"]))))
  }, {
    name: "Autumn Leaf",
    completed: () => have(template_string_$effect(booze_templateObject34 || (booze_templateObject34 = booze_taggedTemplateLiteral(["Crunching Leaves"])))) || !have(template_string_$item(booze_templateObject35 || (booze_templateObject35 = booze_taggedTemplateLiteral(["autumn leaf"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(booze_templateObject36 || (booze_templateObject36 = booze_taggedTemplateLiteral(["autumn leaf"]))))
  }, {
    name: "Item and Booze Drop Test",
    completed: () => CommunityService.BoozeDrop.isDone(),
    do: () => {
      ...
      CommunityService.BoozeDrop.run(() => logTest(CommunityService.BoozeDrop, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "15 Item Drop, 30 Booze Drop, -100 Gear Drop, -equip broken champagne bottle, switch left-hand man"
    },
    effects: [template_string_$effect(booze_templateObject37 || (booze_templateObject37 = booze_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), template_string_$effect(booze_templateObject38 || (booze_templateObject38 = booze_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), template_string_$effect(booze_templateObject39 || (booze_templateObject39 = booze_taggedTemplateLiteral(["Steely-Eyed Squint"]))), template_string_$effect(booze_templateObject40 || (booze_templateObject40 = booze_taggedTemplateLiteral(["Spice Haze"])))],
    limit: {
      tries: 1
    }
  }]
...
var lib = __webpack_require__(931);
...
function Clan_toPropertyKey(t) { var i = Clan_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function Clan_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
var famwt_templateObject, famwt_templateObject2, famwt_templateObject3, famwt_templateObject4, famwt_templateObject5, famwt_templateObject6, famwt_templateObject7, famwt_templateObject8, famwt_templateObject9, famwt_templateObject10, famwt_templateObject11, famwt_templateObject12, famwt_templateObject13, famwt_templateObject14, famwt_templateObject15, famwt_templateObject16, famwt_templateObject17, famwt_templateObject18, famwt_templateObject19, famwt_templateObject20, famwt_templateObject21, famwt_templateObject22, famwt_templateObject23, famwt_templateObject24, famwt_templateObject25, famwt_templateObject26;
...
function bestFam() {
  return $familiars.all().filter(F => have(F) && F !== template_string_$familiar(famwt_templateObject || (famwt_templateObject = famwt_taggedTemplateLiteral(["Homemade Robot"])))).sort((a, b) => (0,external_kolmafia_namespaceObject.familiarWeight)(b) - (0,external_kolmafia_namespaceObject.familiarWeight)(a))[0];
}
var famwtQuest = {
  ...
  tasks: [{
    ...
    ready: () => have(template_string_$item(famwt_templateObject2 || (famwt_templateObject2 = famwt_taggedTemplateLiteral(["box of Familiar Jacks"])))),
    completed: () =>  true || 0,
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject4 || (famwt_templateObject4 = famwt_taggedTemplateLiteral(["box of Familiar Jacks"])))),
    outfit: {
      familiar: template_string_$familiar(famwt_templateObject5 || (famwt_templateObject5 = famwt_taggedTemplateLiteral(["Mini-Trainbot"])))
    }
  }, {
    name: "Witchess Buff",
    ...
    name: "Pancakes",
    completed: () => have(template_string_$effect(famwt_templateObject6 || (famwt_templateObject6 = famwt_taggedTemplateLiteral(["Shortly Stacked"])))) || !have(template_string_$item(famwt_templateObject7 || (famwt_templateObject7 = famwt_taggedTemplateLiteral(["short stack of pancakes"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject8 || (famwt_templateObject8 = famwt_taggedTemplateLiteral(["short stack of pancakes"]))))
  }, {
    name: "Pool Buff",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(famwt_templateObject9 || (famwt_templateObject9 = famwt_taggedTemplateLiteral(["Billiards Belligerence"])))) || property_get("_poolGames") >= 3,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("pool 1")
  }, {
    name: "Love Song",
    completed: () => have(template_string_$effect(famwt_templateObject10 || (famwt_templateObject10 = famwt_taggedTemplateLiteral(["Cold Hearted"])))) || !have(template_string_$item(famwt_templateObject11 || (famwt_templateObject11 = famwt_taggedTemplateLiteral(["love song of icy revenge"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(Math.min(4 - Math.floor((0,external_kolmafia_namespaceObject.haveEffect)(template_string_$effect(famwt_templateObject12 || (famwt_templateObject12 = famwt_taggedTemplateLiteral(["Cold Hearted"])))) / 5), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(famwt_templateObject13 || (famwt_templateObject13 = famwt_taggedTemplateLiteral(["love song of icy revenge"]))))), template_string_$item(famwt_templateObject14 || (famwt_templateObject14 = famwt_taggedTemplateLiteral(["love song of icy revenge"]))))
  }, {
    name: "\u2665 Rocks",
    ready: () => have(template_string_$item(famwt_templateObject15 || (famwt_templateObject15 = famwt_taggedTemplateLiteral(["lump of loyal latite"])))),
    completed: () => have(template_string_$effect(famwt_templateObject16 || (famwt_templateObject16 = famwt_taggedTemplateLiteral(["Loyal as a Rock"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject17 || (famwt_templateObject17 = famwt_taggedTemplateLiteral(["lump of loyal latite"]))))
  }, {
    name: "Hatter Buff",
    completed: () =>  true || 0,
    ...
    ready: () => have(template_string_$item(famwt_templateObject21 || (famwt_templateObject21 = famwt_taggedTemplateLiteral(["Beach Comb"])))) && headAvailable("FAMILIAR"),
    completed: () => have(template_string_$effect(famwt_templateObject22 || (famwt_templateObject22 = famwt_taggedTemplateLiteral(["Do I Know You From Somewhere?"])))),
    do: () => tryHead("FAMILIAR")
  }, {
    name: "Familiar Weight Test",
    completed: () => CommunityService.FamiliarWeight.isDone(),
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.FamiliarWeight.run(() => logTest(CommunityService.FamiliarWeight, testTurns, predictedTestTurns), 42);
    },
    outfit: () => ({
      modifier: "familiar weight, switch left-hand man, ".concat(have(template_string_$item(famwt_templateObject23 || (famwt_templateObject23 = famwt_taggedTemplateLiteral(["overloaded Yule battery"])))) ? "switch Mini-Trainbot," : "", " switch ").concat(bestFam())
    }),
    limit: {
      tries: 1
    },
    effects: [template_string_$effect(famwt_templateObject24 || (famwt_templateObject24 = famwt_taggedTemplateLiteral(["Empathy"]))), template_string_$effect(famwt_templateObject25 || (famwt_templateObject25 = famwt_taggedTemplateLiteral(["Blood Bond"]))), template_string_$effect(famwt_templateObject26 || (famwt_templateObject26 = famwt_taggedTemplateLiteral(["Leash of Linguini"])))]
  }]
};
...
var finaleQuest = {
  ...
  tasks: [{
    ...
    post: () => {
      _set("_mustardServiceTimeEnd", (0,external_kolmafia_namespaceObject.nowToInt)());
      (0,external_kolmafia_namespaceObject.cliExecute)("".concat(property_get("kingLiberatedScript")));
    }
  }]
};
var postFinaleQuest = {
  ...
  tasks: [{
    ...
    do: () => {
      printLoggedTests();
      (0,external_kolmafia_namespaceObject.print)("Took: ".concat(Math.floor((property_get("_mustardServiceTimeEnd", (0,external_kolmafia_namespaceObject.nowToInt)()) - Number(property_get("_mustardServiceTime"))) / 60000), " Minute(s), ").concat(Math.floor((property_get("_mustardServiceTimeEnd", (0,external_kolmafia_namespaceObject.nowToInt)()) - Number(property_get("_mustardServiceTime"))) % 60000 / 1000), " Second(s)"), "green");
...
var hotresQuest = {
  ...
  tasks: [{
    name: "Foam Suit",
    completed: () => have(template_string_$effect(hotres_templateObject || (hotres_templateObject = hotres_taggedTemplateLiteral(["Fireproof Foam Suit"])))) || property_get("_fireExtinguisherCharge") <= 0,
    do: () => reminisce($monster(hotres_templateObject2 || (hotres_templateObject2 = hotres_taggedTemplateLiteral(["ungulith"])))),
    outfit: oomfieOutfit({
      weaponOverride: template_string_$item(hotres_templateObject3 || (hotres_templateObject3 = hotres_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))),
      offhandOverride: template_string_$item(hotres_templateObject4 || (hotres_templateObject4 = hotres_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      acc1Override: template_string_$item(hotres_templateObject5 || (hotres_templateObject5 = hotres_taggedTemplateLiteral(["backup camera"]))),
      acc2Override: template_string_$item(hotres_templateObject6 || (hotres_templateObject6 = hotres_taggedTemplateLiteral(["your cowboy boots"]))),
      modesOverride: {
        backupcamera: "ml"
      }
    }),
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(hotres_templateObject7 || (hotres_templateObject7 = hotres_taggedTemplateLiteral(["Fire Extinguisher: Foam Yourself"])))).trySkill(template_string_$skill(hotres_templateObject8 || (hotres_templateObject8 = hotres_taggedTemplateLiteral(["Use the Force"])))).abort())
  }, {
    name: "Hot Resistance Test",
    completed: () => CommunityService.HotRes.isDone(),
    do: () => {
      ...
      if (predictedTestTurns > 1) {
        (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(hotres_templateObject9 || (hotres_templateObject9 = hotres_taggedTemplateLiteral(["pocket maze"]))));
      }
      var testTurns = CommunityService.HotRes.actualCost();
      printModtrace("hot resistance");
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.HotRes.run(() => logTest(CommunityService.HotRes, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "hot resistance, switch left-hand man, switch exotic parrot"
    },
    effects: [template_string_$effect(hotres_templateObject10 || (hotres_templateObject10 = hotres_taggedTemplateLiteral(["Elemental Saucesphere"]))), template_string_$effect(hotres_templateObject11 || (hotres_templateObject11 = hotres_taggedTemplateLiteral(["Feeling Peaceful"]))), template_string_$effect(hotres_templateObject12 || (hotres_templateObject12 = hotres_taggedTemplateLiteral(["Astral Shell"]))), template_string_$effect(hotres_templateObject13 || (hotres_templateObject13 = hotres_taggedTemplateLiteral(["Blood Bond"]))), template_string_$effect(hotres_templateObject14 || (hotres_templateObject14 = hotres_taggedTemplateLiteral(["Empathy"]))), template_string_$effect(hotres_templateObject15 || (hotres_templateObject15 = hotres_taggedTemplateLiteral(["Leash of Linguini"])))],
    limit: {
      tries: 1
    }
  }]
...
function refillsRemaining() {
  return utils_clamp(3 - property_get("_latteRefillsUsed"), 0, 3);
}
var INGREDIENTS = {
  ancient: {
    modifier: {
...
function shadowRiftChoice() {
  ...
  return $location(levelling_templateObject || (levelling_templateObject = levelling_taggedTemplateLiteral(["Shadow Rift (The Misspelled Cemetary)"])));
}
function shadowRiftPocketTarget() {
  ...
  return $monster(levelling_templateObject2 || (levelling_templateObject2 = levelling_taggedTemplateLiteral(["shadow slab"])));
}
var facialExpression = lib_byStat({
  Muscle: template_string_$effect(levelling_templateObject3 || (levelling_templateObject3 = levelling_taggedTemplateLiteral(["Quiet Determination"]))),
  Mysticality: template_string_$effect(levelling_templateObject4 || (levelling_templateObject4 = levelling_taggedTemplateLiteral(["Inscrutable Gaze"]))),
  Moxie: template_string_$effect(levelling_templateObject5 || (levelling_templateObject5 = levelling_taggedTemplateLiteral(["Quiet Desperation"])))
});
var showerEffect = lib_byStat({
  Muscle: template_string_$effect(levelling_templateObject6 || (levelling_templateObject6 = levelling_taggedTemplateLiteral(["Muscle Unbound"]))),
  Mysticality: template_string_$effect(levelling_templateObject7 || (levelling_templateObject7 = levelling_taggedTemplateLiteral(["Thaumodynamic"]))),
  Moxie: template_string_$effect(levelling_templateObject8 || (levelling_templateObject8 = levelling_taggedTemplateLiteral(["So Fresh and So Clean"])))
});
var levellingEffects = [//Starter Buffs
template_string_$effect(levelling_templateObject9 || (levelling_templateObject9 = levelling_taggedTemplateLiteral(["Mariachi Mood"]))), template_string_$effect(levelling_templateObject10 || (levelling_templateObject10 = levelling_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), template_string_$effect(levelling_templateObject11 || (levelling_templateObject11 = levelling_taggedTemplateLiteral(["Saucemastery"]))), template_string_$effect(levelling_templateObject12 || (levelling_templateObject12 = levelling_taggedTemplateLiteral(["Patience of the Tortoise"]))), template_string_$effect(levelling_templateObject13 || (levelling_templateObject13 = levelling_taggedTemplateLiteral(["Disco State of Mind"]))), template_string_$effect(levelling_templateObject14 || (levelling_templateObject14 = levelling_taggedTemplateLiteral(["Pasta Oneness"]))), //Tiny buffs
template_string_$effect(levelling_templateObject15 || (levelling_templateObject15 = levelling_taggedTemplateLiteral(["Reptilian Fortitude"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject16 || (levelling_templateObject16 = levelling_taggedTemplateLiteral(["Turtle Tamer"]))) ? template_string_$effect(levelling_templateObject17 || (levelling_templateObject17 = levelling_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : template_string_$effect(levelling_templateObject18 || (levelling_templateObject18 = levelling_taggedTemplateLiteral(["Disdain of the War Snapper"]))), template_string_$effect(levelling_templateObject19 || (levelling_templateObject19 = levelling_taggedTemplateLiteral(["Blubbered Up"]))), template_string_$effect(levelling_templateObject20 || (levelling_templateObject20 = levelling_taggedTemplateLiteral(["Tenacity of the Snapper"]))), //Bigger stat buffs
template_string_$effect(levelling_templateObject21 || (levelling_templateObject21 = levelling_taggedTemplateLiteral(["Disco Fever"]))), template_string_$effect(levelling_templateObject22 || (levelling_templateObject22 = levelling_taggedTemplateLiteral(["Rage of the Reindeer"]))), template_string_$effect(levelling_templateObject23 || (levelling_templateObject23 = levelling_taggedTemplateLiteral(["Big"]))), template_string_$effect(levelling_templateObject24 || (levelling_templateObject24 = levelling_taggedTemplateLiteral(["Song of Bravado"]))),
//Facial
facialExpression, //Feelings
template_string_$effect(levelling_templateObject25 || (levelling_templateObject25 = levelling_taggedTemplateLiteral(["Feeling Excited"]))), template_string_$effect(levelling_templateObject26 || (levelling_templateObject26 = levelling_taggedTemplateLiteral(["Feeling Peaceful"]))), //Songs
template_string_$effect(levelling_templateObject27 || (levelling_templateObject27 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), template_string_$effect(levelling_templateObject28 || (levelling_templateObject28 = levelling_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), template_string_$effect(levelling_templateObject29 || (levelling_templateObject29 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), template_string_$effect(levelling_templateObject30 || (levelling_templateObject30 = levelling_taggedTemplateLiteral(["Aloysius' Antiphon of Aptitude"]))), //ML and Bonus Stats
template_string_$effect(levelling_templateObject31 || (levelling_templateObject31 = levelling_taggedTemplateLiteral(["Carol of the Thrills"]))), template_string_$effect(levelling_templateObject32 || (levelling_templateObject32 = levelling_taggedTemplateLiteral(["Pride of the Puffin"]))), template_string_$effect(levelling_templateObject33 || (levelling_templateObject33 = levelling_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), //Defensive
template_string_$effect(levelling_templateObject34 || (levelling_templateObject34 = levelling_taggedTemplateLiteral(["Ghostly Shell"]))), template_string_$effect(levelling_templateObject35 || (levelling_templateObject35 = levelling_taggedTemplateLiteral(["Astral Shell"]))), template_string_$effect(levelling_templateObject36 || (levelling_templateObject36 = levelling_taggedTemplateLiteral(["Jalape\xF1o Saucesphere"]))), template_string_$effect(levelling_templateObject37 || (levelling_templateObject37 = levelling_taggedTemplateLiteral(["Spiky Shell"]))), template_string_$effect(levelling_templateObject38 || (levelling_templateObject38 = levelling_taggedTemplateLiteral(["Elemental Saucesphere"]))), template_string_$effect(levelling_templateObject39 || (levelling_templateObject39 = levelling_taggedTemplateLiteral(["Scarysauce"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject40 || (levelling_templateObject40 = levelling_taggedTemplateLiteral(["Pastamancer"]))) ? template_string_$effect(levelling_templateObject41 || (levelling_templateObject41 = levelling_taggedTemplateLiteral(["Shield of the Pastalord"]))) : template_string_$effect(levelling_templateObject42 || (levelling_templateObject42 = levelling_taggedTemplateLiteral(["Flimsy Shield of the Pastalord"]))), template_string_$effect(levelling_templateObject43 || (levelling_templateObject43 = levelling_taggedTemplateLiteral(["Blood Bubble"]))), //Elemental Weapon Damage
template_string_$effect(levelling_templateObject44 || (levelling_templateObject44 = levelling_taggedTemplateLiteral(["Your Fifteen Minutes"]))), template_string_$effect(levelling_templateObject45 || (levelling_templateObject45 = levelling_taggedTemplateLiteral(["Frostbeard"]))), template_string_$effect(levelling_templateObject46 || (levelling_templateObject46 = levelling_taggedTemplateLiteral(["Takin' It Greasy"]))), template_string_$effect(levelling_templateObject47 || (levelling_templateObject47 = levelling_taggedTemplateLiteral(["Rotten Memories"]))), template_string_$effect(levelling_templateObject48 || (levelling_templateObject48 = levelling_taggedTemplateLiteral(["Pyromania"]))), template_string_$effect(levelling_templateObject49 || (levelling_templateObject49 = levelling_taggedTemplateLiteral(["Intimidating Mien"]))), //Familiar!
template_string_$effect(levelling_templateObject50 || (levelling_templateObject50 = levelling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"]))), familiarAttacks() ? template_string_$effect(levelling_templateObject51 || (levelling_templateObject51 = levelling_taggedTemplateLiteral(["Big"]))) : template_string_$effect(levelling_templateObject52 || (levelling_templateObject52 = levelling_taggedTemplateLiteral(["Empathy"]))), familiarAttacks() ? template_string_$effect(levelling_templateObject53 || (levelling_templateObject53 = levelling_taggedTemplateLiteral(["Big"]))) : template_string_$effect(levelling_templateObject54 || (levelling_templateObject54 = levelling_taggedTemplateLiteral(["Leash of Linguini"]))), familiarAttacks() ? template_string_$effect(levelling_templateObject55 || (levelling_templateObject55 = levelling_taggedTemplateLiteral(["Big"]))) : template_string_$effect(levelling_templateObject56 || (levelling_templateObject56 = levelling_taggedTemplateLiteral(["Blood Bond"]))), //Misc
template_string_$effect(levelling_templateObject57 || (levelling_templateObject57 = levelling_taggedTemplateLiteral(["Carol of the Bulls"]))), template_string_$effect(levelling_templateObject58 || (levelling_templateObject58 = levelling_taggedTemplateLiteral(["Carol of the Hells"]))), template_string_$effect(levelling_templateObject59 || (levelling_templateObject59 = levelling_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), template_string_$effect(levelling_templateObject60 || (levelling_templateObject60 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))];
var levellingQuest = {
  name: "Levelling",
  completed: () => (property_get("_gingerbreadMobHitUsed") || (0,external_kolmafia_namespaceObject.myLevel)() >= 15) && have(template_string_$item(levelling_templateObject61 || (levelling_templateObject61 = levelling_taggedTemplateLiteral(["battle broom"])))),
  tasks: [loss, {
    name: "Beaten Up!",
    completed: () => !have(template_string_$effect(levelling_templateObject62 || (levelling_templateObject62 = levelling_taggedTemplateLiteral(["Beaten Up"])))),
    ...
    completed: () => !AutumnAton_available(),
    do: () => {
      sendTo($location(levelling_templateObject63 || (levelling_templateObject63 = levelling_taggedTemplateLiteral(["Shadow Rift"]))));
    }
  }, {
    name: "Apriling Band Helmet: -Combat Early!",
    ready: () => AprilingBandHelmet_have(),
    completed: () => !canChangeSong() || have(template_string_$effect(levelling_templateObject64 || (levelling_templateObject64 = levelling_taggedTemplateLiteral(["Apriling Band Patrol Beat"])))),
    do: () => conduct("Apriling Band Patrol Beat")
  }, {
    name: "Drink Pilsners",
    ready: () => (0,external_kolmafia_namespaceObject.myLevel)() >= 11 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(levelling_templateObject65 || (levelling_templateObject65 = levelling_taggedTemplateLiteral(["astral pilsner"])))) >= 4,
    prepare: () => {
      uneffect(template_string_$effect(levelling_templateObject66 || (levelling_templateObject66 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
      ensureEffect(template_string_$effect(levelling_templateObject67 || (levelling_templateObject67 = levelling_taggedTemplateLiteral(["Ode to Booze"]))), 4);
    },
    completed: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(levelling_templateObject68 || (levelling_templateObject68 = levelling_taggedTemplateLiteral(["astral pilsner"])))) < 4,
    do: () => (0,external_kolmafia_namespaceObject.drink)(4, template_string_$item(levelling_templateObject69 || (levelling_templateObject69 = levelling_taggedTemplateLiteral(["astral pilsner"])))),
    post: () => {
      uneffect(template_string_$effect(levelling_templateObject70 || (levelling_templateObject70 = levelling_taggedTemplateLiteral(["Ode to Booze"]))));
      ensureEffect(template_string_$effect(levelling_templateObject71 || (levelling_templateObject71 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
    }
  }, {
    name: "Bastille Battalion",
    completed: () => property_get("_bastilleGames") >= 1,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("bastille babar brutalist gesture")
  }, {
    name: "Campway Cloudspeaking",
    completed: () => property_get("_campAwayCloudBuffs") === 1,
    ...
    do: () => (0,external_kolmafia_namespaceObject.restoreHp)(utils_clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2 + 10, (0,external_kolmafia_namespaceObject.myMaxhp)()))
  }, {
    name: "Restore MP",
    ready: () => (0,external_kolmafia_namespaceObject.myMp)() < 50 && property_get("sweat") >= 95,
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 50,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(levelling_templateObject72 || (levelling_templateObject72 = levelling_taggedTemplateLiteral(["Sip Some Sweat"]))))
  }, {
    name: "Eat sosig",
    ready: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(levelling_templateObject73 || (levelling_templateObject73 = levelling_taggedTemplateLiteral(["magical sausage casing"])))) > 0,
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 850 || (0,external_kolmafia_namespaceObject.myMaxmp)() - (0,external_kolmafia_namespaceObject.myMp)() <= 999,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(levelling_templateObject74 || (levelling_templateObject74 = levelling_taggedTemplateLiteral(["magical sausage"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(levelling_templateObject75 || (levelling_templateObject75 = levelling_taggedTemplateLiteral(["magical sausage"]))));
    },
    effects: [(0,external_kolmafia_namespaceObject.myClass)() !== $class(levelling_templateObject76 || (levelling_templateObject76 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? template_string_$effect(levelling_templateObject77 || (levelling_templateObject77 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : template_string_$effect(levelling_templateObject78 || (levelling_templateObject78 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))]
  }, {
    name: "Kramco Goblingo",
    ready: () => getKramcoWandererChance() === 1 && property_get("_neverendingPartyFreeTurns") >= 1,
    completed: () => getKramcoWandererChance() < 1,
    do: () => $location(levelling_templateObject79 || (levelling_templateObject79 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(levelling_templateObject80 || (levelling_templateObject80 = levelling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      shirtOverride: template_string_$item(levelling_templateObject81 || (levelling_templateObject81 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(levelling_templateObject82 || (levelling_templateObject82 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Angry Agate",
    ready: () => have(template_string_$item(levelling_templateObject83 || (levelling_templateObject83 = levelling_taggedTemplateLiteral(["angry agate"])))),
    completed: () => have(template_string_$effect(levelling_templateObject84 || (levelling_templateObject84 = levelling_taggedTemplateLiteral(["Misplaced Rage"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(levelling_templateObject85 || (levelling_templateObject85 = levelling_taggedTemplateLiteral(["angry agate"]))))
  }, {
    name: "Filled Mosquito",
    ready: () => have(template_string_$item(levelling_templateObject86 || (levelling_templateObject86 = levelling_taggedTemplateLiteral(["filled mosquito"])))),
    completed: () => have(template_string_$effect(levelling_templateObject87 || (levelling_templateObject87 = levelling_taggedTemplateLiteral(["Wisdom of Others"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(levelling_templateObject88 || (levelling_templateObject88 = levelling_taggedTemplateLiteral(["filled mosquito"]))))
  }, {
    name: "April Shower",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    ...
    name: "Use 10% Bonus",
    completed: () => !have(template_string_$item(levelling_templateObject89 || (levelling_templateObject89 = levelling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(levelling_templateObject90 || (levelling_templateObject90 = levelling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    outfit: {
      offhand: template_string_$item(levelling_templateObject91 || (levelling_templateObject91 = levelling_taggedTemplateLiteral(["familiar scrapbook"])))
    }
  }, {
    name: "Eat Legend Dishes",
    ready: () => have(template_string_$effect(levelling_templateObject92 || (levelling_templateObject92 = levelling_taggedTemplateLiteral(["Everything Looks Red"])))),
    completed: () => property_get("pizzaOfLegendEaten") && property_get("calzoneOfLegendEaten") || !have(template_string_$item(levelling_templateObject93 || (levelling_templateObject93 = levelling_taggedTemplateLiteral(["Pizza of Legend"])))) && !have(template_string_$item(levelling_templateObject94 || (levelling_templateObject94 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))),
    do: () => [template_string_$item(levelling_templateObject95 || (levelling_templateObject95 = levelling_taggedTemplateLiteral(["Pizza of Legend"]))), template_string_$item(_templateObject96 || (_templateObject96 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))].forEach(i => (0,external_kolmafia_namespaceObject.eat)(1, i)),
    outfit: {
      offhand: template_string_$item(_templateObject97 || (_templateObject97 = levelling_taggedTemplateLiteral(["familiar scrapbook"])))
    }
  }, {
    name: "Lyle Buff",
    ...
    completed: () => have(template_string_$item(_templateObject98 || (_templateObject98 = levelling_taggedTemplateLiteral(["Catherine Wheel"])))) || have(template_string_$item(_templateObject99 || (_templateObject99 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject100 || (_templateObject100 = levelling_taggedTemplateLiteral(["Catherine Wheel"]))))
  }, {
    name: "Boxing Daycare Buff",
    completed: () => [template_string_$effect(_templateObject101 || (_templateObject101 = levelling_taggedTemplateLiteral(["Muddled"]))), template_string_$effect(_templateObject102 || (_templateObject102 = levelling_taggedTemplateLiteral(["Ten out of Ten"]))), template_string_$effect(_templateObject103 || (_templateObject103 = levelling_taggedTemplateLiteral(["Uncucumbered"])))].some(ef => have(ef)) || property_get("_daycareSpa"),
    ...
    completed: () => !args.fam || have(template_string_$effect(_templateObject104 || (_templateObject104 = levelling_taggedTemplateLiteral(["A Contender"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect A Contender")
  }, {
    name: "Check G-9 Status",
    completed: () => property_get("_g9Effect") !== 0,
    do: () => (0,external_kolmafia_namespaceObject.visitUrl)("desc_item.php?whichitem=661049168")
  }, {
    name: "Wish for G-9",
    ready: () => property_get("_g9Effect") > 200,
    completed: () => have(template_string_$effect(_templateObject105 || (_templateObject105 = levelling_taggedTemplateLiteral(["Experimental Effect G-9"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect Experimental Effect G-9")
  }, {
    name: "Wish for New and Improved",
    completed: () => have(template_string_$effect(_templateObject106 || (_templateObject106 = levelling_taggedTemplateLiteral(["Experimental Effect G-9"])))) || have(template_string_$effect(_templateObject107 || (_templateObject107 = levelling_taggedTemplateLiteral(["New and Improved"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect New and Improved")
  }, {
    name: "Use Market Consumables",
    completed: () => [template_string_$effect(_templateObject108 || (_templateObject108 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), template_string_$effect(_templateObject109 || (_templateObject109 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), template_string_$effect(_templateObject110 || (_templateObject110 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].every(ef => have(ef)),
    do: () => [template_string_$effect(_templateObject111 || (_templateObject111 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), template_string_$effect(_templateObject112 || (_templateObject112 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), template_string_$effect(_templateObject113 || (_templateObject113 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].forEach(ef => ensureEffect(ef, 9))
  }, {
    name: "Use Wasabi Marble Soda",
    completed: () => !have(template_string_$item(_templateObject114 || (_templateObject114 = levelling_taggedTemplateLiteral(["wasabi marble soda"])))) || have(template_string_$effect(_templateObject115 || (_templateObject115 = levelling_taggedTemplateLiteral(["Wasabi With You"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject116 || (_templateObject116 = levelling_taggedTemplateLiteral(["wasabi marble soda"]))))
  }, {
    name: "Summon Reagents",
    completed: () => property_get("reagentSummons") > 0,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject117 || (_templateObject117 = levelling_taggedTemplateLiteral(["Advanced Saucecrafting"]))))
  }, {
    name: "Become Occultic",
    completed: () => have(template_string_$effect(_templateObject118 || (_templateObject118 = levelling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject119 || (_templateObject119 = levelling_taggedTemplateLiteral(["ointment of the occult"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject120 || (_templateObject120 = levelling_taggedTemplateLiteral(["ointment of the occult"]))));
    }
  }, {
    name: "Red Letter",
    ready: () => have(template_string_$item(_templateObject121 || (_templateObject121 = levelling_taggedTemplateLiteral(["red letter"])))),
    completed: () => have(template_string_$effect(_templateObject122 || (_templateObject122 = levelling_taggedTemplateLiteral(["Red Lettered"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject123 || (_templateObject123 = levelling_taggedTemplateLiteral(["red letter"]))))
  }, {
    name: "Pyrite Pride",
    ready: () => have(template_string_$item(_templateObject124 || (_templateObject124 = levelling_taggedTemplateLiteral(["pebble of proud pyrite"])))),
    completed: () => have(template_string_$effect(_templateObject125 || (_templateObject125 = levelling_taggedTemplateLiteral(["Pyrite Pride"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject126 || (_templateObject126 = levelling_taggedTemplateLiteral(["pebble of proud pyrite"]))))
  }, {
    name: "Summon Limes",
    completed: () => property_get("_preventScurvy"),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject127 || (_templateObject127 = levelling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))
  }, {
    name: "Become Phorceful",
    completed: () => have(template_string_$effect(_templateObject128 || (_templateObject128 = levelling_taggedTemplateLiteral(["Phorcefullness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject129 || (_templateObject129 = levelling_taggedTemplateLiteral(["philter of phorce"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject130 || (_templateObject130 = levelling_taggedTemplateLiteral(["philter of phorce"]))));
    }
  }, {
    name: "Stabilize your Oils",
    completed: () => have(template_string_$effect(_templateObject131 || (_templateObject131 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject132 || (_templateObject132 = levelling_taggedTemplateLiteral(["oil of stability"]))));
      ensureEffect(template_string_$effect(_templateObject133 || (_templateObject133 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"]))));
    }
  }, {
    name: "Latte to Full MP",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)(utils_clamp(1000, (0,external_kolmafia_namespaceObject.myMaxhp)() / 2, (0,external_kolmafia_namespaceObject.myMaxhp)())),
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 250 || property_get("_latteRefillsUsed") >= 2 || have(template_string_$effect(_templateObject134 || (_templateObject134 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject135 || (_templateObject135 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      if (property_get("_latteDrinkUsed")) {
        fill("pumpkin", "cinnamon", "vanilla");
      }
    },
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject136 || (_templateObject136 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modifier: "mp"
    }),
    effects: [template_string_$effect(_templateObject137 || (_templateObject137 = levelling_taggedTemplateLiteral(["Big"]))), template_string_$effect(_templateObject138 || (_templateObject138 = levelling_taggedTemplateLiteral(["Song of Bravado"]))), template_string_$effect(_templateObject139 || (_templateObject139 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject140 || (_templateObject140 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? template_string_$effect(_templateObject141 || (_templateObject141 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : template_string_$effect(_templateObject142 || (_templateObject142 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))],
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject143 || (_templateObject143 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject144 || (_templateObject144 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    ...
    name: "Refill Latte",
    completed: () => !property_get("_latteBanishUsed") || property_get("_latteRefillsUsed") >= 2,
    do: () => fill("cinnamon", "pumpkin", "vanilla")
  }, {
    name: "Summon Love Songs",
    completed: () => !have(template_string_$skill(_templateObject145 || (_templateObject145 = levelling_taggedTemplateLiteral(["Summon Love Song"])))) || (0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject146 || (_templateObject146 = levelling_taggedTemplateLiteral(["Summon Love Song"])))) + 350 > (0,external_kolmafia_namespaceObject.myMp)(),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject147 || (_templateObject147 = levelling_taggedTemplateLiteral(["Summon Love Song"]))))
  }, {
    name: "Latte for Later",
    ready: () => (0,external_kolmafia_namespaceObject.myMaxmp)() >= 6000,
    completed: () => property_get("_latteRefillsUsed") >= 2,
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject148 || (_templateObject148 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      //Latte.fill(`pumpkin`, `cinnamon`, `vanilla`);
    },
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject149 || (_templateObject149 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modifier: "mp"
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject150 || (_templateObject150 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject151 || (_templateObject151 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    name: "Remove Bloodsugar",
    completed: () => !have(template_string_$effect(_templateObject152 || (_templateObject152 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have(template_string_$effect(_templateObject153 || (_templateObject153 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject154 || (_templateObject154 = levelling_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))))
  }, {
    name: "Flapper Mapper",
    completed: () => property_get("_monstersMapped") >= 3 || have(template_string_$item(_templateObject155 || (_templateObject155 = levelling_taggedTemplateLiteral(["imported taffy"])))),
    do: () => mapMonster($location(_templateObject156 || (_templateObject156 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject157 || (_templateObject157 = levelling_taggedTemplateLiteral(["goblin flapper"])))),
    outfit: () => oomfieOutfit({
      backOverride: !have(template_string_$effect(_templateObject158 || (_templateObject158 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) || !have(template_string_$effect(_templateObject159 || (_templateObject159 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))) ? template_string_$item(_templateObject160 || (_templateObject160 = levelling_taggedTemplateLiteral(["vampyric cloake"]))) : undefined,
      offhandOverride: template_string_$item(_templateObject161 || (_templateObject161 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      modesOverride: {
        umbrella: "broken"
      },
      familiarOverride: template_string_$familiar(_templateObject162 || (_templateObject162 = levelling_taggedTemplateLiteral(["Ghost of Crimbo Carols"]))),
      famequipOverride: template_string_$item.none
    }),
    combat: new CombatStrategy().autoattack(() => Macro.ifHolidayWanderer(Macro.attack().repeat()).trySkill(template_string_$skill(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["Feel Envy"])))).externalIf(!have(template_string_$effect(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["Wolfish Form"])))), Macro.trySkill(template_string_$skill(_templateObject165 || (_templateObject165 = levelling_taggedTemplateLiteral(["Become a Wolf"]))))).externalIf(have(template_string_$effect(_templateObject166 || (_templateObject166 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) && !have(template_string_$effect(_templateObject167 || (_templateObject167 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))), Macro.trySkill(template_string_$skill(_templateObject168 || (_templateObject168 = levelling_taggedTemplateLiteral(["Become a Bat"]))))).attack().repeat())
  }, {
    name: "Oliver's Place (Nanorhino)",
    completed: () => property_get("_speakeasyFreeFights") >= 3 || !have(template_string_$familiar(_templateObject169 || (_templateObject169 = levelling_taggedTemplateLiteral(["Nanorhino"])))) || [template_string_$effect(_templateObject170 || (_templateObject170 = levelling_taggedTemplateLiteral(["Nanobrawny"]))), template_string_$effect(_templateObject171 || (_templateObject171 = levelling_taggedTemplateLiteral(["Nanobrainy"])))].some(ef => have(ef)) || args.fam,
    do: () => $location(_templateObject172 || (_templateObject172 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit({
      backOverride: !have(template_string_$effect(_templateObject173 || (_templateObject173 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) || !have(template_string_$effect(_templateObject174 || (_templateObject174 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))) ? template_string_$item(_templateObject175 || (_templateObject175 = levelling_taggedTemplateLiteral(["vampyric cloake"]))) : undefined,
      familiarOverride: template_string_$familiar(_templateObject176 || (_templateObject176 = levelling_taggedTemplateLiteral(["Nanorhino"])))
    }),
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject177 || (_templateObject177 = levelling_taggedTemplateLiteral(["Sing Along"])))).externalIf(!have(template_string_$effect(_templateObject178 || (_templateObject178 = levelling_taggedTemplateLiteral(["Wolfish Form"])))), Macro.trySkill(template_string_$skill(_templateObject179 || (_templateObject179 = levelling_taggedTemplateLiteral(["Become a Wolf"]))))).externalIf(have(template_string_$effect(_templateObject180 || (_templateObject180 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) && !have(template_string_$effect(_templateObject181 || (_templateObject181 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))), Macro.trySkill(template_string_$skill(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["Become a Bat"]))))).trySkill(template_string_$skill(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"])))).attack().repeat())
  }, {
    name: "Oliver's Place",
    completed: () => property_get("_speakeasyFreeFights") === 3,
    do: $location(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit({
      backOverride: !have(template_string_$effect(_templateObject185 || (_templateObject185 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) || !have(template_string_$effect(_templateObject186 || (_templateObject186 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))) ? template_string_$item(_templateObject187 || (_templateObject187 = levelling_taggedTemplateLiteral(["vampyric cloake"]))) : undefined
    }),
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject188 || (_templateObject188 = levelling_taggedTemplateLiteral(["Sing Along"])))).externalIf(!have(template_string_$effect(_templateObject189 || (_templateObject189 = levelling_taggedTemplateLiteral(["Wolfish Form"])))), Macro.trySkill(template_string_$skill(_templateObject190 || (_templateObject190 = levelling_taggedTemplateLiteral(["Become a Wolf"]))))).externalIf(have(template_string_$effect(_templateObject191 || (_templateObject191 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) && !have(template_string_$effect(_templateObject192 || (_templateObject192 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))), Macro.trySkill(template_string_$skill(_templateObject193 || (_templateObject193 = levelling_taggedTemplateLiteral(["Become a Bat"]))))).attack().repeat())
  }, {
    name: "Pick up a club!",
    completed: () => args.fam || have(template_string_$item(_templateObject194 || (_templateObject194 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject195 || (_templateObject195 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))))
  }, {
    name: "Seal Fights",
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject196 || (_templateObject196 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5,
    do: () => {
      have(template_string_$skill(_templateObject197 || (_templateObject197 = levelling_taggedTemplateLiteral(["Just the Facts"])))) && !have(template_string_$effect(_templateObject198 || (_templateObject198 = levelling_taggedTemplateLiteral(["Sweet and Red"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject199 || (_templateObject199 = levelling_taggedTemplateLiteral(["figurine of a cute baby seal"])))) : (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject200 || (_templateObject200 = levelling_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))));
      have(template_string_$skill(_templateObject201 || (_templateObject201 = levelling_taggedTemplateLiteral(["Just the Facts"])))) && !have(template_string_$effect(_templateObject202 || (_templateObject202 = levelling_taggedTemplateLiteral(["Sweet and Red"])))) ? (0,external_kolmafia_namespaceObject.retrieveItem)(5, template_string_$item(_templateObject203 || (_templateObject203 = levelling_taggedTemplateLiteral(["seal-blubber candle"])))) : (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      have(template_string_$skill(_templateObject205 || (_templateObject205 = levelling_taggedTemplateLiteral(["Just the Facts"])))) && !have(template_string_$effect(_templateObject206 || (_templateObject206 = levelling_taggedTemplateLiteral(["Sweet and Red"])))) ? (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject207 || (_templateObject207 = levelling_taggedTemplateLiteral(["figurine of a cute baby seal"])))) : (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject208 || (_templateObject208 = levelling_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))));
    },
    outfit: () => oomfieOutfit({
      backOverride: !have(template_string_$effect(_templateObject209 || (_templateObject209 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) || !have(template_string_$effect(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))) ? template_string_$item(_templateObject211 || (_templateObject211 = levelling_taggedTemplateLiteral(["vampyric cloake"]))) : undefined,
      weaponOverride: template_string_$item(_templateObject212 || (_templateObject212 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))),
      offhandOverride: !have(template_string_$effect(_templateObject213 || (_templateObject213 = levelling_taggedTemplateLiteral(["Peppermint Rush"])))) ? template_string_$item(_templateObject214 || (_templateObject214 = levelling_taggedTemplateLiteral(["candy cane sword cane"]))) : undefined
    }),
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject215 || (_templateObject215 = levelling_taggedTemplateLiteral(["Sing Along"])))).externalIf(!have(template_string_$effect(_templateObject216 || (_templateObject216 = levelling_taggedTemplateLiteral(["Wolfish Form"])))), Macro.trySkill(template_string_$skill(_templateObject217 || (_templateObject217 = levelling_taggedTemplateLiteral(["Become a Wolf"]))))).externalIf(have(template_string_$effect(_templateObject218 || (_templateObject218 = levelling_taggedTemplateLiteral(["Wolfish Form"])))) && !have(template_string_$effect(_templateObject219 || (_templateObject219 = levelling_taggedTemplateLiteral(["Bat-Adjacent Form"])))), Macro.trySkill(template_string_$skill(_templateObject220 || (_templateObject220 = levelling_taggedTemplateLiteral(["Become a Bat"]))))).trySkill(template_string_$skill(_templateObject221 || (_templateObject221 = levelling_taggedTemplateLiteral(["Surprisingly Sweet Slash"])))).trySkill(template_string_$skill(_templateObject222 || (_templateObject222 = levelling_taggedTemplateLiteral(["Surprisingly Sweet Stab"])))).attack().repeat())
  }, {
    name: "Get Payphone Quest",
    completed: () => property_get("_shadowAffinityToday"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject223 || (_templateObject223 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 1
    }
  }, {
    name: "Payphone Freefights (extingo)",
    ready: () => have(template_string_$effect(_templateObject224 || (_templateObject224 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () =>  true || 0,
    do: () => shadowRiftChoice,
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject226 || (_templateObject226 = levelling_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().autoattack(() => customMacro.if_(shadowRiftPocketTarget(), customMacro.polarpocket(9 - (100 - property_get("_fireExtinguisherCharge")) / 10).trySkill(template_string_$skill(_templateObject227 || (_templateObject227 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).trySkill(template_string_$skill(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).attack().repeat())
  }, {
    name: "Payphone Freefights (cleaver)",
    ready: () => have(template_string_$effect(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject231 || (_templateObject231 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["candy cane sword cane"])))
    }),
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject233 || (_templateObject233 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject234 || (_templateObject234 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).trySkill(template_string_$skill(_templateObject235 || (_templateObject235 = levelling_taggedTemplateLiteral(["Surprisingly Sweet Slash"])))).trySkill(template_string_$skill(_templateObject236 || (_templateObject236 = levelling_taggedTemplateLiteral(["Surprisingly Sweet Stab"])))).attack().repeat())
  }, {
    ...
    completed: () => have(template_string_$item(_templateObject237 || (_templateObject237 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("questRufus") === "step1",
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject238 || (_templateObject238 = levelling_taggedTemplateLiteral(["Machine Elf"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.if_($monster(_templateObject239 || (_templateObject239 = levelling_taggedTemplateLiteral(["shadow matrix"]))), Macro.trySkill(template_string_$skill(_templateObject240 || (_templateObject240 = levelling_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkillRepeat(template_string_$skill(_templateObject241 || (_templateObject241 = levelling_taggedTemplateLiteral(["Saucegeyser"]))))).trySkillRepeat(template_string_$skill(_templateObject242 || (_templateObject242 = levelling_taggedTemplateLiteral(["Northern Explosion"])))))
  }, {
    name: "Retrieve Spooky Lodestone",
    ready: () => property_get("questRufus") === "step1",
    completed: () => have(template_string_$item(_templateObject243 || (_templateObject243 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject244 || (_templateObject244 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    post: () => (0,external_kolmafia_namespaceObject.cliExecute)("fold garbage shirt")
  }, {
    name: "Set Snojo Controls",
    completed: () => property_get("snojoSetting") === $stat(_templateObject245 || (_templateObject245 = levelling_taggedTemplateLiteral(["Moxie"]))),
    do: () => {
    ...
    do: $location(_templateObject246 || (_templateObject246 = levelling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject247 || (_templateObject247 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject248 || (_templateObject248 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject249 || (_templateObject249 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Visit Hottub",
    completed: () => [template_string_$effect(_templateObject250 || (_templateObject250 = levelling_taggedTemplateLiteral(["Snowballed"]))), template_string_$effect(_templateObject251 || (_templateObject251 = levelling_taggedTemplateLiteral(["Bruised"]))), template_string_$effect(_templateObject252 || (_templateObject252 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), template_string_$effect(_templateObject253 || (_templateObject253 = levelling_taggedTemplateLiteral(["Hypnotized"]))), template_string_$effect(_templateObject254 || (_templateObject254 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
    ...
    do: () => fightPiece($monster(_templateObject255 || (_templateObject255 = levelling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject256 || (_templateObject256 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject257 || (_templateObject257 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject258 || (_templateObject258 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Deep Machine Fights",
    completed: () => args.fam && args.familiar !== template_string_$familiar(_templateObject259 || (_templateObject259 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || property_get("_machineTunnelsAdv") >= 5,
    do: () => $location(_templateObject260 || (_templateObject260 = levelling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    outfit: {
      offhand: template_string_$item(_templateObject261 || (_templateObject261 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject262 || (_templateObject262 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject263 || (_templateObject263 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "broken"
      }
    },
    combat: new CombatStrategy().autoattack(() => Macro.externalIf(property_get("lastCopyableMonster") === $monster(_templateObject264 || (_templateObject264 = levelling_taggedTemplateLiteral(["Witchess Bishop"]))), Macro.trySkill(template_string_$skill(_templateObject265 || (_templateObject265 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).if_($monster(_templateObject266 || (_templateObject266 = levelling_taggedTemplateLiteral(["Perceiver of Sensations"]))), Macro.tryItem(template_string_$item(_templateObject267 || (_templateObject267 = levelling_taggedTemplateLiteral(["abstraction: thought"]))))).if_($monster(_templateObject268 || (_templateObject268 = levelling_taggedTemplateLiteral(["Thinker of Thoughts"]))), Macro.tryItem(template_string_$item(_templateObject269 || (_templateObject269 = levelling_taggedTemplateLiteral(["abstraction: action"]))))).trySkill(template_string_$skill(_templateObject270 || (_templateObject270 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Observe NEP Quest",
    completed: () => property_get("_questPartyFairQuest") !== "" || property_get("_questPartyFair") === "" || property_get("_neverendingPartyFreeTurns") >= 10,
    do: () => {
    ...
    ready: () => property_get("_questPartyFair") === "unstarted",
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)(50),
    completed: () => property_get("_neverendingPartyFreeTurns") >= 10,
    do: $location(_templateObject271 || (_templateObject271 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject272 || (_templateObject272 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject273 || (_templateObject273 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject274 || (_templateObject274 = levelling_taggedTemplateLiteral(["sausage goblin"]))), Macro.trySkill(template_string_$skill(_templateObject275 || (_templateObject275 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).trySkill(template_string_$skill(_templateObject276 || (_templateObject276 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject277 || (_templateObject277 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).trySkillRepeat(template_string_$skill(_templateObject278 || (_templateObject278 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject279 || (_templateObject279 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Witch",
    prepare: () => {
      (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)());
      (0,external_kolmafia_namespaceObject.restoreMp)(100);
    },
    completed: () => have(template_string_$item(_templateObject280 || (_templateObject280 = levelling_taggedTemplateLiteral(["battle broom"])))),
    do: () => fightPiece($monster(_templateObject281 || (_templateObject281 = levelling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject282 || (_templateObject282 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject283 || (_templateObject283 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkillRepeat(template_string_$skill(_templateObject284 || (_templateObject284 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject285 || (_templateObject285 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Queen",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject286 || (_templateObject286 = levelling_taggedTemplateLiteral(["very pointy crown"])))) || fightsDone() >= 5,
    do: () => fightPiece($monster(_templateObject287 || (_templateObject287 = levelling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().autoattack(Macro.attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject288 || (_templateObject288 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Shattering Punches",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)(50),
    completed: () => property_get("_shatteringPunchUsed") >= 3,
    do: $location(_templateObject289 || (_templateObject289 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject290 || (_templateObject290 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      weaponOverride: have(template_string_$item(_templateObject291 || (_templateObject291 = levelling_taggedTemplateLiteral(["fish hatchet"])))) ? template_string_$item(_templateObject292 || (_templateObject292 = levelling_taggedTemplateLiteral(["fish hatchet"]))) : template_string_$item(_templateObject293 || (_templateObject293 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      acc2Override: template_string_$item(_templateObject294 || (_templateObject294 = levelling_taggedTemplateLiteral(["Cincho de Mayo"]))),
      modesOverride: {
        umbrella: "broken",
        backupcamera: "ml"
      }
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject295 || (_templateObject295 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject296 || (_templateObject296 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject297 || (_templateObject297 = levelling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject298 || (_templateObject298 = levelling_taggedTemplateLiteral(["Cincho: Confetti Extravaganza"])))).trySkill(template_string_$skill(_templateObject299 || (_templateObject299 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject300 || (_templateObject300 = levelling_taggedTemplateLiteral(["Shattering Punch"])))).abort())
  }, {
    name: "Chest X-rays",
    completed: () => property_get("_chestXRayUsed") >= 3,
    do: $location(_templateObject301 || (_templateObject301 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      acc2: template_string_$item(_templateObject302 || (_templateObject302 = levelling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject303 || (_templateObject303 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject304 || (_templateObject304 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject305 || (_templateObject305 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject306 || (_templateObject306 = levelling_taggedTemplateLiteral(["Chest X-Ray"])))).abort())
  }, {
    name: "Mob-Hit",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreMp)(50),
    completed: () => property_get("_gingerbreadMobHitUsed"),
    do: $location(_templateObject307 || (_templateObject307 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject308 || (_templateObject308 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject309 || (_templateObject309 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject310 || (_templateObject310 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject311 || (_templateObject311 = levelling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort())
  }]
};
...
var noncombatQuest = {
  ...
  tasks: [{
    name: "Shadow Waters",
    completed: () => have(template_string_$effect(noncombat_templateObject || (noncombat_templateObject = noncombat_taggedTemplateLiteral(["Shadow Waters"])))) || !have(template_string_$item(noncombat_templateObject2 || (noncombat_templateObject2 = noncombat_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    ...
    ready: () => have(template_string_$item(noncombat_templateObject4 || (noncombat_templateObject4 = noncombat_taggedTemplateLiteral(["ultra-soft ferns"])))),
    completed: () => have(template_string_$effect(noncombat_templateObject5 || (noncombat_templateObject5 = noncombat_taggedTemplateLiteral(["Ultra-Soft Steps"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(noncombat_templateObject6 || (noncombat_templateObject6 = noncombat_taggedTemplateLiteral(["ultra-soft ferns"]))))
  }, {
    name: "Squeaky Rose",
    completed: () => !have(template_string_$item(noncombat_templateObject7 || (noncombat_templateObject7 = noncombat_taggedTemplateLiteral(["squeaky toy rose"])))) || have(template_string_$effect(noncombat_templateObject8 || (noncombat_templateObject8 = noncombat_taggedTemplateLiteral(["A Rose by Any Other Material"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(noncombat_templateObject9 || (noncombat_templateObject9 = noncombat_taggedTemplateLiteral(["squeaky toy rose"])))),
    outfit: () => ({
      familiar: template_string_$familiar(noncombat_templateObject10 || (noncombat_templateObject10 = noncombat_taggedTemplateLiteral(["Disgeist"])))
    })
  }, {
    name: "Shady Shades",
    completed: () => !have(template_string_$item(noncombat_templateObject11 || (noncombat_templateObject11 = noncombat_taggedTemplateLiteral(["shady shades"])))) || have(template_string_$effect(noncombat_templateObject12 || (noncombat_templateObject12 = noncombat_taggedTemplateLiteral(["Throwing Some Shade"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(noncombat_templateObject13 || (noncombat_templateObject13 = noncombat_taggedTemplateLiteral(["shady shades"])))),
    outfit: () => ({
    ...
    effects: [template_string_$effect(noncombat_templateObject14 || (noncombat_templateObject14 = noncombat_taggedTemplateLiteral(["Empathy"]))), template_string_$effect(noncombat_templateObject15 || (noncombat_templateObject15 = noncombat_taggedTemplateLiteral(["Blood Bond"]))), template_string_$effect(noncombat_templateObject16 || (noncombat_templateObject16 = noncombat_taggedTemplateLiteral(["Leash of Linguini"]))), template_string_$effect(noncombat_templateObject17 || (noncombat_templateObject17 = noncombat_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), template_string_$effect(noncombat_templateObject18 || (noncombat_templateObject18 = noncombat_taggedTemplateLiteral(["Smooth Movements"]))), template_string_$effect(noncombat_templateObject19 || (noncombat_templateObject19 = noncombat_taggedTemplateLiteral(["Feeling Lonely"])))]
  }, {
    name: "Silent Running",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(noncombat_templateObject20 || (noncombat_templateObject20 = noncombat_taggedTemplateLiteral(["Silent Running"])))) || property_get("_olympicSwimmingPool") || CommunityService.Noncombat.prediction <= 1,
    do: () => {
      ...
      if (CommunityService.Noncombat.prediction > 0 && actualTurncost !== CommunityService.Noncombat.prediction) {
        (0,external_kolmafia_namespaceObject.print)("The Actual Cost and the Prediction are mismatched!");
        printModtrace("combat rate");
        (0,external_kolmafia_namespaceObject.cliExecute)("refresh all");
        printModtrace("combat rate");
        if (CommunityService.Noncombat.prediction > 0 && actualTurncost !== CommunityService.Noncombat.prediction) {
          (0,external_kolmafia_namespaceObject.abort)("Could not Resolve mismatch");
        }
      }
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.Noncombat.run(() => logTest(CommunityService.Noncombat, testTurns, predictedTestTurns), 1);
    },
    limit: {
      tries: 1
    }
...
function prequelPulls() {
  return [template_string_$item(runStart_templateObject || (runStart_templateObject = runStart_taggedTemplateLiteral(["Calzone of Legend"]))), template_string_$item(runStart_templateObject2 || (runStart_templateObject2 = runStart_taggedTemplateLiteral(["Pizza of Legend"]))), template_string_$item(runStart_templateObject3 || (runStart_templateObject3 = runStart_taggedTemplateLiteral(["Stick-Knife of Loathing"]))), args.fam ? template_string_$item(runStart_templateObject4 || (runStart_templateObject4 = runStart_taggedTemplateLiteral(["wasabi marble soda"]))) : template_string_$item(runStart_templateObject5 || (runStart_templateObject5 = runStart_taggedTemplateLiteral(["Great Wolf's beastly trousers"])))];
}
function degreeTask(degreeChoice) {
  return {
    name: "S.I.T Degree: ".concat(degreeChoice, "!"),
    completed: () => property_get("_sitCourseCompleted"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject6 || (runStart_templateObject6 = runStart_taggedTemplateLiteral(["S.I.T. Course Completion Certificate"])))),
    choices: () => ({
      1494: degreeChoice === "Psychogeologist" ? 1 : degreeChoice === "Insectologist" ? 2 : 3
    })
  };
}
function latheItemTask(item) {
  if (item !== template_string_$item(runStart_templateObject7 || (runStart_templateObject7 = runStart_taggedTemplateLiteral(["ebony epee"]))) && item !== template_string_$item(runStart_templateObject8 || (runStart_templateObject8 = runStart_taggedTemplateLiteral(["weeping willow wand"])))) (0,external_kolmafia_namespaceObject.abort)("Invalid Lathe!");
  return {
    name: "Lathe: Create ".concat(item.name, "!"),
    prepare: () => (0,external_kolmafia_namespaceObject.visitUrl)("shop.php?whichshop=lathe"),
    completed: () => have(item),
    do: () => (0,external_kolmafia_namespaceObject.create)(1, item)
  };
}
var prequelQuest = {
  name: "Prequel Tasks!",
  ...
  tasks: [{
    name: "Begin Timing!",
    completed: () => property_get("_mustardServiceTime", "") !== "",
    do: () => _set("_mustardServiceTime", (0,external_kolmafia_namespaceObject.nowToInt)())
  }, degreeTask("Psychogeologist"), latheItemTask(template_string_$item(runStart_templateObject9 || (runStart_templateObject9 = runStart_taggedTemplateLiteral(["weeping willow wand"])))), {
    name: "Fall Guy: Autumn Leaf",
    ready: () => AutumnAton_available(),
    completed: () => have(template_string_$item(runStart_templateObject10 || (runStart_templateObject10 = runStart_taggedTemplateLiteral(["autumn leaf"])))),
    do: () => {
      sendTo($location(runStart_templateObject11 || (runStart_templateObject11 = runStart_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
    }
  }, {
    name: "Pull!",
    completed: () => prequelPulls().every(I => property_get("_roninStoragePulls").split(",").includes("".concat(I.id))),
    do: () => prequelPulls().forEach(I => (0,external_kolmafia_namespaceObject.takeStorage)(1, I))
  }, {
    name: "Numberology Attempt",
    ready: () => Object.keys((0,external_kolmafia_namespaceObject.reverseNumberology)()).includes("69") && have(template_string_$skill(runStart_templateObject12 || (runStart_templateObject12 = runStart_taggedTemplateLiteral(["Calculate the Universe"])))),
    ...
    ready: () => (0,external_kolmafia_namespaceObject.myClass)() === $class(runStart_templateObject13 || (runStart_templateObject13 = runStart_taggedTemplateLiteral(["Seal Clubber"]))),
    completed: () => true,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("doublevote 3")
  }, {
    name: "Get Cowboy Boots!",
    ready: () => property_get("telegraphOfficeAvailable"),
    completed: () => have(template_string_$item(runStart_templateObject14 || (runStart_templateObject14 = runStart_taggedTemplateLiteral(["your cowboy boots"])))),
    do: () => {
    ...
    completed: () => !have(template_string_$item(runStart_templateObject15 || (runStart_templateObject15 = runStart_taggedTemplateLiteral(["letter from King Ralph XI"])))) && property_get("questM05Toot") === "finished",
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject16 || (runStart_templateObject16 = runStart_taggedTemplateLiteral(["letter from King Ralph XI"]))))
  }, {
    name: "Get that bag oomfie!!!",
    completed: () => !have(template_string_$item(runStart_templateObject17 || (runStart_templateObject17 = runStart_taggedTemplateLiteral(["pork elf goodies sack"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject18 || (runStart_templateObject18 = runStart_taggedTemplateLiteral(["pork elf goodies sack"]))))
  }, {
    name: "Sell Non-porquoise",
    completed: () => [template_string_$item(runStart_templateObject19 || (runStart_templateObject19 = runStart_taggedTemplateLiteral(["baconstone"]))), template_string_$item(runStart_templateObject20 || (runStart_templateObject20 = runStart_taggedTemplateLiteral(["hamethyst"])))].every(I => !have(I)),
    do: () => [template_string_$item(runStart_templateObject21 || (runStart_templateObject21 = runStart_taggedTemplateLiteral(["baconstone"]))), template_string_$item(runStart_templateObject22 || (runStart_templateObject22 = runStart_taggedTemplateLiteral(["hamethyst"])))].forEach(I => (0,external_kolmafia_namespaceObject.autosell)((0,external_kolmafia_namespaceObject.availableAmount)(I), I))
  }, barrelSmashing, {
    name: "Sell Barrel Junk",
    completed: () => barrelItems.every(I => !have(I)),
    do: () => barrelItems.forEach(I => (0,external_kolmafia_namespaceObject.autosell)(I, (0,external_kolmafia_namespaceObject.availableAmount)(I)))
  }, {
    name: "Sell Porquoise",
    completed: () => (0,external_kolmafia_namespaceObject.myMeat)() >= 81,
    do: () => (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(runStart_templateObject23 || (runStart_templateObject23 = runStart_taggedTemplateLiteral(["porquoise"]))))
  }, {
    name: "Open Astral Drinks!",
    completed: () => !have(template_string_$item(runStart_templateObject24 || (runStart_templateObject24 = runStart_taggedTemplateLiteral(["astral six-pack"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject25 || (runStart_templateObject25 = runStart_taggedTemplateLiteral(["astral six-pack"]))))
  }, {
    name: "Apriling Band: +combat",
    ready: () => AprilingBandHelmet_have(),
    completed: () => have(template_string_$effect(runStart_templateObject26 || (runStart_templateObject26 = runStart_taggedTemplateLiteral(["Apriling Band Battle Cadence"])))) || !canChangeSong(),
    do: () => conduct("Apriling Band Battle Cadence")
  }, {
    ...
    completed: () => property_get("_borrowedTimeUsed") || have(template_string_$item(runStart_templateObject27 || (runStart_templateObject27 = runStart_taggedTemplateLiteral(["borrowed time"])))),
    do: () => (0,external_kolmafia_namespaceObject.create)(1, template_string_$item(runStart_templateObject28 || (runStart_templateObject28 = runStart_taggedTemplateLiteral(["borrowed time"]))))
  }, {
    name: "Use Borrowed Time!",
    completed: () => !have(template_string_$item(runStart_templateObject29 || (runStart_templateObject29 = runStart_taggedTemplateLiteral(["borrowed time"])))) || property_get("_borrowedTimeUsed"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject30 || (runStart_templateObject30 = runStart_taggedTemplateLiteral(["borrowed time"]))))
  }, {
    name: "Mummery!",
    completed: () => property_get("_mummeryUses") !== "",
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject31 || (runStart_templateObject31 = runStart_taggedTemplateLiteral(["mumming trunk"])))),
    choices: () => ({
      1071: 3
    }),
    outfit: () => oomfieOutfit()
    ...
    name: "Saber: Familiar!",
    ready: () => have(template_string_$item(runStart_templateObject32 || (runStart_templateObject32 = runStart_taggedTemplateLiteral(["Fourth of May Cosplay Saber"])))),
    ...
    ready: () => (0,external_kolmafia_namespaceObject.canadiaAvailable)() || have(template_string_$item(runStart_templateObject33 || (runStart_templateObject33 = runStart_taggedTemplateLiteral(["detuned radio"])))),
    ...
    outfit: {
      offhand: template_string_$item(runStart_templateObject34 || (runStart_templateObject34 = runStart_taggedTemplateLiteral(["familiar scrapbook"])))
    },
    choices: {
      1334: 2,
      1336: 1
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject35 || (runStart_templateObject35 = runStart_taggedTemplateLiteral(["model train set"])))),
    ready: () => have(template_string_$item(runStart_templateObject36 || (runStart_templateObject36 = runStart_taggedTemplateLiteral(["model train set"])))),
    completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(runStart_templateObject37 || (runStart_templateObject37 = runStart_taggedTemplateLiteral(["model train set"]))) && property_get("trainsetConfiguration") !== "",
    ...
    completed: () => property_get(guildQuest) !== "unstarted",
    do: () => {
    ...
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$item(runStart_templateObject38 || (runStart_templateObject38 = runStart_taggedTemplateLiteral(["red rocket"])))) || have(template_string_$effect(runStart_templateObject39 || (runStart_templateObject39 = runStart_taggedTemplateLiteral(["Ready to Eat"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(runStart_templateObject40 || (runStart_templateObject40 = runStart_taggedTemplateLiteral(["red rocket"]))))
  }, {
    name: "Pre-Coil Kramco Wanderer!",
    completed: () => getKramcoWandererChance() < 1,
    do: () => guildZone,
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(runStart_templateObject41 || (runStart_templateObject41 = runStart_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))),
      modesOverride: {
        parka: "kachungasaur",
        backupcamera: "meat"
      }
    }),
    combat: new CombatStrategy().autoattack(() => Macro.tryItem(template_string_$item(runStart_templateObject42 || (runStart_templateObject42 = runStart_taggedTemplateLiteral(["red rocket"])))).trySkill(template_string_$skill(runStart_templateObject43 || (runStart_templateObject43 = runStart_taggedTemplateLiteral(["Summon Love Gnats"])))).trySkill(template_string_$skill(runStart_templateObject44 || (runStart_templateObject44 = runStart_taggedTemplateLiteral(["Summon Love Mosquito"])))).attack().repeat())
  }, {
    name: "May Day!",
    completed: () => !have(template_string_$item(runStart_templateObject45 || (runStart_templateObject45 = runStart_taggedTemplateLiteral(["MayDay\u2122 supply package"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject46 || (runStart_templateObject46 = runStart_taggedTemplateLiteral(["MayDay\u2122 supply package"]))))
  }, {
    name: "Sell Space Blanket!",
    completed: () => !have(template_string_$item(runStart_templateObject47 || (runStart_templateObject47 = runStart_taggedTemplateLiteral(["space blanket"])))),
    do: () => (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(runStart_templateObject48 || (runStart_templateObject48 = runStart_taggedTemplateLiteral(["space blanket"]))))
  }, {
    name: "Buy: Detuned Radio!",
    ready: () => (0,external_kolmafia_namespaceObject.knollAvailable)(),
    completed: () => have(template_string_$item(runStart_templateObject49 || (runStart_templateObject49 = runStart_taggedTemplateLiteral(["detuned radio"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(runStart_templateObject50 || (runStart_templateObject50 = runStart_taggedTemplateLiteral(["detuned radio"]))))
  }, {
    name: "Buy: Chewing Gum",
    ready: () => !have(template_string_$item(runStart_templateObject51 || (runStart_templateObject51 = runStart_taggedTemplateLiteral(["turtle totem"])))) || !have(template_string_$item(runStart_templateObject52 || (runStart_templateObject52 = runStart_taggedTemplateLiteral(["saucepan"])))),
    completed: () => have(template_string_$item(runStart_templateObject53 || (runStart_templateObject53 = runStart_taggedTemplateLiteral(["chewing gum on a string"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(have(template_string_$item(runStart_templateObject54 || (runStart_templateObject54 = runStart_taggedTemplateLiteral(["turtle totem"])))) || have(template_string_$item(runStart_templateObject55 || (runStart_templateObject55 = runStart_taggedTemplateLiteral(["saucepan"])))) ? 1 : 2, template_string_$item(runStart_templateObject56 || (runStart_templateObject56 = runStart_taggedTemplateLiteral(["chewing gum on a string"])))),
    outfit: () => ({
      pants: template_string_$item(runStart_templateObject57 || (runStart_templateObject57 = runStart_taggedTemplateLiteral(["designer sweatpants"])))
    })
  }, {
    name: "Buy: Toy Accordion",
    completed: () => have(template_string_$item(runStart_templateObject58 || (runStart_templateObject58 = runStart_taggedTemplateLiteral(["toy accordion"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(runStart_templateObject59 || (runStart_templateObject59 = runStart_taggedTemplateLiteral(["toy accordion"]))))
  }, {
    name: "Acquire Bufftools",
    completed: () => have(template_string_$item(runStart_templateObject60 || (runStart_templateObject60 = runStart_taggedTemplateLiteral(["turtle totem"])))) && have(template_string_$item(runStart_templateObject61 || (runStart_templateObject61 = runStart_taggedTemplateLiteral(["saucepan"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(runStart_templateObject62 || (runStart_templateObject62 = runStart_taggedTemplateLiteral(["chewing gum on a string"])))), template_string_$item(runStart_templateObject63 || (runStart_templateObject63 = runStart_taggedTemplateLiteral(["chewing gum on a string"]))))
  }, {
    name: "Fight: Red Skeleton (Locket)",
    completed: () => monstersReminisced().includes($monster(runStart_templateObject64 || (runStart_templateObject64 = runStart_taggedTemplateLiteral(["red skeleton"])))),
    do: () => reminisce($monster(runStart_templateObject65 || (runStart_templateObject65 = runStart_taggedTemplateLiteral(["red skeleton"])))),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(runStart_templateObject66 || (runStart_templateObject66 = runStart_taggedTemplateLiteral(["Feel Hatred"])))).abort())
  }, {
    name: "Fight: Novelty Tropical Skeleton (Map)",
    ready: () => property_get("lastCopyableMonster") === $monster(runStart_templateObject67 || (runStart_templateObject67 = runStart_taggedTemplateLiteral(["red skeleton"]))),
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$effect(runStart_templateObject68 || (runStart_templateObject68 = runStart_taggedTemplateLiteral(["Everything Looks Yellow"])))) && have(template_string_$item(runStart_templateObject69 || (runStart_templateObject69 = runStart_taggedTemplateLiteral(["cherry"])))),
    ...
    combat: new CombatStrategy().autoattack(() => Macro.if_($monster(runStart_templateObject72 || (runStart_templateObject72 = runStart_taggedTemplateLiteral(["novelty tropical skeleton"]))), Macro.trySkill(template_string_$skill(runStart_templateObject73 || (runStart_templateObject73 = runStart_taggedTemplateLiteral(["Feel Nostalgic"])))).trySkill(template_string_$skill(runStart_templateObject74 || (runStart_templateObject74 = runStart_taggedTemplateLiteral(["Spit jurassic acid"])))).abort()).trySkill(template_string_$skill(runStart_templateObject75 || (runStart_templateObject75 = runStart_taggedTemplateLiteral(["CLEESH"])))).trySkill(template_string_$skill(runStart_templateObject76 || (runStart_templateObject76 = runStart_taggedTemplateLiteral(["Bowl a Curveball"])))).abort()),
    outfit: () => oomfieOutfit({
      hatOverride: template_string_$item.none,
      offhandOverride: template_string_$item(runStart_templateObject77 || (runStart_templateObject77 = runStart_taggedTemplateLiteral(["unbreakable umbrella"]))),
      shirtOverride: template_string_$item(runStart_templateObject78 || (runStart_templateObject78 = runStart_taggedTemplateLiteral(["Jurassic Parka"]))),
      acc1Override: template_string_$item(runStart_templateObject79 || (runStart_templateObject79 = runStart_taggedTemplateLiteral(["backup camera"]))),
      acc2Override: template_string_$item(runStart_templateObject80 || (runStart_templateObject80 = runStart_taggedTemplateLiteral(["your cowboy boots"]))),
      modesOverride: {
        parka: "dilophosaur",
        umbrella: "broken",
        backupcamera: "ml"
    ...
    name: "Open Red Box!",
    completed: () => !have(template_string_$item(runStart_templateObject81 || (runStart_templateObject81 = runStart_taggedTemplateLiteral(["red box"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject82 || (runStart_templateObject82 = runStart_taggedTemplateLiteral(["red box"]))))
  }, {
    name: "Purchase Fireworks Hat!",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$item(runStart_templateObject83 || (runStart_templateObject83 = runStart_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(runStart_templateObject84 || (runStart_templateObject84 = runStart_taggedTemplateLiteral(["sombrero-mounted sparkler"]))))
  }, {
    name: "Unlock the Guild: Freeruns!",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished",
    do: () => guildZone,
    effects: () => [template_string_$effect(runStart_templateObject85 || (runStart_templateObject85 = runStart_taggedTemplateLiteral(["Musk of the Moose"]))), template_string_$effect(runStart_templateObject86 || (runStart_templateObject86 = runStart_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), !args.fam ? template_string_$effect(runStart_templateObject87 || (runStart_templateObject87 = runStart_taggedTemplateLiteral(["Blood Bond"]))) : template_string_$effect(runStart_templateObject88 || (runStart_templateObject88 = runStart_taggedTemplateLiteral(["Musk of the Moose"]))), !args.fam ? template_string_$effect(runStart_templateObject89 || (runStart_templateObject89 = runStart_taggedTemplateLiteral(["Empathy"]))) : template_string_$effect(runStart_templateObject90 || (runStart_templateObject90 = runStart_taggedTemplateLiteral(["Musk of the Moose"])))],
    outfit: () => oomfieOutfit({
      hatOverride: template_string_$item(runStart_templateObject91 || (runStart_templateObject91 = runStart_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      offhandOverride: template_string_$item(runStart_templateObject92 || (runStart_templateObject92 = runStart_taggedTemplateLiteral(["familiar scrapbook"]))),
      acc1Override: property_get("_reflexHammerUsed") >= 3 ? template_string_$item(runStart_templateObject93 || (runStart_templateObject93 = runStart_taggedTemplateLiteral(["backup camera"]))) : template_string_$item(runStart_templateObject94 || (runStart_templateObject94 = runStart_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
      acc2Override: have(template_string_$item(runStart_templateObject95 || (runStart_templateObject95 = runStart_taggedTemplateLiteral(["spring shoes"])))) && !(0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(runStart_templateObject96 || (runStart_templateObject96 = runStart_taggedTemplateLiteral(["spring shoes"])))) ? template_string_$item(runStart_templateObject97 || (runStart_templateObject97 = runStart_taggedTemplateLiteral(["spring shoes"]))) : undefined,
      familiarOverride: args.fam ? args.familiar : template_string_$familiar(runStart_templateObject98 || (runStart_templateObject98 = runStart_taggedTemplateLiteral(["Pair of Stomping Boots"])))
    }),
    combat: new CombatStrategy().autoattack(() => Macro.externalIf((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(runStart_templateObject99 || (runStart_templateObject99 = runStart_taggedTemplateLiteral(["spring shoes"])))) && !have(template_string_$effect(runStart_templateObject100 || (runStart_templateObject100 = runStart_taggedTemplateLiteral(["Everything Looks Green"])))), Macro.trySkill(template_string_$skill(runStart_templateObject101 || (runStart_templateObject101 = runStart_taggedTemplateLiteral(["Spring Away"]))))).externalIf((0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar(runStart_templateObject102 || (runStart_templateObject102 = runStart_taggedTemplateLiteral(["Pair of Stomping Boots"]))), Macro.runaway().abort()).externalIf((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(runStart_templateObject103 || (runStart_templateObject103 = runStart_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))), Macro.trySkill(template_string_$skill(runStart_templateObject104 || (runStart_templateObject104 = runStart_taggedTemplateLiteral(["Reflex Hammer"]))))).trySkill(template_string_$skill(runStart_templateObject105 || (runStart_templateObject105 = runStart_taggedTemplateLiteral(["Feel Hatred"])))).abort())
  }, {
    name: "Cemetery Unlock",
    // Note: Only works for SC probably (lack of testing)
    completed: () => (0,external_kolmafia_namespaceObject.canAdventure)($location(runStart_templateObject106 || (runStart_templateObject106 = runStart_taggedTemplateLiteral(["The Unquiet Garves"])))),
    do: () => {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myAdventures)() >= 60,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(runStart_templateObject107 || (runStart_templateObject107 = runStart_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(runStart_templateObject108 || (runStart_templateObject108 = runStart_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.adv1)($location(runStart_templateObject109 || (runStart_templateObject109 = runStart_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
      ensureEffect(template_string_$effect(runStart_templateObject110 || (runStart_templateObject110 = runStart_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(runStart_templateObject111 || (runStart_templateObject111 = runStart_taggedTemplateLiteral(["distilled fortified wine"]))));
      uneffect(template_string_$effect(runStart_templateObject112 || (runStart_templateObject112 = runStart_taggedTemplateLiteral(["Ode to Booze"]))));
    }
  }]
};
;// CONCATENATED MODULE: ./src/tasks/sdmg.ts
var sdmg_templateObject, sdmg_templateObject2, sdmg_templateObject3, sdmg_templateObject4, sdmg_templateObject5, sdmg_templateObject6, sdmg_templateObject7, sdmg_templateObject8, sdmg_templateObject9, sdmg_templateObject10, sdmg_templateObject11, sdmg_templateObject12, sdmg_templateObject13, sdmg_templateObject14, sdmg_templateObject15, sdmg_templateObject16, sdmg_templateObject17, sdmg_templateObject18, sdmg_templateObject19, sdmg_templateObject20, sdmg_templateObject21, sdmg_templateObject22, sdmg_templateObject23, sdmg_templateObject24, sdmg_templateObject25, sdmg_templateObject26, sdmg_templateObject27, sdmg_templateObject28, sdmg_templateObject29, sdmg_templateObject30, sdmg_templateObject31, sdmg_templateObject32, sdmg_templateObject33, sdmg_templateObject34;
...
var sdmgQuest = {
  ...
  tasks: [{
    name: "Simmer",
    completed: () => have(template_string_$effect(sdmg_templateObject || (sdmg_templateObject = sdmg_taggedTemplateLiteral(["Simmering"])))),
    ...
    name: "Pull!",
    completed: () => have(template_string_$item(sdmg_templateObject3 || (sdmg_templateObject3 = sdmg_taggedTemplateLiteral(["Staff of Simmering Hatred"])))) || have(template_string_$item(sdmg_templateObject4 || (sdmg_templateObject4 = sdmg_taggedTemplateLiteral(["tobiko marble soda"])))) || have(template_string_$effect(sdmg_templateObject5 || (sdmg_templateObject5 = sdmg_taggedTemplateLiteral(["Pisces in the Skyces"])))) || property_get("_roninStoragePulls").split(",").length === 5,
    do: () => (0,external_kolmafia_namespaceObject.myBasestat)($stat(sdmg_templateObject6 || (sdmg_templateObject6 = sdmg_taggedTemplateLiteral(["Mysticality"])))) >= 125 ? (0,external_kolmafia_namespaceObject.takeStorage)(1, template_string_$item(sdmg_templateObject7 || (sdmg_templateObject7 = sdmg_taggedTemplateLiteral(["tobiko marble soda"])))) //takeStorage(1, $item`Staff of Simmering Hatred`)
    : (0,external_kolmafia_namespaceObject.takeStorage)(1, template_string_$item(sdmg_templateObject8 || (sdmg_templateObject8 = sdmg_taggedTemplateLiteral(["tobiko marble soda"]))))
  }, {
    name: "Tobiko Marble Soda",
    completed: () => have(template_string_$effect(sdmg_templateObject9 || (sdmg_templateObject9 = sdmg_taggedTemplateLiteral(["Pisces in the Skyces"])))) || !have(template_string_$item(sdmg_templateObject10 || (sdmg_templateObject10 = sdmg_taggedTemplateLiteral(["tobiko marble soda"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(sdmg_templateObject11 || (sdmg_templateObject11 = sdmg_taggedTemplateLiteral(["tobiko marble soda"]))))
  }, {
    name: "Obsidian Nutcracker",
    completed: () => have(template_string_$item(sdmg_templateObject12 || (sdmg_templateObject12 = sdmg_taggedTemplateLiteral(["weeping willow wand"])))) || have(template_string_$item(sdmg_templateObject13 || (sdmg_templateObject13 = sdmg_taggedTemplateLiteral(["Staff of Simmering Hatred"])))) || have(template_string_$item(sdmg_templateObject14 || (sdmg_templateObject14 = sdmg_taggedTemplateLiteral(["obsidian nutcracker"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(sdmg_templateObject15 || (sdmg_templateObject15 = sdmg_taggedTemplateLiteral(["obsidian nutcracker"]))))
  }, {
    name: "Cargo Handsoap!",
    completed: () => property_get("_cargoPocketEmptied") || have(template_string_$item(sdmg_templateObject16 || (sdmg_templateObject16 = sdmg_taggedTemplateLiteral(["Yeg's Motel hand soap"])))) || have(template_string_$effect(sdmg_templateObject17 || (sdmg_templateObject17 = sdmg_taggedTemplateLiteral(["Sigils of Yeg"])))),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("cargo 177"),
    post: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(sdmg_templateObject18 || (sdmg_templateObject18 = sdmg_taggedTemplateLiteral(["Yeg's Motel hand soap"]))))
  }, {
    name: "Inner Elf",
    prepare: () => Clan.join("Beldungeon"),
    completed: () => args.fam || !have(template_string_$familiar(sdmg_templateObject19 || (sdmg_templateObject19 = sdmg_taggedTemplateLiteral(["Machine Elf"])))) || have(template_string_$effect(sdmg_templateObject20 || (sdmg_templateObject20 = sdmg_taggedTemplateLiteral(["Inner Elf"])))) || property_get("_snokebombUsed") >= 3,
    do: $location(sdmg_templateObject21 || (sdmg_templateObject21 = sdmg_taggedTemplateLiteral(["The Slime Tube"]))),
    outfit: {
      shirt: template_string_$item(sdmg_templateObject22 || (sdmg_templateObject22 = sdmg_taggedTemplateLiteral(["Jurassic Parka"]))),
      familiar: template_string_$familiar(sdmg_templateObject23 || (sdmg_templateObject23 = sdmg_taggedTemplateLiteral(["Machine Elf"]))),
      modes: {
        parka: "kachungasaur"
      }
    },
    effects: [template_string_$effect(sdmg_templateObject24 || (sdmg_templateObject24 = sdmg_taggedTemplateLiteral(["Blood Bubble"])))],
    choices: {
      326: 1
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(sdmg_templateObject25 || (sdmg_templateObject25 = sdmg_taggedTemplateLiteral(["Snokebomb"])))).abort())
  }, {
    name: "Buy: Codpiece",
    prepare: () => Clan.join("Floundry"),
    completed: () => have(template_string_$item(sdmg_templateObject26 || (sdmg_templateObject26 = sdmg_taggedTemplateLiteral(["red shoe"])))) || have(template_string_$item(sdmg_templateObject27 || (sdmg_templateObject27 = sdmg_taggedTemplateLiteral(["ultra-soft ferns"])))) || have(template_string_$item(sdmg_templateObject28 || (sdmg_templateObject28 = sdmg_taggedTemplateLiteral(["codpiece"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(sdmg_templateObject29 || (sdmg_templateObject29 = sdmg_taggedTemplateLiteral(["codpiece"]))))
  }, {
    name: "Spell Damage Poolbuff",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(sdmg_templateObject30 || (sdmg_templateObject30 = sdmg_taggedTemplateLiteral(["Mental A-cue-ity"])))),
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.SpellDamage.run(() => logTest(CommunityService.SpellDamage, testTurns, predictedTestTurns), 34);
    },
    outfit: {
      modifier: "spell damage, switch left-hand man"
    },
    effects: [template_string_$effect(sdmg_templateObject31 || (sdmg_templateObject31 = sdmg_taggedTemplateLiteral(["Song of Sauce"]))), template_string_$effect(sdmg_templateObject32 || (sdmg_templateObject32 = sdmg_taggedTemplateLiteral(["Carol of the Hells"]))), template_string_$effect(sdmg_templateObject33 || (sdmg_templateObject33 = sdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), template_string_$effect(sdmg_templateObject34 || (sdmg_templateObject34 = sdmg_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"])))],
    limit: {
      tries: 1
    }
  }]
...
var muscleQuest = {
  ...
  tasks: [{
    ...
    name: "Muscle Test",
    prepare: () => [template_string_$effect(stats_templateObject || (stats_templateObject = stats_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), template_string_$effect(stats_templateObject2 || (stats_templateObject2 = stats_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), template_string_$effect(stats_templateObject3 || (stats_templateObject3 = stats_taggedTemplateLiteral(["Aloysius' Antiphon of Aptitude"])))].forEach(ef => uneffect(ef)),
    completed: () => CommunityService.Muscle.isDone(),
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.Muscle.run(() => logTest(CommunityService.Muscle, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "Muscle, switch left-hand man"
    },
    effects: [template_string_$effect(stats_templateObject4 || (stats_templateObject4 = stats_taggedTemplateLiteral(["Big"]))), template_string_$effect(stats_templateObject5 || (stats_templateObject5 = stats_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), template_string_$effect(stats_templateObject6 || (stats_templateObject6 = stats_taggedTemplateLiteral(["Quiet Determination"]))), template_string_$effect(stats_templateObject7 || (stats_templateObject7 = stats_taggedTemplateLiteral(["Rage of the Reindeer"]))), template_string_$effect(stats_templateObject8 || (stats_templateObject8 = stats_taggedTemplateLiteral(["Song of Bravado"]))), template_string_$effect(stats_templateObject9 || (stats_templateObject9 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), template_string_$effect(stats_templateObject10 || (stats_templateObject10 = stats_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), template_string_$effect(stats_templateObject11 || (stats_templateObject11 = stats_taggedTemplateLiteral(["Patience of the Tortoise"])))],
    limit: {
      tries: 1
    }
  }]
...
var mystQuest = {
  ...
  tasks: [{
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.Mysticality.run(() => logTest(CommunityService.Mysticality, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "Mysticality, switch left-hand man"
    },
    post: () => uneffect(template_string_$effect(stats_templateObject12 || (stats_templateObject12 = stats_taggedTemplateLiteral(["The Magical Mojomuscular Melody"])))),
    effects: [template_string_$effect(stats_templateObject13 || (stats_templateObject13 = stats_taggedTemplateLiteral(["Big"]))), template_string_$effect(stats_templateObject14 || (stats_templateObject14 = stats_taggedTemplateLiteral(["Glittering Eyelashes"]))), template_string_$effect(stats_templateObject15 || (stats_templateObject15 = stats_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))), template_string_$effect(stats_templateObject16 || (stats_templateObject16 = stats_taggedTemplateLiteral(["Saucemastery"]))), template_string_$effect(stats_templateObject17 || (stats_templateObject17 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), template_string_$effect(stats_templateObject18 || (stats_templateObject18 = stats_taggedTemplateLiteral(["Quiet Judgement"]))), template_string_$effect(stats_templateObject19 || (stats_templateObject19 = stats_taggedTemplateLiteral(["Song of Bravado"]))), template_string_$effect(stats_templateObject20 || (stats_templateObject20 = stats_taggedTemplateLiteral(["Pasta Oneness"])))],
    limit: {
      tries: 1
    }
  }]
...
var moxQuest = {
  ...
  tasks: [{
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.Moxie.run(() => logTest(CommunityService.Moxie, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "Moxie, switch left-hand man"
    },
    effects: [template_string_$effect(stats_templateObject21 || (stats_templateObject21 = stats_taggedTemplateLiteral(["Big"]))), template_string_$effect(stats_templateObject22 || (stats_templateObject22 = stats_taggedTemplateLiteral(["Butt-Rock Hair"]))), template_string_$effect(stats_templateObject23 || (stats_templateObject23 = stats_taggedTemplateLiteral(["Disco Fever"]))), template_string_$effect(stats_templateObject24 || (stats_templateObject24 = stats_taggedTemplateLiteral(["Quiet Desperation"]))), template_string_$effect(stats_templateObject25 || (stats_templateObject25 = stats_taggedTemplateLiteral(["Song of Bravado"]))), template_string_$effect(stats_templateObject26 || (stats_templateObject26 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), template_string_$effect(stats_templateObject27 || (stats_templateObject27 = stats_taggedTemplateLiteral(["Blubbered Up"]))), template_string_$effect(stats_templateObject28 || (stats_templateObject28 = stats_taggedTemplateLiteral(["Mariachi Mood"]))), template_string_$effect(stats_templateObject29 || (stats_templateObject29 = stats_taggedTemplateLiteral(["Disco State of Mind"]))), template_string_$effect(stats_templateObject30 || (stats_templateObject30 = stats_taggedTemplateLiteral(["The Moxious Madrigal"])))],
    limit: {
      tries: 1
    }
  }]
...
var hpQuest = {
  ...
  tasks: [{
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.HP.run(() => logTest(CommunityService.HP, testTurns, predictedTestTurns), 1);
    },
    outfit: {
      modifier: "HP, switch left-hand man"
    },
    effects: [template_string_$effect(stats_templateObject31 || (stats_templateObject31 = stats_taggedTemplateLiteral(["Big"]))), template_string_$effect(stats_templateObject32 || (stats_templateObject32 = stats_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), template_string_$effect(stats_templateObject33 || (stats_templateObject33 = stats_taggedTemplateLiteral(["Reptilian Fortitude"]))), template_string_$effect(stats_templateObject34 || (stats_templateObject34 = stats_taggedTemplateLiteral(["Quiet Determination"]))), template_string_$effect(stats_templateObject35 || (stats_templateObject35 = stats_taggedTemplateLiteral(["Song of Bravado"]))), template_string_$effect(stats_templateObject36 || (stats_templateObject36 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), template_string_$effect(stats_templateObject37 || (stats_templateObject37 = stats_taggedTemplateLiteral(["Saucemastery"]))), template_string_$effect(stats_templateObject38 || (stats_templateObject38 = stats_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), template_string_$effect(stats_templateObject39 || (stats_templateObject39 = stats_taggedTemplateLiteral(["Patience of the Tortoise"])))],
    limit: {
      tries: 1
    }
  }]
 ...
 */
function wishes() {
  return utils_clamp(5 - property_get("_monkeyPawWishesUsed"), 0, 5);
}
/**
...
var wdmgQuest = {
  ...
  tasks: [{
    name: "Pool Buff",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(wdmg_templateObject || (wdmg_templateObject = wdmg_taggedTemplateLiteral(["Billiards Belligerence"])))),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("pool 1")
  }, {
    name: "Boombox",
    completed: () => property_get("_boomBoxSongsLeft") <= 2 || song() === "These Fists Were Made for Punchin'",
    do: () => setSong("These Fists Were Made for Punchin'")
  }, {
    name: "Inner Elf",
    prepare: () => Clan.join("Beldungeon"),
    completed: () => args.fam || !have(template_string_$familiar(wdmg_templateObject2 || (wdmg_templateObject2 = wdmg_taggedTemplateLiteral(["Machine Elf"])))) || have(template_string_$effect(wdmg_templateObject3 || (wdmg_templateObject3 = wdmg_taggedTemplateLiteral(["Inner Elf"])))) || property_get("_snokebombUsed") >= 3,
    do: $location(wdmg_templateObject4 || (wdmg_templateObject4 = wdmg_taggedTemplateLiteral(["The Slime Tube"]))),
    outfit: {
      weapon: template_string_$item.none,
      offhand: template_string_$item.none,
      shirt: template_string_$item(wdmg_templateObject5 || (wdmg_templateObject5 = wdmg_taggedTemplateLiteral(["Jurassic Parka"]))),
      familiar: template_string_$familiar(wdmg_templateObject6 || (wdmg_templateObject6 = wdmg_taggedTemplateLiteral(["Machine Elf"]))),
      modes: {
        parka: "kachungasaur"
      }
    },
    effects: [template_string_$effect(wdmg_templateObject7 || (wdmg_templateObject7 = wdmg_taggedTemplateLiteral(["Blood Bubble"])))],
    choices: {
      326: 1
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(wdmg_templateObject8 || (wdmg_templateObject8 = wdmg_taggedTemplateLiteral(["Snokebomb"])))).abort())
  }, {
    name: "Deep Dark Visions",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$effect(wdmg_templateObject9 || (wdmg_templateObject9 = wdmg_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(wdmg_templateObject10 || (wdmg_templateObject10 = wdmg_taggedTemplateLiteral(["Deep Dark Visions"])))),
    outfit: {
      modifier: "spooky res"
    }
  }, {
    ...
    completed: () => have(template_string_$effect(wdmg_templateObject11 || (wdmg_templateObject11 = wdmg_taggedTemplateLiteral(["Cowrruption"])))) || !have(template_string_$item(wdmg_templateObject12 || (wdmg_templateObject12 = wdmg_taggedTemplateLiteral(["corrupted marrow"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(wdmg_templateObject13 || (wdmg_templateObject13 = wdmg_taggedTemplateLiteral(["corrupted marrow"]))))
  }, {
    name: "Imported Taffy",
    completed: () => have(template_string_$effect(wdmg_templateObject14 || (wdmg_templateObject14 = wdmg_taggedTemplateLiteral(["Imported Strength"])))) || !have(template_string_$item(wdmg_templateObject15 || (wdmg_templateObject15 = wdmg_taggedTemplateLiteral(["imported taffy"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(wdmg_templateObject16 || (wdmg_templateObject16 = wdmg_taggedTemplateLiteral(["imported taffy"]))))
  }, {
    name: "Red Eye",
    completed: () => have(template_string_$effect(wdmg_templateObject17 || (wdmg_templateObject17 = wdmg_taggedTemplateLiteral(["Seeing Red"])))) || !have(template_string_$item(wdmg_templateObject18 || (wdmg_templateObject18 = wdmg_taggedTemplateLiteral(["red eye"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(wdmg_templateObject19 || (wdmg_templateObject19 = wdmg_taggedTemplateLiteral(["red eye"]))))
  }, {
    name: "100% Familiar wish for Pyramid Power",
    completed: () => !args.fam || property_get("_genieWishesUsed") >= 3 || have(template_string_$effect(wdmg_templateObject20 || (wdmg_templateObject20 = wdmg_taggedTemplateLiteral(["Pyramid Power"])))),
    do: () => wishFor(template_string_$effect(wdmg_templateObject21 || (wdmg_templateObject21 = wdmg_taggedTemplateLiteral(["Pyramid Power"]))))
  }, {
    name: "Weapon Damage Test",
    completed: () => CommunityService.WeaponDamage.isDone(),
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.print)("Expecting: [".concat(predictedTestTurns, "]"), "blue");
      (0,external_kolmafia_namespaceObject.print)("Took: [".concat(testTurns, "]"), "blue");
      CommunityService.WeaponDamage.run(() => logTest(CommunityService.WeaponDamage, testTurns, predictedTestTurns), args.fam ? 11 : 1);
    },
    outfit: {
      weapon: template_string_$item(wdmg_templateObject22 || (wdmg_templateObject22 = wdmg_taggedTemplateLiteral(["candy cane sword cane"]))),
      modifier: "1 weapon dmg percent, 0.9 weapon dmg, switch left-hand man "
    },
    effects: [template_string_$effect(wdmg_templateObject23 || (wdmg_templateObject23 = wdmg_taggedTemplateLiteral(["Bow-Legged Swagger"]))), template_string_$effect(wdmg_templateObject24 || (wdmg_templateObject24 = wdmg_taggedTemplateLiteral(["Scowl of the Auk"]))), template_string_$effect(wdmg_templateObject25 || (wdmg_templateObject25 = wdmg_taggedTemplateLiteral(["Rage of the Reindeer"]))), template_string_$effect(wdmg_templateObject26 || (wdmg_templateObject26 = wdmg_taggedTemplateLiteral(["Song of the North"]))), template_string_$effect(wdmg_templateObject27 || (wdmg_templateObject27 = wdmg_taggedTemplateLiteral(["Carol of the Bulls"]))), template_string_$effect(wdmg_templateObject28 || (wdmg_templateObject28 = wdmg_taggedTemplateLiteral(["Tenacity of the Snapper"]))), template_string_$effect(wdmg_templateObject29 || (wdmg_templateObject29 = wdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(wdmg_templateObject30 || (wdmg_templateObject30 = wdmg_taggedTemplateLiteral(["Turtle Tamer"]))) ? template_string_$effect(wdmg_templateObject31 || (wdmg_templateObject31 = wdmg_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : template_string_$effect(wdmg_templateObject32 || (wdmg_templateObject32 = wdmg_taggedTemplateLiteral(["Disdain of the War Snapper"]))), template_string_$effect(wdmg_templateObject33 || (wdmg_templateObject33 = wdmg_taggedTemplateLiteral(["Frenzied, Bloody"])))],
    limit: {
      tries: 1
    }
  }]
...
function main() {
  ...
  if (args.fam) {
    if ((0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar.none) {
      (0,external_kolmafia_namespaceObject.abort)("Please choose a familiar before running a 100% run");
    } else {
      args.familiar = (0,external_kolmafia_namespaceObject.myFamiliar)();
    }
  }
  if (args.run) {
