...
function maximizeCached(objectives) {
  ...
  var cacheKey = [objective].concat(maximize_toConsumableArray(untouchedSlots.map(slot => "".concat(slot, ":").concat((0,external_kolmafia_namespaceObject.equippedItem)(slot))).sort()), [have($effect(_templateObject49 || (_templateObject49 = maximize_taggedTemplateLiteral(["Offhand Remarkable"]))))]).join("; ");
...
var Outfit = /*#__PURE__*/function () {
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function _dress(refreshed) {
      ...
      if (bjorn && (0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) {
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = new Map([["famequip", $slot(_templateObject58 || (_templateObject58 = outfit_taggedTemplateLiteral(["familiar"])))], ["offhand", $slot(_templateObject59 || (_templateObject59 = outfit_taggedTemplateLiteral(["off-hand"])))]]).get(slotName)) !== null && _a !== void 0 ? _a : (0,external_kolmafia_namespaceObject.toSlot)(slotName));
    ...
    value: function current() {
      ...
      if ((0,external_kolmafia_namespaceObject.haveEquipped)(template_string_$item(_templateObject66 || (_templateObject66 = outfit_taggedTemplateLiteral(["Buddy Bjorn"]))))) outfit.riders.set($slot(_templateObject67 || (_templateObject67 = outfit_taggedTemplateLiteral(["buddy-bjorn"]))), (0,external_kolmafia_namespaceObject.myBjornedFamiliar)());
...
function familiarChoice() {
  ...
  } else if (!have($effect(lib_templateObject57 || (lib_templateObject57 = lib_taggedTemplateLiteral(["Spit Upon"]))))) {
  ...
  } else return template_string_$familiar(lib_templateObject61 || (lib_templateObject61 = lib_taggedTemplateLiteral(["Patriotic Eagle"])));
}
...
function oomfieOutfit(options) {
  ...
  if (args.fam) {
    if (args.familiar === template_string_$familiar.none) {
      ...
      famequipOverride = template_string_$item(lib_templateObject62 || (lib_templateObject62 = lib_taggedTemplateLiteral(["tiny stillsuit"])));
    }
  }
  if (options !== null && options !== void 0 && options.modifier) {
    ...
    return {
      ...
      famequip: (_ref2 = (_famequipOverride = famequipOverride) !== null && _famequipOverride !== void 0 ? _famequipOverride : options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _ref2 !== void 0 ? _ref2 : template_string_$item(lib_templateObject63 || (lib_templateObject63 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
    ...
    return {
      hat: (_options$hatOverride2 = options === null || options === void 0 ? void 0 : options.hatOverride) !== null && _options$hatOverride2 !== void 0 ? _options$hatOverride2 : template_string_$item(lib_templateObject64 || (lib_templateObject64 = lib_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
      back: (_options$backOverride2 = options === null || options === void 0 ? void 0 : options.backOverride) !== null && _options$backOverride2 !== void 0 ? _options$backOverride2 : template_string_$item(lib_templateObject65 || (lib_templateObject65 = lib_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      shirt: (_options$shirtOverrid2 = options === null || options === void 0 ? void 0 : options.shirtOverride) !== null && _options$shirtOverrid2 !== void 0 ? _options$shirtOverrid2 : template_string_$item(lib_templateObject66 || (lib_templateObject66 = lib_taggedTemplateLiteral(["Jurassic Parka"]))),
      weapon: (_options$weaponOverri2 = options === null || options === void 0 ? void 0 : options.weaponOverride) !== null && _options$weaponOverri2 !== void 0 ? _options$weaponOverri2 : template_string_$item(lib_templateObject67 || (lib_templateObject67 = lib_taggedTemplateLiteral(["June cleaver"]))),
...
var famwtQuest = {
  ...
  tasks: [{
    ...
    name: "Pancakes",
    completed: () => have($effect(famwt_templateObject5 || (famwt_templateObject5 = famwt_taggedTemplateLiteral(["Shortly Stacked"])))) || !have(template_string_$item(famwt_templateObject6 || (famwt_templateObject6 = famwt_taggedTemplateLiteral(["short stack of pancakes"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject7 || (famwt_templateObject7 = famwt_taggedTemplateLiteral(["short stack of pancakes"]))))
  }, {
    name: "Pool Buff",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have($effect(famwt_templateObject8 || (famwt_templateObject8 = famwt_taggedTemplateLiteral(["Billiards Belligerence"])))) || property_get("_poolGames") >= 3,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("pool 1")
  }, {
    name: "Love Song",
    completed: () => have($effect(famwt_templateObject9 || (famwt_templateObject9 = famwt_taggedTemplateLiteral(["Cold Hearted"])))) || !have(template_string_$item(famwt_templateObject10 || (famwt_templateObject10 = famwt_taggedTemplateLiteral(["love song of icy revenge"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(Math.min(4 - Math.floor((0,external_kolmafia_namespaceObject.haveEffect)($effect(famwt_templateObject11 || (famwt_templateObject11 = famwt_taggedTemplateLiteral(["Cold Hearted"])))) / 5), (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(famwt_templateObject12 || (famwt_templateObject12 = famwt_taggedTemplateLiteral(["love song of icy revenge"]))))), template_string_$item(famwt_templateObject13 || (famwt_templateObject13 = famwt_taggedTemplateLiteral(["love song of icy revenge"]))))
  }, {
    name: "\u2665 Rocks",
    ready: () => have(template_string_$item(famwt_templateObject14 || (famwt_templateObject14 = famwt_taggedTemplateLiteral(["lump of loyal latite"])))),
    completed: () => have($effect(famwt_templateObject15 || (famwt_templateObject15 = famwt_taggedTemplateLiteral(["Loyal as a Rock"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(famwt_templateObject16 || (famwt_templateObject16 = famwt_taggedTemplateLiteral(["lump of loyal latite"]))))
  }, {
    name: "Hatter Buff",
    completed: () =>  true || 0,
    ...
    effects: [$effect(famwt_templateObject20 || (famwt_templateObject20 = famwt_taggedTemplateLiteral(["Empathy"]))), $effect(famwt_templateObject21 || (famwt_templateObject21 = famwt_taggedTemplateLiteral(["Blood Bond"]))), $effect(famwt_templateObject22 || (famwt_templateObject22 = famwt_taggedTemplateLiteral(["Leash of Linguini"])))]
  }]
};
...
var facialExpression = lib_byStat({
  Muscle: $effect(levelling_templateObject3 || (levelling_templateObject3 = levelling_taggedTemplateLiteral(["Quiet Determination"]))),
  Mysticality: $effect(levelling_templateObject4 || (levelling_templateObject4 = levelling_taggedTemplateLiteral(["Inscrutable Gaze"]))),
  Moxie: $effect(levelling_templateObject5 || (levelling_templateObject5 = levelling_taggedTemplateLiteral(["Quiet Desperation"])))
});
var showerEffect = lib_byStat({
  Muscle: $effect(levelling_templateObject6 || (levelling_templateObject6 = levelling_taggedTemplateLiteral(["Muscle Unbound"]))),
  Mysticality: $effect(levelling_templateObject7 || (levelling_templateObject7 = levelling_taggedTemplateLiteral(["Thaumodynamic"]))),
  Moxie: $effect(levelling_templateObject8 || (levelling_templateObject8 = levelling_taggedTemplateLiteral(["So Fresh and So Clean"])))
});
var levellingEffects = [//Starter Buffs
$effect(levelling_templateObject9 || (levelling_templateObject9 = levelling_taggedTemplateLiteral(["Mariachi Mood"]))), $effect(levelling_templateObject10 || (levelling_templateObject10 = levelling_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), $effect(levelling_templateObject11 || (levelling_templateObject11 = levelling_taggedTemplateLiteral(["Saucemastery"]))), $effect(levelling_templateObject12 || (levelling_templateObject12 = levelling_taggedTemplateLiteral(["Patience of the Tortoise"]))), $effect(levelling_templateObject13 || (levelling_templateObject13 = levelling_taggedTemplateLiteral(["Disco State of Mind"]))), $effect(levelling_templateObject14 || (levelling_templateObject14 = levelling_taggedTemplateLiteral(["Pasta Oneness"]))), //Tiny buffs
$effect(levelling_templateObject15 || (levelling_templateObject15 = levelling_taggedTemplateLiteral(["Reptilian Fortitude"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject16 || (levelling_templateObject16 = levelling_taggedTemplateLiteral(["Turtle Tamer"]))) ? $effect(levelling_templateObject17 || (levelling_templateObject17 = levelling_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : $effect(levelling_templateObject18 || (levelling_templateObject18 = levelling_taggedTemplateLiteral(["Disdain of the War Snapper"]))), $effect(levelling_templateObject19 || (levelling_templateObject19 = levelling_taggedTemplateLiteral(["Blubbered Up"]))), $effect(levelling_templateObject20 || (levelling_templateObject20 = levelling_taggedTemplateLiteral(["Tenacity of the Snapper"]))), //Bigger stat buffs
$effect(levelling_templateObject21 || (levelling_templateObject21 = levelling_taggedTemplateLiteral(["Disco Fever"]))), $effect(levelling_templateObject22 || (levelling_templateObject22 = levelling_taggedTemplateLiteral(["Rage of the Reindeer"]))), $effect(levelling_templateObject23 || (levelling_templateObject23 = levelling_taggedTemplateLiteral(["Big"]))), $effect(levelling_templateObject24 || (levelling_templateObject24 = levelling_taggedTemplateLiteral(["Song of Bravado"]))),
//Facial
facialExpression, //Feelings
$effect(levelling_templateObject25 || (levelling_templateObject25 = levelling_taggedTemplateLiteral(["Feeling Excited"]))), $effect(levelling_templateObject26 || (levelling_templateObject26 = levelling_taggedTemplateLiteral(["Feeling Peaceful"]))), //Songs
$effect(levelling_templateObject27 || (levelling_templateObject27 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(levelling_templateObject28 || (levelling_templateObject28 = levelling_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effect(levelling_templateObject29 || (levelling_templateObject29 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), $effect(levelling_templateObject30 || (levelling_templateObject30 = levelling_taggedTemplateLiteral(["Aloysius' Antiphon of Aptitude"]))), //ML and Bonus Stats
$effect(levelling_templateObject31 || (levelling_templateObject31 = levelling_taggedTemplateLiteral(["Carol of the Thrills"]))), $effect(levelling_templateObject32 || (levelling_templateObject32 = levelling_taggedTemplateLiteral(["Pride of the Puffin"]))), $effect(levelling_templateObject33 || (levelling_templateObject33 = levelling_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), //Defensive
$effect(levelling_templateObject34 || (levelling_templateObject34 = levelling_taggedTemplateLiteral(["Ghostly Shell"]))), $effect(levelling_templateObject35 || (levelling_templateObject35 = levelling_taggedTemplateLiteral(["Astral Shell"]))), $effect(levelling_templateObject36 || (levelling_templateObject36 = levelling_taggedTemplateLiteral(["Jalape\xF1o Saucesphere"]))), $effect(levelling_templateObject37 || (levelling_templateObject37 = levelling_taggedTemplateLiteral(["Spiky Shell"]))), $effect(levelling_templateObject38 || (levelling_templateObject38 = levelling_taggedTemplateLiteral(["Elemental Saucesphere"]))), $effect(levelling_templateObject39 || (levelling_templateObject39 = levelling_taggedTemplateLiteral(["Scarysauce"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject40 || (levelling_templateObject40 = levelling_taggedTemplateLiteral(["Pastamancer"]))) ? $effect(levelling_templateObject41 || (levelling_templateObject41 = levelling_taggedTemplateLiteral(["Shield of the Pastalord"]))) : $effect(levelling_templateObject42 || (levelling_templateObject42 = levelling_taggedTemplateLiteral(["Flimsy Shield of the Pastalord"]))), //Elemental Weapon Damage
$effect(levelling_templateObject43 || (levelling_templateObject43 = levelling_taggedTemplateLiteral(["Your Fifteen Minutes"]))), $effect(levelling_templateObject44 || (levelling_templateObject44 = levelling_taggedTemplateLiteral(["Frostbeard"]))), $effect(levelling_templateObject45 || (levelling_templateObject45 = levelling_taggedTemplateLiteral(["Takin' It Greasy"]))), $effect(levelling_templateObject46 || (levelling_templateObject46 = levelling_taggedTemplateLiteral(["Rotten Memories"]))), $effect(levelling_templateObject47 || (levelling_templateObject47 = levelling_taggedTemplateLiteral(["Pyromania"]))), $effect(levelling_templateObject48 || (levelling_templateObject48 = levelling_taggedTemplateLiteral(["Intimidating Mien"]))),
//Familiar!
familiarAttacks() ? $effect(levelling_templateObject49 || (levelling_templateObject49 = levelling_taggedTemplateLiteral(["Big"]))) : $effect(levelling_templateObject50 || (levelling_templateObject50 = levelling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"]))), familiarAttacks() ? $effect(levelling_templateObject51 || (levelling_templateObject51 = levelling_taggedTemplateLiteral(["Big"]))) : $effect(levelling_templateObject52 || (levelling_templateObject52 = levelling_taggedTemplateLiteral(["Empathy"]))), familiarAttacks() ? $effect(levelling_templateObject53 || (levelling_templateObject53 = levelling_taggedTemplateLiteral(["Big"]))) : $effect(levelling_templateObject54 || (levelling_templateObject54 = levelling_taggedTemplateLiteral(["Leash of Linguini"]))), familiarAttacks() ? $effect(levelling_templateObject55 || (levelling_templateObject55 = levelling_taggedTemplateLiteral(["Big"]))) : $effect(levelling_templateObject56 || (levelling_templateObject56 = levelling_taggedTemplateLiteral(["Blood Bond"]))), //Misc
$effect(levelling_templateObject57 || (levelling_templateObject57 = levelling_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(levelling_templateObject58 || (levelling_templateObject58 = levelling_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(levelling_templateObject59 || (levelling_templateObject59 = levelling_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), $effect(levelling_templateObject60 || (levelling_templateObject60 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))];
var levellingQuest = {
  name: "Levelling",
  ...
  tasks: [loss, {
    name: "Beaten Up!",
    completed: () => !have($effect(levelling_templateObject62 || (levelling_templateObject62 = levelling_taggedTemplateLiteral(["Beaten Up"])))),
    ...
    prepare: () => {
      uneffect($effect(levelling_templateObject65 || (levelling_templateObject65 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
      ensureEffect($effect(levelling_templateObject66 || (levelling_templateObject66 = levelling_taggedTemplateLiteral(["Ode to Booze"]))), 4);
    },
    ...
    post: () => {
      uneffect($effect(levelling_templateObject69 || (levelling_templateObject69 = levelling_taggedTemplateLiteral(["Ode to Booze"]))));
      ensureEffect($effect(levelling_templateObject70 || (levelling_templateObject70 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
    }
  }, {
    name: "June Cleave",
    ...
    post: () => {
      if (have($effect(levelling_templateObject73 || (levelling_templateObject73 = levelling_taggedTemplateLiteral(["Beaten Up"]))))) {
        uneffect($effect(levelling_templateObject74 || (levelling_templateObject74 = levelling_taggedTemplateLiteral(["Beaten Up"]))));
      }
    },
    choices: {
    ...
    effects: [(0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject86 || (_templateObject86 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject87 || (_templateObject87 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject88 || (_templateObject88 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))]
  }, {
    ...
    completed: () => have($effect(_templateObject95 || (_templateObject95 = levelling_taggedTemplateLiteral(["Misplaced Rage"])))),
    ...
    completed: () => have($effect(_templateObject98 || (_templateObject98 = levelling_taggedTemplateLiteral(["Wisdom of Others"])))),
    ...
    ready: () => have($effect(_templateObject103 || (_templateObject103 = levelling_taggedTemplateLiteral(["Everything Looks Red"])))),
    ...
    completed: () => [$effect(_templateObject112 || (_templateObject112 = levelling_taggedTemplateLiteral(["Muddled"]))), $effect(_templateObject113 || (_templateObject113 = levelling_taggedTemplateLiteral(["Ten out of Ten"]))), $effect(_templateObject114 || (_templateObject114 = levelling_taggedTemplateLiteral(["Uncucumbered"])))].some(ef => have(ef)) || property_get("_daycareSpa"),
    ...
    completed: () => !args.fam || have($effect(_templateObject115 || (_templateObject115 = levelling_taggedTemplateLiteral(["A Contender"])))) || property_get("_genieWishesUsed") >= 2,
    ...
    completed: () => have($effect(_templateObject116 || (_templateObject116 = levelling_taggedTemplateLiteral(["Experimental Effect G-9"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect Experimental Effect G-9")
  }, {
    name: "Wish for New and Improved",
    completed: () => have($effect(_templateObject117 || (_templateObject117 = levelling_taggedTemplateLiteral(["Experimental Effect G-9"])))) || have($effect(_templateObject118 || (_templateObject118 = levelling_taggedTemplateLiteral(["New and Improved"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect New and Improved")
  }, {
    name: "Use Market Consumables",
    completed: () => [$effect(_templateObject119 || (_templateObject119 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject120 || (_templateObject120 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject121 || (_templateObject121 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].every(ef => have(ef)),
    do: () => [$effect(_templateObject122 || (_templateObject122 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject123 || (_templateObject123 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject124 || (_templateObject124 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].forEach(ef => ensureEffect(ef, 9))
  }, {
    name: "Use Wasabi Marble Soda",
    completed: () => !have(template_string_$item(_templateObject125 || (_templateObject125 = levelling_taggedTemplateLiteral(["wasabi marble soda"])))) || have($effect(_templateObject126 || (_templateObject126 = levelling_taggedTemplateLiteral(["Wasabi With You"])))),
    ...
    completed: () => have($effect(_templateObject129 || (_templateObject129 = levelling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
    ...
    completed: () => have($effect(_templateObject133 || (_templateObject133 = levelling_taggedTemplateLiteral(["Red Lettered"])))),
    ...
    completed: () => have($effect(_templateObject136 || (_templateObject136 = levelling_taggedTemplateLiteral(["Pyrite Pride"])))),
    ...
    completed: () => have($effect(_templateObject139 || (_templateObject139 = levelling_taggedTemplateLiteral(["Phorcefullness"])))),
    do: () => {
    ...
    completed: () => have($effect(_templateObject142 || (_templateObject142 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"])))),
    do: () => {
      ...
      ensureEffect($effect(_templateObject144 || (_templateObject144 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"]))));
    }
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 250 || property_get("_latteRefillsUsed") >= 2 || have($effect(_templateObject145 || (_templateObject145 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))),
    do: () => {
    ...
    effects: [$effect(_templateObject148 || (_templateObject148 = levelling_taggedTemplateLiteral(["Big"]))), $effect(_templateObject149 || (_templateObject149 = levelling_taggedTemplateLiteral(["Song of Bravado"]))), $effect(_templateObject150 || (_templateObject150 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject151 || (_templateObject151 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject152 || (_templateObject152 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject153 || (_templateObject153 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))],
    ...
    completed: () => !have($effect(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have($effect(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    ...
    completed: () => !have(template_string_$skill(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["Just the Facts"])))) || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5 || have($effect(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["Sweet and Red"])))),
    do: () => {
    ...
    ready: () => have($effect(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    ...
    ready: () => have($effect(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    ...
    name: "Visit Hottub",
    completed: () => [$effect(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["Snowballed"]))), $effect(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["Bruised"]))), $effect(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), $effect(_templateObject231 || (_templateObject231 = levelling_taggedTemplateLiteral(["Hypnotized"]))), $effect(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
...
var noncombatQuest = {
  ...
  tasks: [{
    ...
    name: "Squeaky Rose",
    completed: () => !have(template_string_$item(noncombat_templateObject4 || (noncombat_templateObject4 = noncombat_taggedTemplateLiteral(["squeaky toy rose"])))) || have($effect(noncombat_templateObject5 || (noncombat_templateObject5 = noncombat_taggedTemplateLiteral(["A Rose by Any Other Material"])))),
    ...
    name: "Silent Running",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have($effect(noncombat_templateObject20 || (noncombat_templateObject20 = noncombat_taggedTemplateLiteral(["Silent Running"])))) || property_get("_olympicSwimmingPool") || CommunityService.Noncombat.actualCost() === 1,
...
var sdmgQuest = {
  ...
  tasks: [{
    ...
    completed: () => have($effect(sdmg_templateObject9 || (sdmg_templateObject9 = sdmg_taggedTemplateLiteral(["Pisces in the Skyces"])))) || !have(template_string_$item(sdmg_templateObject10 || (sdmg_templateObject10 = sdmg_taggedTemplateLiteral(["tobiko marble soda"])))),
    ...
    name: "Cargo Handsoap!",
    completed: () => property_get("_cargoPocketEmptied") || have(template_string_$item(sdmg_templateObject15 || (sdmg_templateObject15 = sdmg_taggedTemplateLiteral(["Yeg's Motel hand soap"])))) || have($effect(sdmg_templateObject16 || (sdmg_templateObject16 = sdmg_taggedTemplateLiteral(["Sigils of Yeg"])))),
    ...
    completed: () => args.fam || !have(template_string_$familiar(sdmg_templateObject18 || (sdmg_templateObject18 = sdmg_taggedTemplateLiteral(["Machine Elf"])))) || have($effect(sdmg_templateObject19 || (sdmg_templateObject19 = sdmg_taggedTemplateLiteral(["Inner Elf"])))) || property_get("_snokebombUsed") >= 3,
    ...
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have($effect(sdmg_templateObject23 || (sdmg_templateObject23 = sdmg_taggedTemplateLiteral(["Mental A-cue-ity"])))),
    ...
    effects: [$effect(sdmg_templateObject24 || (sdmg_templateObject24 = sdmg_taggedTemplateLiteral(["Song of Sauce"]))), $effect(sdmg_templateObject25 || (sdmg_templateObject25 = sdmg_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(sdmg_templateObject26 || (sdmg_templateObject26 = sdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), $effect(sdmg_templateObject27 || (sdmg_templateObject27 = sdmg_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"])))],
    limit: {
      tries: 1
    }
  }]
...
var skeletonsQuest = {
  ...
  tasks: [loss, {
    ...
    post: () => {
      if (have($effect(skeletons_templateObject4 || (skeletons_templateObject4 = skeletons_taggedTemplateLiteral(["Beaten Up"]))))) {
        uneffect($effect(skeletons_templateObject5 || (skeletons_templateObject5 = skeletons_taggedTemplateLiteral(["Beaten Up"]))));
      }
    }
  }, {
    name: "Obtain Red Rocket",
    completed: () => have(template_string_$item(skeletons_templateObject6 || (skeletons_templateObject6 = skeletons_taggedTemplateLiteral(["red rocket"])))) || have($effect(skeletons_templateObject7 || (skeletons_templateObject7 = skeletons_taggedTemplateLiteral(["Everything Looks Red"])))),
    ...
    do: () => guildZone,
    post: () => {
      if (have($effect(skeletons_templateObject9 || (skeletons_templateObject9 = skeletons_taggedTemplateLiteral(["Beaten Up"])))) && !have(template_string_$item(skeletons_templateObject10 || (skeletons_templateObject10 = skeletons_taggedTemplateLiteral(["magical sausage casing"]))))) {
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have($effect(skeletons_templateObject17 || (skeletons_templateObject17 = skeletons_taggedTemplateLiteral(["Everything Looks Yellow"])))) && have(template_string_$item(skeletons_templateObject18 || (skeletons_templateObject18 = skeletons_taggedTemplateLiteral(["cherry"])))),
    do: () => {
    ...
    effects: [$effect(skeletons_templateObject44 || (skeletons_templateObject44 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject45 || (skeletons_templateObject45 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), $effect(skeletons_templateObject46 || (skeletons_templateObject46 = skeletons_taggedTemplateLiteral(["Empathy"]))), $effect(skeletons_templateObject47 || (skeletons_templateObject47 = skeletons_taggedTemplateLiteral(["Blood Bond"])))]
  }, {
    name: "Guild Unlock (100% Familiar)",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished",
    do: () => guildZone,
    effects: [$effect(skeletons_templateObject48 || (skeletons_templateObject48 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject49 || (skeletons_templateObject49 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"])))],
    outfit: () => ({
    ...
    do: () => {
      ...
      ensureEffect($effect(skeletons_templateObject61 || (skeletons_templateObject61 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
      ...
      uneffect($effect(skeletons_templateObject63 || (skeletons_templateObject63 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
    }
  }]
};
...
var mystQuest = {
  ...
  tasks: [{
    ...
    post: () => uneffect($effect(stats_templateObject12 || (stats_templateObject12 = stats_taggedTemplateLiteral(["The Magical Mojomuscular Melody"])))),
    effects: [$effect(stats_templateObject13 || (stats_templateObject13 = stats_taggedTemplateLiteral(["Big"]))), $effect(stats_templateObject14 || (stats_templateObject14 = stats_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(stats_templateObject15 || (stats_templateObject15 = stats_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))), $effect(stats_templateObject16 || (stats_templateObject16 = stats_taggedTemplateLiteral(["Saucemastery"]))), $effect(stats_templateObject17 || (stats_templateObject17 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(stats_templateObject18 || (stats_templateObject18 = stats_taggedTemplateLiteral(["Quiet Judgement"]))), $effect(stats_templateObject19 || (stats_templateObject19 = stats_taggedTemplateLiteral(["Song of Bravado"]))), $effect(stats_templateObject20 || (stats_templateObject20 = stats_taggedTemplateLiteral(["Pasta Oneness"])))],
    limit: {
      tries: 1
    }
  }]
...
var moxQuest = {
  ...
  tasks: [{
    ...
    effects: [$effect(stats_templateObject21 || (stats_templateObject21 = stats_taggedTemplateLiteral(["Big"]))), $effect(stats_templateObject22 || (stats_templateObject22 = stats_taggedTemplateLiteral(["Butt-Rock Hair"]))), $effect(stats_templateObject23 || (stats_templateObject23 = stats_taggedTemplateLiteral(["Disco Fever"]))), $effect(stats_templateObject24 || (stats_templateObject24 = stats_taggedTemplateLiteral(["Quiet Desperation"]))), $effect(stats_templateObject25 || (stats_templateObject25 = stats_taggedTemplateLiteral(["Song of Bravado"]))), $effect(stats_templateObject26 || (stats_templateObject26 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(stats_templateObject27 || (stats_templateObject27 = stats_taggedTemplateLiteral(["Blubbered Up"]))), $effect(stats_templateObject28 || (stats_templateObject28 = stats_taggedTemplateLiteral(["Mariachi Mood"]))), $effect(stats_templateObject29 || (stats_templateObject29 = stats_taggedTemplateLiteral(["Disco State of Mind"]))), $effect(stats_templateObject30 || (stats_templateObject30 = stats_taggedTemplateLiteral(["The Moxious Madrigal"])))],
    limit: {
      tries: 1
    }
  }]
...
var hpQuest = {
  ...
  tasks: [{
    ...
    effects: [$effect(stats_templateObject31 || (stats_templateObject31 = stats_taggedTemplateLiteral(["Big"]))), $effect(stats_templateObject32 || (stats_templateObject32 = stats_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(stats_templateObject33 || (stats_templateObject33 = stats_taggedTemplateLiteral(["Reptilian Fortitude"]))), $effect(stats_templateObject34 || (stats_templateObject34 = stats_taggedTemplateLiteral(["Quiet Determination"]))), $effect(stats_templateObject35 || (stats_templateObject35 = stats_taggedTemplateLiteral(["Song of Bravado"]))), $effect(stats_templateObject36 || (stats_templateObject36 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(stats_templateObject37 || (stats_templateObject37 = stats_taggedTemplateLiteral(["Saucemastery"]))), $effect(stats_templateObject38 || (stats_templateObject38 = stats_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), $effect(stats_templateObject39 || (stats_templateObject39 = stats_taggedTemplateLiteral(["Patience of the Tortoise"])))],
    limit: {
      tries: 1
    }
  }]
...
var wdmgQuest = {
  ...
  tasks: [{
    ...
    name: "Inner Elf",
    prepare: () => Clan.join("Beldungeon"),
    completed: () => args.fam || !have(template_string_$familiar(wdmg_templateObject2 || (wdmg_templateObject2 = wdmg_taggedTemplateLiteral(["Machine Elf"])))) || have($effect(wdmg_templateObject3 || (wdmg_templateObject3 = wdmg_taggedTemplateLiteral(["Inner Elf"])))) || property_get("_snokebombUsed") >= 3,
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have($effect(wdmg_templateObject7 || (wdmg_templateObject7 = wdmg_taggedTemplateLiteral(["Visions of the Deep Dark Deeps"])))),
    ...
    completed: () => have($effect(wdmg_templateObject9 || (wdmg_templateObject9 = wdmg_taggedTemplateLiteral(["Cowrruption"])))) || !have(template_string_$item(wdmg_templateObject10 || (wdmg_templateObject10 = wdmg_taggedTemplateLiteral(["corrupted marrow"])))),
    ...
    name: "Imported Taffy",
    completed: () => have($effect(wdmg_templateObject12 || (wdmg_templateObject12 = wdmg_taggedTemplateLiteral(["Imported Strength"])))) || !have(template_string_$item(wdmg_templateObject13 || (wdmg_templateObject13 = wdmg_taggedTemplateLiteral(["imported taffy"])))),
    ...
    name: "Red Eye",
    completed: () => have($effect(wdmg_templateObject15 || (wdmg_templateObject15 = wdmg_taggedTemplateLiteral(["Seeing Red"])))) || !have(template_string_$item(wdmg_templateObject16 || (wdmg_templateObject16 = wdmg_taggedTemplateLiteral(["red eye"])))),
    ...
    completed: () => !args.fam || property_get("_genieWishesUsed") >= 3 || have($effect(wdmg_templateObject18 || (wdmg_templateObject18 = wdmg_taggedTemplateLiteral(["Pyramid Power"])))),
    do: () => wishFor($effect(wdmg_templateObject19 || (wdmg_templateObject19 = wdmg_taggedTemplateLiteral(["Pyramid Power"]))))
  }, {
    name: "Weapon Damage Test",
    completed: () => CommunityService.WeaponDamage.isDone(),
    do: () => {
    ...
    effects: [$effect(wdmg_templateObject20 || (wdmg_templateObject20 = wdmg_taggedTemplateLiteral(["Bow-Legged Swagger"]))), $effect(wdmg_templateObject21 || (wdmg_templateObject21 = wdmg_taggedTemplateLiteral(["Scowl of the Auk"]))), $effect(wdmg_templateObject22 || (wdmg_templateObject22 = wdmg_taggedTemplateLiteral(["Rage of the Reindeer"]))), $effect(wdmg_templateObject23 || (wdmg_templateObject23 = wdmg_taggedTemplateLiteral(["Song of the North"]))), $effect(wdmg_templateObject24 || (wdmg_templateObject24 = wdmg_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(wdmg_templateObject25 || (wdmg_templateObject25 = wdmg_taggedTemplateLiteral(["Tenacity of the Snapper"]))), $effect(wdmg_templateObject26 || (wdmg_templateObject26 = wdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(wdmg_templateObject27 || (wdmg_templateObject27 = wdmg_taggedTemplateLiteral(["Turtle Tamer"]))) ? $effect(wdmg_templateObject28 || (wdmg_templateObject28 = wdmg_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : $effect(wdmg_templateObject29 || (wdmg_templateObject29 = wdmg_taggedTemplateLiteral(["Disdain of the War Snapper"])))],
    limit: {
      tries: 1
    }
  }]
