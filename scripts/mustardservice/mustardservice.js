...
function familiarChoice() {
  ...
  } else if (!have($effect(lib_templateObject6 || (lib_templateObject6 = lib_taggedTemplateLiteral(["Spit Upon"]))))) {
    return template_string_$familiar(lib_templateObject7 || (lib_templateObject7 = lib_taggedTemplateLiteral(["Melodramedary"])));
  } else if (!have(template_string_$item(lib_templateObject8 || (lib_templateObject8 = lib_taggedTemplateLiteral(["short stack of pancakes"]))))) {
    return template_string_$familiar(lib_templateObject9 || (lib_templateObject9 = lib_taggedTemplateLiteral(["Shorter-Order Cook"])));
  } else return template_string_$familiar(lib_templateObject10 || (lib_templateObject10 = lib_taggedTemplateLiteral(["Patriotic Eagle"])));
}
...
function oomfieOutfit(options) {
  ...
  if (args.fam) {
    if (args.familiar === template_string_$familiar.none) {
      ...
      famequipOverride = template_string_$item(lib_templateObject11 || (lib_templateObject11 = lib_taggedTemplateLiteral(["tiny stillsuit"])));
    }
  }
  if (options !== null && options !== void 0 && options.modifier) {
    ...
    return {
      ...
      famequip: (_ref2 = (_famequipOverride = famequipOverride) !== null && _famequipOverride !== void 0 ? _famequipOverride : options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _ref2 !== void 0 ? _ref2 : template_string_$item(lib_templateObject12 || (lib_templateObject12 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
    ...
    return {
      hat: (_options$hatOverride2 = options === null || options === void 0 ? void 0 : options.hatOverride) !== null && _options$hatOverride2 !== void 0 ? _options$hatOverride2 : template_string_$item(lib_templateObject13 || (lib_templateObject13 = lib_taggedTemplateLiteral(["Daylight Shavings Helmet"]))),
      back: (_options$backOverride2 = options === null || options === void 0 ? void 0 : options.backOverride) !== null && _options$backOverride2 !== void 0 ? _options$backOverride2 : template_string_$item(lib_templateObject14 || (lib_templateObject14 = lib_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      shirt: (_options$shirtOverrid2 = options === null || options === void 0 ? void 0 : options.shirtOverride) !== null && _options$shirtOverrid2 !== void 0 ? _options$shirtOverrid2 : template_string_$item(lib_templateObject15 || (lib_templateObject15 = lib_taggedTemplateLiteral(["Jurassic Parka"]))),
      weapon: (_options$weaponOverri2 = options === null || options === void 0 ? void 0 : options.weaponOverride) !== null && _options$weaponOverri2 !== void 0 ? _options$weaponOverri2 : template_string_$item(lib_templateObject16 || (lib_templateObject16 = lib_taggedTemplateLiteral(["June cleaver"]))),
      offhand: (_options$offhandOverr2 = options === null || options === void 0 ? void 0 : options.offhandOverride) !== null && _options$offhandOverr2 !== void 0 ? _options$offhandOverr2 : template_string_$item(lib_templateObject17 || (lib_templateObject17 = lib_taggedTemplateLiteral(["unbreakable umbrella"]))),
      pants: (_options$pantsOverrid2 = options === null || options === void 0 ? void 0 : options.pantsOverride) !== null && _options$pantsOverrid2 !== void 0 ? _options$pantsOverrid2 : template_string_$item(lib_templateObject18 || (lib_templateObject18 = lib_taggedTemplateLiteral(["designer sweatpants"]))),
      acc1: (_options$acc1Override2 = options === null || options === void 0 ? void 0 : options.acc1Override) !== null && _options$acc1Override2 !== void 0 ? _options$acc1Override2 : template_string_$item(lib_templateObject19 || (lib_templateObject19 = lib_taggedTemplateLiteral(["backup camera"]))),
      acc2: (_options$acc2Override2 = options === null || options === void 0 ? void 0 : options.acc2Override) !== null && _options$acc2Override2 !== void 0 ? _options$acc2Override2 : template_string_$item(lib_templateObject20 || (lib_templateObject20 = lib_taggedTemplateLiteral(["your cowboy boots"]))),
      acc3: (_options$acc3Override2 = options === null || options === void 0 ? void 0 : options.acc3Override) !== null && _options$acc3Override2 !== void 0 ? _options$acc3Override2 : template_string_$item(lib_templateObject21 || (lib_templateObject21 = lib_taggedTemplateLiteral(["combat lover's locket"]))),
      ...
      famequip: (_ref4 = (_famequipOverride2 = famequipOverride) !== null && _famequipOverride2 !== void 0 ? _famequipOverride2 : options === null || options === void 0 ? void 0 : options.famequipOverride) !== null && _ref4 !== void 0 ? _ref4 : template_string_$item(lib_templateObject22 || (lib_templateObject22 = lib_taggedTemplateLiteral(["tiny stillsuit"]))),
...
var levellingQuest = {
  ...
  tasks: [loss, {
    ...
    do: () => (0,external_kolmafia_namespaceObject.drink)(4, template_string_$item(_templateObject68 || (_templateObject68 = levelling_taggedTemplateLiteral(["astral pilsner"])))),
    post: () => {
      uneffect($effect(_templateObject69 || (_templateObject69 = levelling_taggedTemplateLiteral(["Ode to Booze"]))));
      ensureEffect($effect(_templateObject70 || (_templateObject70 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
    }
  }, {
    name: "June Cleave",
    ...
    do: () => $location(_templateObject83 || (_templateObject83 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    outfit: {
      offhand: template_string_$item(_templateObject84 || (_templateObject84 = levelling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject85 || (_templateObject85 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Angry Agate",
    ready: () => have(template_string_$item(_templateObject86 || (_templateObject86 = levelling_taggedTemplateLiteral(["angry agate"])))),
    completed: () => have($effect(_templateObject87 || (_templateObject87 = levelling_taggedTemplateLiteral(["Misplaced Rage"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject88 || (_templateObject88 = levelling_taggedTemplateLiteral(["angry agate"]))))
  }, {
    name: "Filled Mosquito",
    ready: () => have(template_string_$item(_templateObject89 || (_templateObject89 = levelling_taggedTemplateLiteral(["filled mosquito"])))),
    completed: () => have($effect(_templateObject90 || (_templateObject90 = levelling_taggedTemplateLiteral(["Wisdom of Others"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject91 || (_templateObject91 = levelling_taggedTemplateLiteral(["filled mosquito"]))))
  }, {
    name: "April Shower",
    ...
    name: "Use 10% Bonus",
    completed: () => !have(template_string_$item(_templateObject92 || (_templateObject92 = levelling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject93 || (_templateObject93 = levelling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    outfit: {
      offhand: template_string_$item(_templateObject94 || (_templateObject94 = levelling_taggedTemplateLiteral(["familiar scrapbook"])))
    }
  }, {
    name: "Eat Legend Dishes",
    ready: () => have($effect(_templateObject95 || (_templateObject95 = levelling_taggedTemplateLiteral(["Everything Looks Red"])))),
    completed: () => property_get("pizzaOfLegendEaten") && property_get("calzoneOfLegendEaten") || !have(template_string_$item(_templateObject96 || (_templateObject96 = levelling_taggedTemplateLiteral(["Pizza of Legend"])))) && !have(template_string_$item(_templateObject97 || (_templateObject97 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))),
    do: () => [template_string_$item(_templateObject98 || (_templateObject98 = levelling_taggedTemplateLiteral(["Pizza of Legend"]))), template_string_$item(_templateObject99 || (_templateObject99 = levelling_taggedTemplateLiteral(["Calzone of Legend"])))].forEach(i => (0,external_kolmafia_namespaceObject.eat)(1, i)),
    outfit: {
      offhand: template_string_$item(_templateObject100 || (_templateObject100 = levelling_taggedTemplateLiteral(["familiar scrapbook"])))
    }
  }, {
    name: "Lyle Buff",
    ...
    completed: () => have(template_string_$item(_templateObject101 || (_templateObject101 = levelling_taggedTemplateLiteral(["Catherine Wheel"])))) || have(template_string_$item(_templateObject102 || (_templateObject102 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject103 || (_templateObject103 = levelling_taggedTemplateLiteral(["Catherine Wheel"]))))
  }, {
    name: "Boxing Daycare Buff",
    completed: () => [$effect(_templateObject104 || (_templateObject104 = levelling_taggedTemplateLiteral(["Muddled"]))), $effect(_templateObject105 || (_templateObject105 = levelling_taggedTemplateLiteral(["Ten out of Ten"]))), $effect(_templateObject106 || (_templateObject106 = levelling_taggedTemplateLiteral(["Uncucumbered"])))].some(ef => have(ef)) || property_get("_daycareSpa"),
    ...
    completed: () => !args.fam || have($effect(_templateObject107 || (_templateObject107 = levelling_taggedTemplateLiteral(["A Contender"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect A Contender")
  }, {
    name: "Wish for New and Improved",
    completed: () => have($effect(_templateObject108 || (_templateObject108 = levelling_taggedTemplateLiteral(["New and Improved"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect New and Improved")
  }, {
    name: "Use Market Consumables",
    completed: () => [$effect(_templateObject109 || (_templateObject109 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject110 || (_templateObject110 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject111 || (_templateObject111 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].every(ef => have(ef)),
    do: () => [$effect(_templateObject112 || (_templateObject112 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject113 || (_templateObject113 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject114 || (_templateObject114 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].forEach(ef => ensureEffect(ef, 9))
  }, {
    name: "Use Wasabi Marble Soda",
    completed: () => !have(template_string_$item(_templateObject115 || (_templateObject115 = levelling_taggedTemplateLiteral(["wasabi marble soda"])))) || have($effect(_templateObject116 || (_templateObject116 = levelling_taggedTemplateLiteral(["Wasabi With You"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject117 || (_templateObject117 = levelling_taggedTemplateLiteral(["wasabi marble soda"]))))
  }, {
    name: "Summon Reagents",
    completed: () => property_get("reagentSummons") > 0,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject118 || (_templateObject118 = levelling_taggedTemplateLiteral(["Advanced Saucecrafting"]))))
  }, {
    name: "Become Occultic",
    completed: () => have($effect(_templateObject119 || (_templateObject119 = levelling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject120 || (_templateObject120 = levelling_taggedTemplateLiteral(["ointment of the occult"]))));
      ensureEffect($effect(_templateObject121 || (_templateObject121 = levelling_taggedTemplateLiteral(["Mystically Oiled"]))));
    }
  }, {
    name: "Summon Limes",
    completed: () => property_get("_preventScurvy"),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject122 || (_templateObject122 = levelling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))
  }, {
    name: "Become Phorceful",
    completed: () => have($effect(_templateObject123 || (_templateObject123 = levelling_taggedTemplateLiteral(["Phorcefullness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject124 || (_templateObject124 = levelling_taggedTemplateLiteral(["philter of phorce"]))));
      ensureEffect($effect(_templateObject125 || (_templateObject125 = levelling_taggedTemplateLiteral(["Phorcefullness"]))));
    }
  }, {
    name: "Stabilize your Oils",
    completed: () => have($effect(_templateObject126 || (_templateObject126 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject127 || (_templateObject127 = levelling_taggedTemplateLiteral(["oil of stability"]))));
      ensureEffect($effect(_templateObject128 || (_templateObject128 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"]))));
    }
  }, {
    name: "Eat sosig",
    ready: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject129 || (_templateObject129 = levelling_taggedTemplateLiteral(["magical sausage casing"])))) > 0,
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject130 || (_templateObject130 = levelling_taggedTemplateLiteral(["magical sausage"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject131 || (_templateObject131 = levelling_taggedTemplateLiteral(["magical sausage"]))));
    },
    effects: [(0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject132 || (_templateObject132 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject133 || (_templateObject133 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject134 || (_templateObject134 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))]
  }, {
    ...
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 850 || property_get("_latteRefillsUsed") >= 2 || have($effect(_templateObject135 || (_templateObject135 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject136 || (_templateObject136 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      if (property_get("_latteDrinkUsed")) {
        fill("pumpkin", "cinnamon", "vanilla");
      }
    },
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject137 || (_templateObject137 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modifier: "mp"
    }),
    effects: [$effect(_templateObject138 || (_templateObject138 = levelling_taggedTemplateLiteral(["Big"]))), $effect(_templateObject139 || (_templateObject139 = levelling_taggedTemplateLiteral(["Song of Bravado"]))), $effect(_templateObject140 || (_templateObject140 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject141 || (_templateObject141 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject142 || (_templateObject142 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject143 || (_templateObject143 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))],
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject144 || (_templateObject144 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject145 || (_templateObject145 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    ...
    ready: () => !property_get("_latteBanishUsed"),
    completed: () => (0,external_kolmafia_namespaceObject.myMp)() >= 200 || property_get("_latteRefillsUsed") >= 2,
    do: () => {
    ...
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject148 || (_templateObject148 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject149 || (_templateObject149 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    name: "Summon Love Songs",
    completed: () => !have(template_string_$skill(_templateObject150 || (_templateObject150 = levelling_taggedTemplateLiteral(["Summon Love Song"])))) || (0,external_kolmafia_namespaceObject.itemAmount)(template_string_$item(_templateObject151 || (_templateObject151 = levelling_taggedTemplateLiteral(["love song of icy revenge"])))) >= 4 || (0,external_kolmafia_namespaceObject.mpCost)(template_string_$skill(_templateObject152 || (_templateObject152 = levelling_taggedTemplateLiteral(["Summon Love Song"])))) > (0,external_kolmafia_namespaceObject.myMp)() + 100,
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject153 || (_templateObject153 = levelling_taggedTemplateLiteral(["Summon Love Song"]))))
  }, {
    name: "Remove Bloodsugar",
    completed: () => !have($effect(_templateObject154 || (_templateObject154 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have($effect(_templateObject155 || (_templateObject155 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject156 || (_templateObject156 = levelling_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))))
  }, {
    name: "Flapper Mapper",
    completed: () => property_get("_monstersMapped") >= 2 || have(template_string_$item(_templateObject157 || (_templateObject157 = levelling_taggedTemplateLiteral(["imported taffy"])))),
    do: () => mapMonster($location(_templateObject158 || (_templateObject158 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject159 || (_templateObject159 = levelling_taggedTemplateLiteral(["goblin flapper"])))),
    outfit: () => oomfieOutfit({
    ...
    combat: new CombatStrategy().macro(Macro.ifHolidayWanderer(Macro.attack().repeat()).trySkill(template_string_$skill(_templateObject161 || (_templateObject161 = levelling_taggedTemplateLiteral(["Feel Envy"])))).attack().repeat())
  }, {
    name: "Oliver's Place (Nanorhino)",
    completed: () => property_get("_speakeasyFreeFights") >= 3 || !have(template_string_$familiar(_templateObject162 || (_templateObject162 = levelling_taggedTemplateLiteral(["Nanorhino"])))) || [$effect(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["Nanobrawny"]))), $effect(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["Nanobrainy"])))].some(ef => have(ef)) || args.fam,
    do: () => $location(_templateObject165 || (_templateObject165 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject166 || (_templateObject166 = levelling_taggedTemplateLiteral(["Nanorhino"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject167 || (_templateObject167 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject168 || (_templateObject168 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"])))).attack().repeat())
  }, {
    name: "Oliver's Place",
    completed: () => property_get("_speakeasyFreeFights") === 3,
    do: $location(_templateObject169 || (_templateObject169 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject170 || (_templateObject170 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Pick up a club!",
    completed: () => args.fam || have(template_string_$item(_templateObject171 || (_templateObject171 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject172 || (_templateObject172 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))))
  }, {
    name: "Seal Fights",
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject173 || (_templateObject173 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject174 || (_templateObject174 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(3, template_string_$item(_templateObject175 || (_templateObject175 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject176 || (_templateObject176 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
    },
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject177 || (_templateObject177 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject178 || (_templateObject178 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Get Payphone Quest",
    completed: () => property_get("_shadowAffinityToday"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject179 || (_templateObject179 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 1
    }
  }, {
    name: "Payphone Freefights (extingo)",
    ready: () => have($effect(_templateObject180 || (_templateObject180 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject181 || (_templateObject181 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_fireExtinguisherCharge") <= 10,
    do: shadowRiftChoice,
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().autoattack(() => customMacro.if_(shadowRiftPocketTarget(), customMacro.polarpocket(9).trySkill(template_string_$skill(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).trySkill(template_string_$skill(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Payphone Freefights (cleaver)",
    ready: () => have($effect(_templateObject185 || (_templateObject185 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject186 || (_templateObject186 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject187 || (_templateObject187 = levelling_taggedTemplateLiteral(["Sing Along"])))).if_(shadowRiftPocketTarget(), Macro.trySkill(template_string_$skill(_templateObject188 || (_templateObject188 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).attack().repeat())
  }, {
    ...
    completed: () => have(template_string_$item(_templateObject189 || (_templateObject189 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("questRufus") === "step1",
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject190 || (_templateObject190 = levelling_taggedTemplateLiteral(["Machine Elf"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.if_($monster(_templateObject191 || (_templateObject191 = levelling_taggedTemplateLiteral(["shadow matrix"]))), Macro.trySkill(template_string_$skill(_templateObject192 || (_templateObject192 = levelling_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkillRepeat(template_string_$skill(_templateObject193 || (_templateObject193 = levelling_taggedTemplateLiteral(["Saucegeyser"]))))).trySkillRepeat(template_string_$skill(_templateObject194 || (_templateObject194 = levelling_taggedTemplateLiteral(["Northern Explosion"])))))
  }, {
    name: "Retrieve Spooky Lodestone",
    ready: () => property_get("questRufus") === "step1",
    completed: () => have(template_string_$item(_templateObject195 || (_templateObject195 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject196 || (_templateObject196 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    post: () => (0,external_kolmafia_namespaceObject.cliExecute)("fold garbage shirt")
  }, {
    name: "Set Snojo Controls",
    completed: () => property_get("snojoSetting") === $stat(_templateObject197 || (_templateObject197 = levelling_taggedTemplateLiteral(["Moxie"]))),
    do: () => {
    ...
    do: $location(_templateObject198 || (_templateObject198 = levelling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject199 || (_templateObject199 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject200 || (_templateObject200 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject201 || (_templateObject201 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Visit Hottub",
    completed: () => [$effect(_templateObject202 || (_templateObject202 = levelling_taggedTemplateLiteral(["Snowballed"]))), $effect(_templateObject203 || (_templateObject203 = levelling_taggedTemplateLiteral(["Bruised"]))), $effect(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), $effect(_templateObject205 || (_templateObject205 = levelling_taggedTemplateLiteral(["Hypnotized"]))), $effect(_templateObject206 || (_templateObject206 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
    ...
    do: () => fightPiece($monster(_templateObject207 || (_templateObject207 = levelling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject208 || (_templateObject208 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject209 || (_templateObject209 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Deep Machine Fights",
    completed: () => args.fam && args.familiar !== template_string_$familiar(_templateObject211 || (_templateObject211 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || property_get("_machineTunnelsAdv") >= 5,
    do: () => $location(_templateObject212 || (_templateObject212 = levelling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    outfit: {
      offhand: template_string_$item(_templateObject213 || (_templateObject213 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject214 || (_templateObject214 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject215 || (_templateObject215 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "broken"
      }
    },
    combat: new CombatStrategy().autoattack(() => Macro.externalIf(property_get("lastCopyableMonster") === $monster(_templateObject216 || (_templateObject216 = levelling_taggedTemplateLiteral(["Witchess Bishop"]))), Macro.trySkill(template_string_$skill(_templateObject217 || (_templateObject217 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).if_($monster(_templateObject218 || (_templateObject218 = levelling_taggedTemplateLiteral(["Perceiver of Sensations"]))), Macro.tryItem(template_string_$item(_templateObject219 || (_templateObject219 = levelling_taggedTemplateLiteral(["abstraction: thought"]))))).if_($monster(_templateObject220 || (_templateObject220 = levelling_taggedTemplateLiteral(["Thinker of Thoughts"]))), Macro.tryItem(template_string_$item(_templateObject221 || (_templateObject221 = levelling_taggedTemplateLiteral(["abstraction: action"]))))).trySkill(template_string_$skill(_templateObject222 || (_templateObject222 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Neverending Free Fights",
    completed: () => property_get("_neverendingPartyFreeTurns") >= 10,
    do: $location(_templateObject223 || (_templateObject223 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject224 || (_templateObject224 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject225 || (_templateObject225 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject226 || (_templateObject226 = levelling_taggedTemplateLiteral(["sausage goblin"]))), Macro.trySkill(template_string_$skill(_templateObject227 || (_templateObject227 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).trySkill(template_string_$skill(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).trySkillRepeat(template_string_$skill(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject231 || (_templateObject231 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Witch",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["battle broom"])))),
    do: () => fightPiece($monster(_templateObject233 || (_templateObject233 = levelling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject234 || (_templateObject234 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject235 || (_templateObject235 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkillRepeat(template_string_$skill(_templateObject236 || (_templateObject236 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject237 || (_templateObject237 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Queen",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject238 || (_templateObject238 = levelling_taggedTemplateLiteral(["very pointy crown"])))),
    do: () => fightPiece($monster(_templateObject239 || (_templateObject239 = levelling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject240 || (_templateObject240 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject241 || (_templateObject241 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Shattering Punches",
    completed: () => property_get("_shatteringPunchUsed") >= 3,
    do: $location(_templateObject242 || (_templateObject242 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject243 || (_templateObject243 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      weaponOverride: have(template_string_$item(_templateObject244 || (_templateObject244 = levelling_taggedTemplateLiteral(["fish hatchet"])))) ? template_string_$item(_templateObject245 || (_templateObject245 = levelling_taggedTemplateLiteral(["fish hatchet"]))) : template_string_$item(_templateObject246 || (_templateObject246 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      acc2Override: template_string_$item(_templateObject247 || (_templateObject247 = levelling_taggedTemplateLiteral(["Cincho de Mayo"]))),
      modesOverride: {
        umbrella: "broken",
        backupcamera: "ml"
      }
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject248 || (_templateObject248 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject249 || (_templateObject249 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject250 || (_templateObject250 = levelling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject251 || (_templateObject251 = levelling_taggedTemplateLiteral(["Cincho: Confetti Extravaganza"])))).trySkill(template_string_$skill(_templateObject252 || (_templateObject252 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject253 || (_templateObject253 = levelling_taggedTemplateLiteral(["Shattering Punch"])))).abort())
  }, {
    name: "Chest X-rays",
    completed: () => property_get("_chestXRayUsed") >= 3,
    do: $location(_templateObject254 || (_templateObject254 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      acc2: template_string_$item(_templateObject255 || (_templateObject255 = levelling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject256 || (_templateObject256 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject257 || (_templateObject257 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject258 || (_templateObject258 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject259 || (_templateObject259 = levelling_taggedTemplateLiteral(["Chest X-Ray"])))).abort())
  }, {
    name: "Mob-Hit",
    completed: () => property_get("_gingerbreadMobHitUsed"),
    do: $location(_templateObject260 || (_templateObject260 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject261 || (_templateObject261 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject262 || (_templateObject262 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject263 || (_templateObject263 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject264 || (_templateObject264 = levelling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort())
  }]
};
...
var noncombatQuest = {
  ...
  tasks: [{
    ...
    outfit: () => ({
      hat: template_string_$item(noncombat_templateObject11 || (noncombat_templateObject11 = noncombat_taggedTemplateLiteral(["very pointy crown"]))),
      offhand: template_string_$item(noncombat_templateObject12 || (noncombat_templateObject12 = noncombat_taggedTemplateLiteral(["unbreakable umbrella"]))),
      modifier: "-60 combat rate, +switch left-hand man, +switch disgeist"
    }),
    effects: [$effect(noncombat_templateObject13 || (noncombat_templateObject13 = noncombat_taggedTemplateLiteral(["Empathy"]))), $effect(noncombat_templateObject14 || (noncombat_templateObject14 = noncombat_taggedTemplateLiteral(["Blood Bond"]))), $effect(noncombat_templateObject15 || (noncombat_templateObject15 = noncombat_taggedTemplateLiteral(["Leash of Linguini"]))), $effect(noncombat_templateObject16 || (noncombat_templateObject16 = noncombat_taggedTemplateLiteral(["The Sonata of Sneakiness"]))), $effect(noncombat_templateObject17 || (noncombat_templateObject17 = noncombat_taggedTemplateLiteral(["Smooth Movements"]))), $effect(noncombat_templateObject18 || (noncombat_templateObject18 = noncombat_taggedTemplateLiteral(["Feeling Lonely"])))]
  }, {
    name: "Silent Running",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have($effect(noncombat_templateObject19 || (noncombat_templateObject19 = noncombat_taggedTemplateLiteral(["Silent Running"])))) || property_get("_olympicSwimmingPool") || CommunityService.Noncombat.actualCost() === 1,
...
var skeletonsQuest = {
  ...
  tasks: [loss, {
    ...
    combat: new CombatStrategy().macro(Macro.ifHolidayWanderer(Macro.trySkill(template_string_$skill(skeletons_templateObject21 || (skeletons_templateObject21 = skeletons_taggedTemplateLiteral(["Bowl a Curveball"])))).trySkill(template_string_$skill(skeletons_templateObject22 || (skeletons_templateObject22 = skeletons_taggedTemplateLiteral(["Feel Hatred"])))).abort()).trySkill(template_string_$skill(skeletons_templateObject23 || (skeletons_templateObject23 = skeletons_taggedTemplateLiteral(["Feel Nostalgic"])))).trySkill(template_string_$skill(skeletons_templateObject24 || (skeletons_templateObject24 = skeletons_taggedTemplateLiteral(["Spit jurassic acid"])))).abort()),
    outfit: {
      hat: template_string_$item.none,
      offhand: template_string_$item(skeletons_templateObject25 || (skeletons_templateObject25 = skeletons_taggedTemplateLiteral(["unbreakable umbrella"]))),
      shirt: template_string_$item(skeletons_templateObject26 || (skeletons_templateObject26 = skeletons_taggedTemplateLiteral(["Jurassic Parka"]))),
      acc1: template_string_$item(skeletons_templateObject27 || (skeletons_templateObject27 = skeletons_taggedTemplateLiteral(["backup camera"]))),
      acc2: template_string_$item(skeletons_templateObject28 || (skeletons_templateObject28 = skeletons_taggedTemplateLiteral(["your cowboy boots"]))),
      modes: {
        umbrella: "broken",
        parka: "dilophosaur",
        backupcamera: "ml"
    ...
    name: "Red May Day",
    completed: () => [template_string_$item(skeletons_templateObject29 || (skeletons_templateObject29 = skeletons_taggedTemplateLiteral(["red box"]))), template_string_$item(skeletons_templateObject30 || (skeletons_templateObject30 = skeletons_taggedTemplateLiteral(["MayDay\u2122 supply package"])))].every(i => !have(i)),
    do: () => {
      [template_string_$item(skeletons_templateObject31 || (skeletons_templateObject31 = skeletons_taggedTemplateLiteral(["red box"]))), template_string_$item(skeletons_templateObject32 || (skeletons_templateObject32 = skeletons_taggedTemplateLiteral(["MayDay\u2122 supply package"])))].forEach(i => (0,external_kolmafia_namespaceObject.use)(1, i));
      if (have(template_string_$item(skeletons_templateObject33 || (skeletons_templateObject33 = skeletons_taggedTemplateLiteral(["space blanket"]))))) {
        (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(skeletons_templateObject34 || (skeletons_templateObject34 = skeletons_taggedTemplateLiteral(["space blanket"]))));
      }
    }
  }, {
    name: "Acquire Floundry Item",
    prepare: () => Clan.join("Floundry"),
    completed: () => property_get("_floundryItemCreated") || have(template_string_$item(skeletons_templateObject35 || (skeletons_templateObject35 = skeletons_taggedTemplateLiteral(["red shoe"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject36 || (skeletons_templateObject36 = skeletons_taggedTemplateLiteral(["codpiece"])))),
    post: () => Clan.join("Bonus Adventures from Hell")
  }, {
    name: "Purchase Fireworks Hat",
    completed: () => have(template_string_$item(skeletons_templateObject37 || (skeletons_templateObject37 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject38 || (skeletons_templateObject38 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))))
  }, {
    name: "Guild Unlock",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished" || args.fam,
    do: guildZone,
    outfit: {
      offhand: template_string_$item(skeletons_templateObject39 || (skeletons_templateObject39 = skeletons_taggedTemplateLiteral(["familiar scrapbook"]))),
      hat: template_string_$item(skeletons_templateObject40 || (skeletons_templateObject40 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      familiar: template_string_$familiar(skeletons_templateObject41 || (skeletons_templateObject41 = skeletons_taggedTemplateLiteral(["Pair of Stomping Boots"]))),
      famequip: template_string_$item(skeletons_templateObject42 || (skeletons_templateObject42 = skeletons_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        parka: "spikolodon"
      }
    },
    combat: new CombatStrategy().autoattack(Macro.runaway().abort()),
    effects: [$effect(skeletons_templateObject43 || (skeletons_templateObject43 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject44 || (skeletons_templateObject44 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), $effect(skeletons_templateObject45 || (skeletons_templateObject45 = skeletons_taggedTemplateLiteral(["Empathy"]))), $effect(skeletons_templateObject46 || (skeletons_templateObject46 = skeletons_taggedTemplateLiteral(["Blood Bond"])))]
  }, {
    name: "Guild Unlock (100% Familiar)",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished",
    do: () => guildZone,
    effects: [$effect(skeletons_templateObject47 || (skeletons_templateObject47 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject48 || (skeletons_templateObject48 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"])))],
    outfit: () => ({
      offhand: template_string_$item(skeletons_templateObject49 || (skeletons_templateObject49 = skeletons_taggedTemplateLiteral(["familiar scrapbook"]))),
      hat: template_string_$item(skeletons_templateObject50 || (skeletons_templateObject50 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      acc1: property_get("_reflexHammerUsed") >= 3 ? template_string_$item(skeletons_templateObject51 || (skeletons_templateObject51 = skeletons_taggedTemplateLiteral(["backup camera"]))) : template_string_$item(skeletons_templateObject52 || (skeletons_templateObject52 = skeletons_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))),
      familiar: args.familiar,
      famequip: template_string_$item(skeletons_templateObject53 || (skeletons_templateObject53 = skeletons_taggedTemplateLiteral(["tiny stillsuit"])))
    }),
    combat: new CombatStrategy().autoattack(() => Macro.externalIf(property_get("_reflexHammerUsed") < 3, Macro.trySkill(template_string_$skill(skeletons_templateObject54 || (skeletons_templateObject54 = skeletons_taggedTemplateLiteral(["Reflex Hammer"]))))).trySkill(template_string_$skill(skeletons_templateObject55 || (skeletons_templateObject55 = skeletons_taggedTemplateLiteral(["Feel Hatred"])))).abort())
  }, {
    name: "Cemetery Unlock",
    completed: () => (0,external_kolmafia_namespaceObject.canAdventure)($location(skeletons_templateObject56 || (skeletons_templateObject56 = skeletons_taggedTemplateLiteral(["The Unquiet Garves"])))),
    do: () => {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject57 || (skeletons_templateObject57 = skeletons_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(skeletons_templateObject58 || (skeletons_templateObject58 = skeletons_taggedTemplateLiteral(["11-leaf clover"]))));
      (0,external_kolmafia_namespaceObject.adv1)($location(skeletons_templateObject59 || (skeletons_templateObject59 = skeletons_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
      ensureEffect($effect(skeletons_templateObject60 || (skeletons_templateObject60 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
      (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(skeletons_templateObject61 || (skeletons_templateObject61 = skeletons_taggedTemplateLiteral(["distilled fortified wine"]))));
      uneffect($effect(skeletons_templateObject62 || (skeletons_templateObject62 = skeletons_taggedTemplateLiteral(["Ode to Booze"]))));
    }
  }]
};
