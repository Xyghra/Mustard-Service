...
var runStartQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      back: have(template_string_$item(preSkeletons_templateObject25 || (preSkeletons_templateObject25 = preSkeletons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) ? template_string_$item(preSkeletons_templateObject26 || (preSkeletons_templateObject26 = preSkeletons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))) : undefined,
      pants: template_string_$item(preSkeletons_templateObject27 || (preSkeletons_templateObject27 = preSkeletons_taggedTemplateLiteral(["designer sweatpants"])))
    }
  }, {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(2, template_string_$item(preSkeletons_templateObject30 || (preSkeletons_templateObject30 = preSkeletons_taggedTemplateLiteral(["borrowed time"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(preSkeletons_templateObject31 || (preSkeletons_templateObject31 = preSkeletons_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    }
  }, {
    name: "Borrow Time",
    ...
    do: () => {
      ...
      (0,external_kolmafia_namespaceObject.equip)($slot(preSkeletons_templateObject33 || (preSkeletons_templateObject33 = preSkeletons_taggedTemplateLiteral(["familiar"]))), template_string_$item(preSkeletons_templateObject34 || (preSkeletons_templateObject34 = preSkeletons_taggedTemplateLiteral(["tiny stillsuit"]))));
    }
  }, {
    name: "Mummery",
    completed: () => property_get("_mummeryUses") !== "",
    do: () => {
      withChoice(1071, 3, () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject35 || (preSkeletons_templateObject35 = preSkeletons_taggedTemplateLiteral(["mumming trunk"])))));
    }
  }, {
    name: "SongBoom\u2122",
    ...
    completed: () => have(template_string_$item(preSkeletons_templateObject36 || (preSkeletons_templateObject36 = preSkeletons_taggedTemplateLiteral(["ebony epee"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.visitUrl)("shop.php?whichshop=lathe");
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(preSkeletons_templateObject37 || (preSkeletons_templateObject37 = preSkeletons_taggedTemplateLiteral(["ebony epee"]))));
    }
  }, {
    name: "DRINKME",
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject38 || (preSkeletons_templateObject38 = preSkeletons_taggedTemplateLiteral(["model train set"])))),
    completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(preSkeletons_templateObject39 || (preSkeletons_templateObject39 = preSkeletons_taggedTemplateLiteral(["model train set"]))) && property_get("trainsetConfiguration") !== "",
...
var skeletonsQuest = {
  ...
  tasks: [{
    ...
    ready: () => property_get("lastCopyableMonster") === $monster(skeletons_templateObject26 || (skeletons_templateObject26 = skeletons_taggedTemplateLiteral(["red skeleton"]))),
    ...
    outfit: {
      offhand: template_string_$item(skeletons_templateObject34 || (skeletons_templateObject34 = skeletons_taggedTemplateLiteral(["latte lovers member's mug"]))),
    ...
    completed: () => have(template_string_$item(skeletons_templateObject42 || (skeletons_templateObject42 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(skeletons_templateObject43 || (skeletons_templateObject43 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))))
  }, {
    name: "Guild Unlock",
    completed: () => property_get(guildQuest) === "step1" || property_get(guildQuest) === "finished",
    do: guildZone,
    outfit: {
      offhand: template_string_$item(skeletons_templateObject44 || (skeletons_templateObject44 = skeletons_taggedTemplateLiteral(["latte lovers member's mug"]))),
      hat: template_string_$item(skeletons_templateObject45 || (skeletons_templateObject45 = skeletons_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
    ...
    effects: [$effect(skeletons_templateObject48 || (skeletons_templateObject48 = skeletons_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(skeletons_templateObject49 || (skeletons_templateObject49 = skeletons_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), $effect(skeletons_templateObject50 || (skeletons_templateObject50 = skeletons_taggedTemplateLiteral(["Empathy"]))), $effect(skeletons_templateObject51 || (skeletons_templateObject51 = skeletons_taggedTemplateLiteral(["Blood Bond"])))]
  }, {
    name: "Cemetary Unlock",
    completed: () => (0,external_kolmafia_namespaceObject.canAdventure)($location(skeletons_templateObject52 || (skeletons_templateObject52 = skeletons_taggedTemplateLiteral(["The Unquiet Garves"])))),
    do: () => {
    ...
    outfit: {
      familiar: template_string_$familiar(skeletons_templateObject53 || (skeletons_templateObject53 = skeletons_taggedTemplateLiteral(["Melodramedary"]))),
...
var levellingOutfit = {
  ...
  offhand: template_string_$item(levelling_templateObject9 || (levelling_templateObject9 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
  pants: template_string_$item(levelling_templateObject10 || (levelling_templateObject10 = levelling_taggedTemplateLiteral(["designer sweatpants"]))),
  acc1: template_string_$item(levelling_templateObject11 || (levelling_templateObject11 = levelling_taggedTemplateLiteral(["backup camera"]))),
  acc2: template_string_$item(levelling_templateObject12 || (levelling_templateObject12 = levelling_taggedTemplateLiteral(["your cowboy boots"]))),
  acc3: template_string_$item(levelling_templateObject13 || (levelling_templateObject13 = levelling_taggedTemplateLiteral(["combat lover's locket"]))),
  familiar: template_string_$familiar(levelling_templateObject14 || (levelling_templateObject14 = levelling_taggedTemplateLiteral(["Melodramedary"]))),
  famequip: template_string_$item(levelling_templateObject15 || (levelling_templateObject15 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
};
var facialExpression = byStat({
  Muscle: $effect(levelling_templateObject16 || (levelling_templateObject16 = levelling_taggedTemplateLiteral(["Quiet Determination"]))),
  Mysticality: $effect(levelling_templateObject17 || (levelling_templateObject17 = levelling_taggedTemplateLiteral(["Inscrutable Gaze"]))),
  Moxie: $effect(levelling_templateObject18 || (levelling_templateObject18 = levelling_taggedTemplateLiteral(["Quiet Desperation"])))
});
var showerEffect = byStat({
  Muscle: $effect(levelling_templateObject19 || (levelling_templateObject19 = levelling_taggedTemplateLiteral(["Muscle Unbound"]))),
  Mysticality: $effect(levelling_templateObject20 || (levelling_templateObject20 = levelling_taggedTemplateLiteral(["Thaumodynamic"]))),
  Moxie: $effect(levelling_templateObject21 || (levelling_templateObject21 = levelling_taggedTemplateLiteral(["So Fresh and So Clean"])))
});
var levellingEffects = [//Starter Buffs
$effect(levelling_templateObject22 || (levelling_templateObject22 = levelling_taggedTemplateLiteral(["Mariachi Mood"]))), $effect(levelling_templateObject23 || (levelling_templateObject23 = levelling_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), $effect(levelling_templateObject24 || (levelling_templateObject24 = levelling_taggedTemplateLiteral(["Saucemastery"]))), $effect(levelling_templateObject25 || (levelling_templateObject25 = levelling_taggedTemplateLiteral(["Patience of the Tortoise"]))), $effect(levelling_templateObject26 || (levelling_templateObject26 = levelling_taggedTemplateLiteral(["Disco State of Mind"]))), $effect(levelling_templateObject27 || (levelling_templateObject27 = levelling_taggedTemplateLiteral(["Pasta Oneness"]))), //Tiny buffs
$effect(levelling_templateObject28 || (levelling_templateObject28 = levelling_taggedTemplateLiteral(["Reptilian Fortitude"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject29 || (levelling_templateObject29 = levelling_taggedTemplateLiteral(["Turtle Tamer"]))) ? $effect(levelling_templateObject30 || (levelling_templateObject30 = levelling_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : $effect(levelling_templateObject31 || (levelling_templateObject31 = levelling_taggedTemplateLiteral(["Disdain of the War Snapper"]))), $effect(levelling_templateObject32 || (levelling_templateObject32 = levelling_taggedTemplateLiteral(["Blubbered Up"]))), $effect(levelling_templateObject33 || (levelling_templateObject33 = levelling_taggedTemplateLiteral(["Tenacity of the Snapper"]))), $effect(levelling_templateObject34 || (levelling_templateObject34 = levelling_taggedTemplateLiteral(["Employee of the Month"]))), //Bigger stat buffs
$effect(levelling_templateObject35 || (levelling_templateObject35 = levelling_taggedTemplateLiteral(["Disco Fever"]))), $effect(levelling_templateObject36 || (levelling_templateObject36 = levelling_taggedTemplateLiteral(["Rage of the Reindeer"]))), $effect(levelling_templateObject37 || (levelling_templateObject37 = levelling_taggedTemplateLiteral(["Big"]))), $effect(levelling_templateObject38 || (levelling_templateObject38 = levelling_taggedTemplateLiteral(["Song of Bravado"]))),
//Facial
facialExpression, //Feelings
$effect(levelling_templateObject39 || (levelling_templateObject39 = levelling_taggedTemplateLiteral(["Feeling Excited"]))), $effect(levelling_templateObject40 || (levelling_templateObject40 = levelling_taggedTemplateLiteral(["Feeling Peaceful"]))), //Songs
$effect(levelling_templateObject41 || (levelling_templateObject41 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(levelling_templateObject42 || (levelling_templateObject42 = levelling_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effect(levelling_templateObject43 || (levelling_templateObject43 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), $effect(levelling_templateObject44 || (levelling_templateObject44 = levelling_taggedTemplateLiteral(["Aloysius' Antiphon of Aptitude"]))), //ML and Bonus Stats
$effect(levelling_templateObject45 || (levelling_templateObject45 = levelling_taggedTemplateLiteral(["Carol of the Thrills"]))), $effect(levelling_templateObject46 || (levelling_templateObject46 = levelling_taggedTemplateLiteral(["Pride of the Puffin"]))), $effect(levelling_templateObject47 || (levelling_templateObject47 = levelling_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), //Defensive
$effect(levelling_templateObject48 || (levelling_templateObject48 = levelling_taggedTemplateLiteral(["Ghostly Shell"]))), $effect(levelling_templateObject49 || (levelling_templateObject49 = levelling_taggedTemplateLiteral(["Astral Shell"]))), $effect(levelling_templateObject50 || (levelling_templateObject50 = levelling_taggedTemplateLiteral(["Jalape\xF1o Saucesphere"]))), $effect(levelling_templateObject51 || (levelling_templateObject51 = levelling_taggedTemplateLiteral(["Spiky Shell"]))), $effect(levelling_templateObject52 || (levelling_templateObject52 = levelling_taggedTemplateLiteral(["Elemental Saucesphere"]))), $effect(levelling_templateObject53 || (levelling_templateObject53 = levelling_taggedTemplateLiteral(["Scarysauce"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(levelling_templateObject54 || (levelling_templateObject54 = levelling_taggedTemplateLiteral(["Pastamancer"]))) ? $effect(levelling_templateObject55 || (levelling_templateObject55 = levelling_taggedTemplateLiteral(["Shield of the Pastalord"]))) : $effect(levelling_templateObject56 || (levelling_templateObject56 = levelling_taggedTemplateLiteral(["Flimsy Shield of the Pastalord"]))), //Elemental Weapon Damage
$effect(levelling_templateObject57 || (levelling_templateObject57 = levelling_taggedTemplateLiteral(["Your Fifteen Minutes"]))), $effect(levelling_templateObject58 || (levelling_templateObject58 = levelling_taggedTemplateLiteral(["Frostbeard"]))), $effect(levelling_templateObject59 || (levelling_templateObject59 = levelling_taggedTemplateLiteral(["Takin' It Greasy"]))), $effect(levelling_templateObject60 || (levelling_templateObject60 = levelling_taggedTemplateLiteral(["Rotten Memories"]))), $effect(levelling_templateObject61 || (levelling_templateObject61 = levelling_taggedTemplateLiteral(["Pyromania"]))), $effect(levelling_templateObject62 || (levelling_templateObject62 = levelling_taggedTemplateLiteral(["Intimidating Mien"]))), //Familiar!
$effect(levelling_templateObject63 || (levelling_templateObject63 = levelling_taggedTemplateLiteral(["Curiosity of Br'er Tarrypin"]))), $effect(_templateObject64 || (_templateObject64 = levelling_taggedTemplateLiteral(["Empathy"]))), $effect(_templateObject65 || (_templateObject65 = levelling_taggedTemplateLiteral(["Leash of Linguini"]))), $effect(_templateObject66 || (_templateObject66 = levelling_taggedTemplateLiteral(["Blood Bond"]))), //Misc
$effect(_templateObject67 || (_templateObject67 = levelling_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(_templateObject68 || (_templateObject68 = levelling_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(_templateObject69 || (_templateObject69 = levelling_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), $effect(_templateObject70 || (_templateObject70 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))];
(0,external_kolmafia_namespaceObject.print)("".concat(levellingEffects));
var levellingQuest = {
  name: "Levelling",
  completed: () => (property_get("_gingerbreadMobHitUsed") || (0,external_kolmafia_namespaceObject.myLevel)() >= 15) && have(template_string_$item(_templateObject71 || (_templateObject71 = levelling_taggedTemplateLiteral(["battle broom"])))),
  tasks: [{
    name: "Beaten Up!",
    completed: () => !have($effect(_templateObject72 || (_templateObject72 = levelling_taggedTemplateLiteral(["Beaten Up"])))),
    ...
    do: () => {
      upgrade();
      sendTo($location(_templateObject73 || (_templateObject73 = levelling_taggedTemplateLiteral(["Shadow Rift"]))));
    }
  }, {
    name: "Swap Shortcook",
    ready: () => have($effect(_templateObject74 || (_templateObject74 = levelling_taggedTemplateLiteral(["Spit Upon"])))) && ((0,external_kolmafia_namespaceObject.myFamiliar)() !== template_string_$familiar(_templateObject75 || (_templateObject75 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || ![1, 2, 3, 4].includes(property_get("_machineTunnelsAdv"))),
    completed: () => (0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar(_templateObject76 || (_templateObject76 = levelling_taggedTemplateLiteral(["Shorter-Order Cook"]))) || have(template_string_$item(_templateObject77 || (_templateObject77 = levelling_taggedTemplateLiteral(["short stack of pancakes"])))),
    do: () => (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject78 || (_templateObject78 = levelling_taggedTemplateLiteral(["Shorter-Order Cook"]))))
  }, {
    name: "Swap Sombrero",
    ready: () => have($effect(_templateObject79 || (_templateObject79 = levelling_taggedTemplateLiteral(["Spit Upon"])))) && ((0,external_kolmafia_namespaceObject.myFamiliar)() !== template_string_$familiar(_templateObject80 || (_templateObject80 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || ![1, 2, 3, 4].includes(property_get("_machineTunnelsAdv"))) && have(template_string_$item(_templateObject81 || (_templateObject81 = levelling_taggedTemplateLiteral(["short stack of pancakes"])))),
    completed: () => (0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar(_templateObject82 || (_templateObject82 = levelling_taggedTemplateLiteral(["Hovering Sombrero"]))),
    do: () => (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject83 || (_templateObject83 = levelling_taggedTemplateLiteral(["Hovering Sombrero"]))))
  }, {
    name: "Drink Pilsners",
    ready: () => (0,external_kolmafia_namespaceObject.myLevel)() >= 11 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject84 || (_templateObject84 = levelling_taggedTemplateLiteral(["astral pilsner"])))) >= 4,
    prepare: () => {
      uneffect($effect(_templateObject85 || (_templateObject85 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
      ensureEffect($effect(_templateObject86 || (_templateObject86 = levelling_taggedTemplateLiteral(["Ode to Booze"]))), 4);
    },
    completed: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject87 || (_templateObject87 = levelling_taggedTemplateLiteral(["astral pilsner"])))) < 4,
    do: () => (0,external_kolmafia_namespaceObject.drink)(4, template_string_$item(_templateObject88 || (_templateObject88 = levelling_taggedTemplateLiteral(["astral pilsner"])))),
    post: () => {
      uneffect($effect(_templateObject89 || (_templateObject89 = levelling_taggedTemplateLiteral(["Ode to Booze"]))));
      ensureEffect($effect(_templateObject90 || (_templateObject90 = levelling_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))));
    }
  }, {
    name: "June Cleave",
    ready: () => property_get("_juneCleaverFightsLeft") === 0,
    prepare: () => levelling_curWeapon = (0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject91 || (_templateObject91 = levelling_taggedTemplateLiteral(["weapon"])))),
    completed: () => property_get("_juneCleaverFightsLeft") > 0,
    do: () => (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject92 || (_templateObject92 = levelling_taggedTemplateLiteral(["The Sleazy Back Alley"]))), -1, "abort;"),
    outfit: {
      weapon: template_string_$item(_templateObject93 || (_templateObject93 = levelling_taggedTemplateLiteral(["June cleaver"])))
    },
    post: () => {
      if (have($effect(_templateObject94 || (_templateObject94 = levelling_taggedTemplateLiteral(["Beaten Up"]))))) {
        uneffect($effect(_templateObject95 || (_templateObject95 = levelling_taggedTemplateLiteral(["Beaten Up"]))));
      }
      (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject96 || (_templateObject96 = levelling_taggedTemplateLiteral(["weapon"]))), levelling_curWeapon);
    }
  }, {
    name: "Restore HP",
    ...
    prepare: () => {
      curOffhand = (0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject97 || (_templateObject97 = levelling_taggedTemplateLiteral(["off-hand"]))));
    },
    ready: () => getKramcoWandererChance() === 1 && property_get("_latteRefillsUsed") >= 3 && property_get("_neverendingPartyFreeTurns") >= 1,
    completed: () => getKramcoWandererChance() < 1,
    do: () => $location(_templateObject98 || (_templateObject98 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    outfit: {
      offhand: template_string_$item(_templateObject99 || (_templateObject99 = levelling_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))
    },
    combat: new CombatStrategy().macro(Macro.attack().repeat()),
    post: () => (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject100 || (_templateObject100 = levelling_taggedTemplateLiteral(["off-hand"]))), curOffhand)
  }, {
    name: "April Shower",
    ...
    name: "Use 10% Bonus",
    completed: () => !have(template_string_$item(_templateObject101 || (_templateObject101 = levelling_taggedTemplateLiteral(["a ten-percent bonus"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject102 || (_templateObject102 = levelling_taggedTemplateLiteral(["a ten-percent bonus"]))))
  }, {
    ...
    completed: () => have(template_string_$item(_templateObject108 || (_templateObject108 = levelling_taggedTemplateLiteral(["Catherine Wheel"])))) || have(template_string_$item(_templateObject109 || (_templateObject109 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject110 || (_templateObject110 = levelling_taggedTemplateLiteral(["Catherine Wheel"]))))
  }, {
    name: "Boxing Daycare Buff",
    completed: () => [$effect(_templateObject111 || (_templateObject111 = levelling_taggedTemplateLiteral(["Muddled"]))), $effect(_templateObject112 || (_templateObject112 = levelling_taggedTemplateLiteral(["Ten out of Ten"]))), $effect(_templateObject113 || (_templateObject113 = levelling_taggedTemplateLiteral(["Uncucumbered"])))].some(ef => have(ef)) || property_get("_daycareSpa"),
    ...
    completed: () => have($effect(_templateObject114 || (_templateObject114 = levelling_taggedTemplateLiteral(["A Contender"])))) || property_get("_genieWishesUsed") >= 2 || true,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect A Contender")
  }, {
    name: "Wish for New and Improved",
    completed: () => have($effect(_templateObject115 || (_templateObject115 = levelling_taggedTemplateLiteral(["New and Improved"])))) || property_get("_genieWishesUsed") >= 2,
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect New and Improved")
  }, {
    name: "Use Market Consumables",
    completed: () => [$effect(_templateObject116 || (_templateObject116 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject117 || (_templateObject117 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject118 || (_templateObject118 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].every(ef => have(ef)),
    do: () => [$effect(_templateObject119 || (_templateObject119 = levelling_taggedTemplateLiteral(["Glittering Eyelashes"]))), $effect(_templateObject120 || (_templateObject120 = levelling_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(_templateObject121 || (_templateObject121 = levelling_taggedTemplateLiteral(["Butt-Rock Hair"])))].forEach(ef => ensureEffect(ef, 9))
  }, {
    name: "Use Wasabi Marble Soda",
    completed: () => !have(template_string_$item(_templateObject122 || (_templateObject122 = levelling_taggedTemplateLiteral(["wasabi marble soda"])))) || have($effect(_templateObject123 || (_templateObject123 = levelling_taggedTemplateLiteral(["Wasabi With You"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject124 || (_templateObject124 = levelling_taggedTemplateLiteral(["wasabi marble soda"]))))
  }, {
    name: "Eat sosig",
    ready: () => (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject125 || (_templateObject125 = levelling_taggedTemplateLiteral(["magical sausage casing"])))) > 0,
    completed: () => property_get("_sausagesEaten") > 0,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject126 || (_templateObject126 = levelling_taggedTemplateLiteral(["magical sausage"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject127 || (_templateObject127 = levelling_taggedTemplateLiteral(["magical sausage"]))));
    }
  }, {
    ...
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject129 || (_templateObject129 = levelling_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))))
  }, {
    name: "Become Occultic",
    completed: () => have($effect(_templateObject130 || (_templateObject130 = levelling_taggedTemplateLiteral(["Mystically Oiled"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject131 || (_templateObject131 = levelling_taggedTemplateLiteral(["ointment of the occult"]))));
      ensureEffect($effect(_templateObject132 || (_templateObject132 = levelling_taggedTemplateLiteral(["Mystically Oiled"]))));
    }
  }, {
    name: "Become Phorceful",
    completed: () => have($effect(_templateObject133 || (_templateObject133 = levelling_taggedTemplateLiteral(["Phorcefullness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject134 || (_templateObject134 = levelling_taggedTemplateLiteral(["philter of phorce"]))));
      ensureEffect($effect(_templateObject135 || (_templateObject135 = levelling_taggedTemplateLiteral(["Phorcefullness"]))));
    }
  }, {
    name: "Stabilize your Oils",
    completed: () => have($effect(_templateObject136 || (_templateObject136 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject137 || (_templateObject137 = levelling_taggedTemplateLiteral(["oil of stability"]))));
      ensureEffect($effect(_templateObject138 || (_templateObject138 = levelling_taggedTemplateLiteral(["Stabilizing Oiliness"]))));
    }
  }, {
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject139 || (_templateObject139 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      fill("pumpkin", "cinnamon", "vanilla");
    },
    outfit: {
      offhand: template_string_$item(_templateObject140 || (_templateObject140 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modifier: "mp"
    },
    effects: [$effect(_templateObject141 || (_templateObject141 = levelling_taggedTemplateLiteral(["Big"]))), $effect(_templateObject142 || (_templateObject142 = levelling_taggedTemplateLiteral(["Song of Bravado"]))), $effect(_templateObject143 || (_templateObject143 = levelling_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject144 || (_templateObject144 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? $effect(_templateObject145 || (_templateObject145 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : $effect(_templateObject146 || (_templateObject146 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))],
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject147 || (_templateObject147 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject148 || (_templateObject148 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    name: "Buff the heck up oomfie!",
    completed: () => have($effect(_templateObject149 || (_templateObject149 = levelling_taggedTemplateLiteral(["Bendin' Hell"])))) || property_get("_speakeasyFreeFights") === 3,
    do: () => levellingEffects.forEach(ef => ensureEffect(ef))
  }, {
    name: "Latte for Later",
    completed: () => property_get("_latteRefillsUsed") >= 3,
    do: () => {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject150 || (_templateObject150 = levelling_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1);
      fill("pumpkin", "cinnamon", "vanilla");
    },
    outfit: {
      hat: template_string_$item(_templateObject151 || (_templateObject151 = levelling_taggedTemplateLiteral(["wad of used tape"]))),
      back: have(template_string_$item(_templateObject152 || (_templateObject152 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) ? template_string_$item(_templateObject153 || (_templateObject153 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))) : template_string_$item(_templateObject154 || (_templateObject154 = levelling_taggedTemplateLiteral(["Catherine Wheel"]))),
      shirt: template_string_$item(_templateObject155 || (_templateObject155 = levelling_taggedTemplateLiteral(["Jurassic Parka"]))),
      weapon: template_string_$item(_templateObject156 || (_templateObject156 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      pants: template_string_$item(_templateObject157 || (_templateObject157 = levelling_taggedTemplateLiteral(["designer sweatpants"]))),
      acc1: template_string_$item(_templateObject158 || (_templateObject158 = levelling_taggedTemplateLiteral(["backup camera"]))),
      acc2: template_string_$item(_templateObject159 || (_templateObject159 = levelling_taggedTemplateLiteral(["your cowboy boots"]))),
      acc3: template_string_$item(_templateObject160 || (_templateObject160 = levelling_taggedTemplateLiteral(["combat lover's locket"]))),
      familiar: template_string_$familiar(_templateObject161 || (_templateObject161 = levelling_taggedTemplateLiteral(["Melodramedary"]))),
      famequip: template_string_$item(_templateObject162 || (_templateObject162 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      offhand: template_string_$item(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["latte lovers member's mug"]))),
      modes: have(template_string_$item(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) ? {
        parka: "spikolodon",
        umbrella: "broken",
        backupcamera: "ml",
    ...
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject165 || (_templateObject165 = levelling_taggedTemplateLiteral(["Gulp Latte"])))).trySkill(template_string_$skill(_templateObject166 || (_templateObject166 = levelling_taggedTemplateLiteral(["Throw Latte on Opponent"])))).abort())
  }, {
    name: "Remove Bloodsugar",
    completed: () => !have($effect(_templateObject167 || (_templateObject167 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have($effect(_templateObject168 || (_templateObject168 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    do: () => (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject169 || (_templateObject169 = levelling_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))))
  }, {
    name: "Flapper Mapper",
    completed: () => property_get("_monstersMapped") >= 2,
    do: () => mapMonster($location(_templateObject170 || (_templateObject170 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject171 || (_templateObject171 = levelling_taggedTemplateLiteral(["goblin flapper"])))),
    outfit: {
      offhand: template_string_$item(_templateObject172 || (_templateObject172 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject173 || (_templateObject173 = levelling_taggedTemplateLiteral(["Nanorhino"]))),
      famequip: template_string_$item(_templateObject174 || (_templateObject174 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject175 || (_templateObject175 = levelling_taggedTemplateLiteral(["Feel Envy"])))).trySkill(template_string_$skill(_templateObject176 || (_templateObject176 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"])))).attack().repeat())
  }, {
    name: "Oliver's Place",
    completed: () => property_get("_speakeasyFreeFights") === 3,
    do: $location(_templateObject177 || (_templateObject177 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: levellingOutfit,
    combat: new CombatStrategy().macro(Macro.attack().repeat())
  }, {
    name: "Pick up a club!",
    completed: () => have(template_string_$item(_templateObject178 || (_templateObject178 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject179 || (_templateObject179 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))))
  }, {
    name: "Seal Fights",
    ...
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject180 || (_templateObject180 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(3, template_string_$item(_templateObject181 || (_templateObject181 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
    },
    outfit: {
      weapon: template_string_$item(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    },
    combat: new CombatStrategy().macro(Macro.attack().repeat())
  }, {
    name: "Get Payphone Quest",
    completed: () => property_get("_shadowAffinityToday"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 1
    }
  }, {
    ...
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject186 || (_templateObject186 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_fireExtinguisherCharge") <= 10,
    do: $location(_templateObject187 || (_templateObject187 = levelling_taggedTemplateLiteral(["Shadow Rift (The Misspelled Cemetary)"]))),
    outfit: {
      hat: template_string_$item(_templateObject188 || (_templateObject188 = levelling_taggedTemplateLiteral(["sombrero-mounted sparkler"]))),
      weapon: template_string_$item(_templateObject189 || (_templateObject189 = levelling_taggedTemplateLiteral(["industrial fire extinguisher"])))
    },
    combat: new CombatStrategy().macro(Macro.if_($monster(_templateObject190 || (_templateObject190 = levelling_taggedTemplateLiteral(["shadow slab"]))), Macro.trySkill(template_string_$skill(_templateObject191 || (_templateObject191 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject192 || (_templateObject192 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject193 || (_templateObject193 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject194 || (_templateObject194 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject195 || (_templateObject195 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject196 || (_templateObject196 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject197 || (_templateObject197 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject198 || (_templateObject198 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"])))).trySkill(template_string_$skill(_templateObject199 || (_templateObject199 = levelling_taggedTemplateLiteral(["Fire Extinguisher: Polar Vortex"]))))).attack().repeat())
  }, {
    name: "Payphone Freefights (cleaver)",
    ready: () => have($effect(_templateObject200 || (_templateObject200 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject201 || (_templateObject201 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: $location(_templateObject202 || (_templateObject202 = levelling_taggedTemplateLiteral(["Shadow Rift (The Misspelled Cemetary)"]))),
    outfit: {
    ...
    completed: () => have(template_string_$item(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("questRufus") === "step1",
    do: $location(_templateObject205 || (_templateObject205 = levelling_taggedTemplateLiteral(["Shadow Rift (The Misspelled Cemetary)"]))),
    outfit: {
      weapon: template_string_$item(_templateObject206 || (_templateObject206 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      familiar: template_string_$familiar(_templateObject207 || (_templateObject207 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject208 || (_templateObject208 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    },
    combat: new CombatStrategy().macro(Macro.if_($monster(_templateObject209 || (_templateObject209 = levelling_taggedTemplateLiteral(["shadow matrix"]))), Macro.trySkill(template_string_$skill(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkillRepeat(template_string_$skill(_templateObject211 || (_templateObject211 = levelling_taggedTemplateLiteral(["Saucegeyser"]))))).trySkillRepeat(template_string_$skill(_templateObject212 || (_templateObject212 = levelling_taggedTemplateLiteral(["Northern Explosion"])))))
  }, {
    name: "Retrieve Spooky Lodestone",
    ready: () => property_get("questRufus") === "step1",
    completed: () => have(template_string_$item(_templateObject213 || (_templateObject213 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject214 || (_templateObject214 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    post: () => (0,external_kolmafia_namespaceObject.cliExecute)("fold garbage shirt")
  }, {
    name: "Set Snojo Controls",
    completed: () => property_get("snojoSetting") === $stat(_templateObject215 || (_templateObject215 = levelling_taggedTemplateLiteral(["Moxie"]))),
    do: () => {
    ...
    do: $location(_templateObject216 || (_templateObject216 = levelling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    outfit: {
      shirt: template_string_$item(_templateObject217 || (_templateObject217 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      offhand: template_string_$item(_templateObject218 || (_templateObject218 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject219 || (_templateObject219 = levelling_taggedTemplateLiteral(["Melodramedary"]))),
      famequip: template_string_$item(_templateObject220 || (_templateObject220 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject221 || (_templateObject221 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).attack().repeat())
  }, {
    name: "Visit Hottub",
    completed: () => [$effect(_templateObject222 || (_templateObject222 = levelling_taggedTemplateLiteral(["Snowballed"]))), $effect(_templateObject223 || (_templateObject223 = levelling_taggedTemplateLiteral(["Bruised"]))), $effect(_templateObject224 || (_templateObject224 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), $effect(_templateObject225 || (_templateObject225 = levelling_taggedTemplateLiteral(["Hypnotized"]))), $effect(_templateObject226 || (_templateObject226 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
    ...
    do: () => fightPiece($monster(_templateObject227 || (_templateObject227 = levelling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).attack().repeat()),
    outfit: {
      famequip: template_string_$item(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    }
  }, {
    name: "Deep Machine Fights",
    completed: () => property_get("_machineTunnelsAdv") >= 5,
    do: () => $location(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    outfit: {
      offhand: template_string_$item(_templateObject231 || (_templateObject231 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject233 || (_templateObject233 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    },
    combat: new CombatStrategy().macro(() => Macro.trySkill(template_string_$skill(_templateObject234 || (_templateObject234 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject235 || (_templateObject235 = levelling_taggedTemplateLiteral(["Witchess Bishop"]))), Macro.trySkill(template_string_$skill(_templateObject236 || (_templateObject236 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).attack().repeat())
  }, {
    name: "Awful Bad things have happened, need more spit",
    completed: () => have($effect(_templateObject237 || (_templateObject237 = levelling_taggedTemplateLiteral(["Spit Upon"])))) || (0,external_kolmafia_namespaceObject.myFamiliar)() === template_string_$familiar(_templateObject238 || (_templateObject238 = levelling_taggedTemplateLiteral(["Melodramedary"]))),
    do: () => (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject239 || (_templateObject239 = levelling_taggedTemplateLiteral(["Melodramedary"]))))
  }, {
    ...
    combat: new CombatStrategy().macro(() => Macro.trySkill(template_string_$skill(_templateObject241 || (_templateObject241 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject242 || (_templateObject242 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject243 || (_templateObject243 = levelling_taggedTemplateLiteral(["sausage goblin"]))), Macro.trySkill(template_string_$skill(_templateObject244 || (_templateObject244 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).trySkillRepeat(template_string_$skill(_templateObject245 || (_templateObject245 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: {
      offhand: template_string_$item(_templateObject246 || (_templateObject246 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      famequip: template_string_$item(_templateObject247 || (_templateObject247 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "broken"
      }
    }
    ...
    name: "Witchess Witch",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject248 || (_templateObject248 = levelling_taggedTemplateLiteral(["battle broom"])))),
    do: () => fightPiece($monster(_templateObject249 || (_templateObject249 = levelling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject250 || (_templateObject250 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkillRepeat(template_string_$skill(_templateObject251 || (_templateObject251 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: {
      famequip: template_string_$item(_templateObject252 || (_templateObject252 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    }
  }, {
    name: "Witchess Queen",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject253 || (_templateObject253 = levelling_taggedTemplateLiteral(["very pointy crown"])))),
    do: () => fightPiece($monster(_templateObject254 || (_templateObject254 = levelling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().macro(Macro.attack().repeat()),
    outfit: {
    ...
    do: $location(_templateObject256 || (_templateObject256 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      weapon: have(template_string_$item(_templateObject257 || (_templateObject257 = levelling_taggedTemplateLiteral(["fish hatchet"])))) ? template_string_$item(_templateObject258 || (_templateObject258 = levelling_taggedTemplateLiteral(["fish hatchet"]))) : template_string_$item(_templateObject259 || (_templateObject259 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      acc2: template_string_$item(_templateObject260 || (_templateObject260 = levelling_taggedTemplateLiteral(["Cincho de Mayo"]))),
      famequip: template_string_$item(_templateObject261 || (_templateObject261 = levelling_taggedTemplateLiteral(["tiny stillsuit"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject262 || (_templateObject262 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject263 || (_templateObject263 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject264 || (_templateObject264 = levelling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject265 || (_templateObject265 = levelling_taggedTemplateLiteral(["Cincho: Confetti Extravaganza"])))).trySkill(template_string_$skill(_templateObject266 || (_templateObject266 = levelling_taggedTemplateLiteral(["Shattering Punch"])))).abort())
  }, {
    name: "Chest X-rays",
    completed: () => property_get("_chestXRayUsed") >= 3,
    do: $location(_templateObject267 || (_templateObject267 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      famequip: template_string_$item(_templateObject268 || (_templateObject268 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      acc2: template_string_$item(_templateObject269 || (_templateObject269 = levelling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject270 || (_templateObject270 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject271 || (_templateObject271 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject272 || (_templateObject272 = levelling_taggedTemplateLiteral(["Chest X-Ray"])))).abort())
  }, {
    name: "Mob-Hit",
    completed: () => property_get("_gingerbreadMobHitUsed"),
    do: $location(_templateObject273 || (_templateObject273 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().macro(Macro.trySkill(template_string_$skill(_templateObject274 || (_templateObject274 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject275 || (_templateObject275 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject276 || (_templateObject276 = levelling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort())
  }]
};
;// CONCATENATED MODULE: ./src/tasks/stats.ts
var stats_templateObject, stats_templateObject2, stats_templateObject3, stats_templateObject4, stats_templateObject5, stats_templateObject6, stats_templateObject7, stats_templateObject8, stats_templateObject9, stats_templateObject10, stats_templateObject11, stats_templateObject12, stats_templateObject13, stats_templateObject14, stats_templateObject15, stats_templateObject16, stats_templateObject17, stats_templateObject18, stats_templateObject19, stats_templateObject20, stats_templateObject21, stats_templateObject22, stats_templateObject23, stats_templateObject24, stats_templateObject25, stats_templateObject26, stats_templateObject27, stats_templateObject28, stats_templateObject29, stats_templateObject30, stats_templateObject31, stats_templateObject32, stats_templateObject33, stats_templateObject34, stats_templateObject35, stats_templateObject36, stats_templateObject37, stats_templateObject38;
...
var hpQuest = {
  ...
  tasks: [{
    ...
    effects: [$effect(stats_templateObject30 || (stats_templateObject30 = stats_taggedTemplateLiteral(["Big"]))), $effect(stats_templateObject31 || (stats_templateObject31 = stats_taggedTemplateLiteral(["Go Get 'Em, Tiger!"]))), $effect(stats_templateObject32 || (stats_templateObject32 = stats_taggedTemplateLiteral(["Reptilian Fortitude"]))), $effect(stats_templateObject33 || (stats_templateObject33 = stats_taggedTemplateLiteral(["Quiet Determination"]))), $effect(stats_templateObject34 || (stats_templateObject34 = stats_taggedTemplateLiteral(["Song of Bravado"]))), $effect(stats_templateObject35 || (stats_templateObject35 = stats_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(stats_templateObject36 || (stats_templateObject36 = stats_taggedTemplateLiteral(["Saucemastery"]))), $effect(stats_templateObject37 || (stats_templateObject37 = stats_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), $effect(stats_templateObject38 || (stats_templateObject38 = stats_taggedTemplateLiteral(["Patience of the Tortoise"])))],
    limit: {
      tries: 1
    }
  }]
...
var famwtQuest = {
  ...
  tasks: [{
    ...
    name: "Hatter Buff",
    completed: () => !have(template_string_$item(famwt_templateObject9 || (famwt_templateObject9 = famwt_taggedTemplateLiteral(["\"DRINK ME\" potion"])))) || have($effect(famwt_templateObject10 || (famwt_templateObject10 = famwt_taggedTemplateLiteral(["You Can Really Taste the Dormouse"])))) || !have(template_string_$item(famwt_templateObject11 || (famwt_templateObject11 = famwt_taggedTemplateLiteral(["sombrero-mounted sparkler"])))),
...
var noncombatQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      offhand: template_string_$item(noncombat_templateObject10 || (noncombat_templateObject10 = noncombat_taggedTemplateLiteral(["unbreakable umbrella"]))),
