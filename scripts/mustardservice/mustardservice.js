...
function equipOutfit(outfit) {
  //Fam
  (0,external_kolmafia_namespaceObject.useFamiliar)(outfit[1]); //Equips
...
function coldConsult() {
  if ((0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(_templateObject80 || (_templateObject80 = lib_taggedTemplateLiteral(["cold medicine cabinet"]))) && property_get("_coldMedicineConsults") <= 5 && (0,external_kolmafia_namespaceObject.totalTurnsPlayed)() >= property_get("_nextColdMedicineConsult")) {
    if ((0,external_kolmafia_namespaceObject.visitUrl)("campground.php?action=workshed", false, true).includes("Extrovermectin&trade;") || (0,external_kolmafia_namespaceObject.visitUrl)("campground.php?action=workshed", false, true).includes("Breathitin")) {
      (0,external_kolmafia_namespaceObject.visitUrl)("campground.php?action=workshed");
...
function deepDarkVisions() {
  ...
  var _iterator = mustard_service_createForOfIteratorHelper($effects(mustard_service_templateObject18 || (mustard_service_templateObject18 = mustard_service_taggedTemplateLiteral(["Astral Shell, Elemental Saucesphere"])))),
      _step;
  ...
  (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(mustard_service_templateObject17 || (mustard_service_templateObject17 = mustard_service_taggedTemplateLiteral(["Deep Dark Visions"]))));
  equipOutfit(outfit);
}
function motherSlime() {
  var curFam = (0,external_kolmafia_namespaceObject.myFamiliar)();
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(mustard_service_templateObject19 || (mustard_service_templateObject19 = mustard_service_taggedTemplateLiteral(["Machine Elf"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject20 || (mustard_service_templateObject20 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(mustard_service_templateObject21 || (mustard_service_templateObject21 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));
  ...
  (0,external_kolmafia_namespaceObject.adv1)($location(mustard_service_templateObject22 || (mustard_service_templateObject22 = mustard_service_taggedTemplateLiteral(["The Slime Tube"]))), -1, "skill snokebomb; abort;");
  (0,external_kolmafia_namespaceObject.setCcs)("default");
  (0,external_kolmafia_namespaceObject.useFamiliar)(curFam);
}
function pilsners() {
  if ((0,external_kolmafia_namespaceObject.myLevel)() >= 11 && (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(mustard_service_templateObject23 || (mustard_service_templateObject23 = mustard_service_taggedTemplateLiteral(["astral pilsner"])))) === 6) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(mustard_service_templateObject24 || (mustard_service_templateObject24 = mustard_service_taggedTemplateLiteral(["The Ode to Booze"]))));
    (0,external_kolmafia_namespaceObject.drink)(4, template_string_$item(mustard_service_templateObject25 || (mustard_service_templateObject25 = mustard_service_taggedTemplateLiteral(["astral pilsner"]))));
  }
}
var famRoute = template_string_$familiar(mustard_service_templateObject26 || (mustard_service_templateObject26 = mustard_service_taggedTemplateLiteral(["Melodramedary"])));
var drinkSockdollager = false;
var floundryItem = template_string_$item(mustard_service_templateObject27 || (mustard_service_templateObject27 = mustard_service_taggedTemplateLiteral(["fish hatchet"])));
var yachtzeeChaining = false;
var scalerZone = $location(mustard_service_templateObject28 || (mustard_service_templateObject28 = mustard_service_taggedTemplateLiteral(["The Neverending Party"])));
function preRun() {
  (0,external_kolmafia_namespaceObject.print)("Pre Run: Pulling");
  (0,external_kolmafia_namespaceObject.setAutoAttack)(0);
  var pulls = [template_string_$item(mustard_service_templateObject29 || (mustard_service_templateObject29 = mustard_service_taggedTemplateLiteral(["Calzone of Legend"]))), template_string_$item(mustard_service_templateObject30 || (mustard_service_templateObject30 = mustard_service_taggedTemplateLiteral(["Pizza of Legend"]))), //$item`Deep Dish of Legend`,
  template_string_$item(mustard_service_templateObject31 || (mustard_service_templateObject31 = mustard_service_taggedTemplateLiteral(["wasabi marble soda"]))), //$item`abstraction: purpose`,
  template_string_$item(mustard_service_templateObject32 || (mustard_service_templateObject32 = mustard_service_taggedTemplateLiteral(["Stick-Knife of Loathing"]))), template_string_$item(mustard_service_templateObject33 || (mustard_service_templateObject33 = mustard_service_taggedTemplateLiteral(["tobiko marble soda"]))) //$item`red eye`,
...
function setup() {
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject34 || (mustard_service_templateObject34 = mustard_service_taggedTemplateLiteral(["pants"]))), template_string_$item(mustard_service_templateObject35 || (mustard_service_templateObject35 = mustard_service_taggedTemplateLiteral(["designer sweatpants"]))));
  (0,external_kolmafia_namespaceObject.cliExecute)("numberology 69"); //useSkill(1, $skill`Spirit of Garlic`);

  if (have(template_string_$item(mustard_service_templateObject36 || (mustard_service_templateObject36 = mustard_service_taggedTemplateLiteral(["astral six-pack"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject37 || (mustard_service_templateObject37 = mustard_service_taggedTemplateLiteral(["astral six-pack"]))));
  }

  if (!have(floundryItem)) {
    Clan.join("Floundry");
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, floundryItem); //use(1, $item`codpiece`);
  ...
  if (!have(template_string_$skill(mustard_service_templateObject38 || (mustard_service_templateObject38 = mustard_service_taggedTemplateLiteral(["Insectologist"]))))) {
  ...
  if (!have(template_string_$item(mustard_service_templateObject39 || (mustard_service_templateObject39 = mustard_service_taggedTemplateLiteral(["your cowboy boots"]))))) {
  ...
  if (have(template_string_$item(mustard_service_templateObject40 || (mustard_service_templateObject40 = mustard_service_taggedTemplateLiteral(["letter from King Ralph XI"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject41 || (mustard_service_templateObject41 = mustard_service_taggedTemplateLiteral(["letter from King Ralph XI"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject42 || (mustard_service_templateObject42 = mustard_service_taggedTemplateLiteral(["pork elf goodies sack"]))));

    var _iterator2 = mustard_service_createForOfIteratorHelper(template_string_$items(mustard_service_templateObject46 || (mustard_service_templateObject46 = mustard_service_taggedTemplateLiteral(["baconstone, hamethyst"])))),
        _step2;
    ...
    if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(mustard_service_templateObject43 || (mustard_service_templateObject43 = mustard_service_taggedTemplateLiteral(["porquoise"])))) > 2) {
      (0,external_kolmafia_namespaceObject.autosell)((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(mustard_service_templateObject44 || (mustard_service_templateObject44 = mustard_service_taggedTemplateLiteral(["porquoise"])))) - 2, template_string_$item(mustard_service_templateObject45 || (mustard_service_templateObject45 = mustard_service_taggedTemplateLiteral(["porquoise"]))));
    }
  }

  var _iterator3 = mustard_service_createForOfIteratorHelper(template_string_$items(mustard_service_templateObject72 || (mustard_service_templateObject72 = mustard_service_taggedTemplateLiteral(["toy accordion, turtle totem, saucepan"])))),
      _step3;
  ...
  if (!have(template_string_$item(mustard_service_templateObject47 || (mustard_service_templateObject47 = mustard_service_taggedTemplateLiteral(["borrowed time"])))) && property_get("_borrowedTimeUsed") === false) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(2, template_string_$item(mustard_service_templateObject48 || (mustard_service_templateObject48 = mustard_service_taggedTemplateLiteral(["borrowed time"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject49 || (mustard_service_templateObject49 = mustard_service_taggedTemplateLiteral(["borrowed time"]))));
  }

  if (!have(template_string_$item(mustard_service_templateObject50 || (mustard_service_templateObject50 = mustard_service_taggedTemplateLiteral(["box of Familiar Jacks"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(mustard_service_templateObject51 || (mustard_service_templateObject51 = mustard_service_taggedTemplateLiteral(["box of Familiar Jacks"]))));
  }

  (0,external_kolmafia_namespaceObject.useFamiliar)(famRoute);
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject52 || (mustard_service_templateObject52 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(mustard_service_templateObject53 || (mustard_service_templateObject53 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));

  if (property_get("_mummeryUses") === "") {
    (0,external_kolmafia_namespaceObject.setProperty)("choiceAdventure1271", "3");
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject54 || (mustard_service_templateObject54 = mustard_service_taggedTemplateLiteral(["mumming trunk"]))));
  }
  ...
  if (property_get("_spinmasterLatheVisited") === false) {
    ...
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(mustard_service_templateObject55 || (mustard_service_templateObject55 = mustard_service_taggedTemplateLiteral(["ebony epee"]))));
  }
  ...
  if (available()) {
    sendTo($location(mustard_service_templateObject56 || (mustard_service_templateObject56 = mustard_service_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
  }

  if (property_get("trainsetConfiguration") === "") {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject57 || (mustard_service_templateObject57 = mustard_service_taggedTemplateLiteral(["model train set"]))));
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject58 || (mustard_service_templateObject58 = mustard_service_taggedTemplateLiteral(["hat"]))), template_string_$item(mustard_service_templateObject59 || (mustard_service_templateObject59 = mustard_service_taggedTemplateLiteral(["wad of used tape"]))));
  (0,external_kolmafia_namespaceObject.cliExecute)("parka kachungasaur");
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject60 || (mustard_service_templateObject60 = mustard_service_taggedTemplateLiteral(["shirt"]))), template_string_$item(mustard_service_templateObject61 || (mustard_service_templateObject61 = mustard_service_taggedTemplateLiteral(["Jurassic Parka"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject62 || (mustard_service_templateObject62 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(mustard_service_templateObject63 || (mustard_service_templateObject63 = mustard_service_taggedTemplateLiteral(["June cleaver"]))));
  (0,external_kolmafia_namespaceObject.cliExecute)("umbrella dr");
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject64 || (mustard_service_templateObject64 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(mustard_service_templateObject65 || (mustard_service_templateObject65 = mustard_service_taggedTemplateLiteral(["unbreakable umbrella"]))));
  (0,external_kolmafia_namespaceObject.cliExecute)("backupcamera init");
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject66 || (mustard_service_templateObject66 = mustard_service_taggedTemplateLiteral(["acc1"]))), template_string_$item(mustard_service_templateObject67 || (mustard_service_templateObject67 = mustard_service_taggedTemplateLiteral(["backup camera"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject68 || (mustard_service_templateObject68 = mustard_service_taggedTemplateLiteral(["acc2"]))), template_string_$item(mustard_service_templateObject69 || (mustard_service_templateObject69 = mustard_service_taggedTemplateLiteral(["your cowboy boots"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(mustard_service_templateObject70 || (mustard_service_templateObject70 = mustard_service_taggedTemplateLiteral(["acc3"]))), template_string_$item(mustard_service_templateObject71 || (mustard_service_templateObject71 = mustard_service_taggedTemplateLiteral(["combat lover's locket"]))));
  /*
...
function skeletons() {
  ...
  if ((0,external_kolmafia_namespaceObject.getProperty)("_mustardServiceDiner") === "false") {
    (0,external_kolmafia_namespaceObject.adv1)($location(mustard_service_templateObject73 || (mustard_service_templateObject73 = mustard_service_taggedTemplateLiteral(["Sloppy Seconds Diner"]))), -1, "abort;");
    (0,external_kolmafia_namespaceObject.adv1)($location(mustard_service_templateObject74 || (mustard_service_templateObject74 = mustard_service_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1, "abort;");
    (0,external_kolmafia_namespaceObject.adv1)($location(mustard_service_templateObject75 || (mustard_service_templateObject75 = mustard_service_taggedTemplateLiteral(["Barf Mountain"]))), -1, "abort;");
  ...
  if (have($effect(mustard_service_templateObject76 || (mustard_service_templateObject76 = mustard_service_taggedTemplateLiteral(["Beaten Up"])))) && !have(template_string_$item(mustard_service_templateObject77 || (mustard_service_templateObject77 = mustard_service_taggedTemplateLiteral(["magical sausage casing"]))))) {
    (0,external_kolmafia_namespaceObject.abort)("Died during first sosig?");
  }

  if (!have(template_string_$item(mustard_service_templateObject78 || (mustard_service_templateObject78 = mustard_service_taggedTemplateLiteral(["red rocket"])))) && !have($effect(mustard_service_templateObject79 || (mustard_service_templateObject79 = mustard_service_taggedTemplateLiteral(["Everything Looks Red"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(mustard_service_templateObject80 || (mustard_service_templateObject80 = mustard_service_taggedTemplateLiteral(["red rocket"]))));
  }

  if (!have($effect(mustard_service_templateObject81 || (mustard_service_templateObject81 = mustard_service_taggedTemplateLiteral(["Everything Looks Yellow"]))))) {
    (0,external_kolmafia_namespaceObject.writeCcs)("[default]\nskill feel hatred\nabort", "mustardservice");
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    reminisce($monster(mustard_service_templateObject82 || (mustard_service_templateObject82 = mustard_service_taggedTemplateLiteral(["red skeleton"]))));
    (0,external_kolmafia_namespaceObject.setCcs)("default");
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    mapMonster($location(mustard_service_templateObject83 || (mustard_service_templateObject83 = mustard_service_taggedTemplateLiteral(["The Skeleton Store"]))), $monster(mustard_service_templateObject84 || (mustard_service_templateObject84 = mustard_service_taggedTemplateLiteral(["novelty tropical skeleton"]))));
    (0,external_kolmafia_namespaceObject.setCcs)("default");
  }

  if (!have($effect(mustard_service_templateObject85 || (mustard_service_templateObject85 = mustard_service_taggedTemplateLiteral(["Everything Looks Yellow"])))) && have($effect(mustard_service_templateObject86 || (mustard_service_templateObject86 = mustard_service_taggedTemplateLiteral(["Beaten Up"]))))) {
    (0,external_kolmafia_namespaceObject.abort)("Failed to YR skeletong");
  }

  if (have(template_string_$item(mustard_service_templateObject87 || (mustard_service_templateObject87 = mustard_service_taggedTemplateLiteral(["red box"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(mustard_service_templateObject88 || (mustard_service_templateObject88 = mustard_service_taggedTemplateLiteral(["red box"]))));
  }

  (0,external_kolmafia_namespaceObject.cliExecute)("parka spikolodon");

  if (have(template_string_$item(mustard_service_templateObject89 || (mustard_service_templateObject89 = mustard_service_taggedTemplateLiteral(["MayDay\u2122 supply package"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject90 || (_templateObject90 = mustard_service_taggedTemplateLiteral(["MayDay\u2122 supply package"]))));
    (0,external_kolmafia_namespaceObject.autosell)(1, template_string_$item(_templateObject91 || (_templateObject91 = mustard_service_taggedTemplateLiteral(["space blanket"]))));
  }

  if (!have(template_string_$item(_templateObject92 || (_templateObject92 = mustard_service_taggedTemplateLiteral(["Catherine Wheel"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject93 || (_templateObject93 = mustard_service_taggedTemplateLiteral(["Catherine Wheel"]))));
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject94 || (_templateObject94 = mustard_service_taggedTemplateLiteral(["Catherine Wheel"]))));
  }

  if (have(template_string_$item(_templateObject95 || (_templateObject95 = mustard_service_taggedTemplateLiteral(["magical sausage casing"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject96 || (_templateObject96 = mustard_service_taggedTemplateLiteral(["magical sausage"]))));
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject97 || (_templateObject97 = mustard_service_taggedTemplateLiteral(["magical sausage"]))));
  }

  if (property_get("questG09Muscle") !== "finished") {
    var effs = [$effect(_templateObject98 || (_templateObject98 = mustard_service_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effect(_templateObject99 || (_templateObject99 = mustard_service_taggedTemplateLiteral(["Musk of the Moose"]))), $effect(_templateObject100 || (_templateObject100 = mustard_service_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))), $effect(_templateObject101 || (_templateObject101 = mustard_service_taggedTemplateLiteral(["Pride of the Puffin"]))), $effect(_templateObject102 || (_templateObject102 = mustard_service_taggedTemplateLiteral(["Carol of the Thrills"]))), $effect(_templateObject103 || (_templateObject103 = mustard_service_taggedTemplateLiteral(["Empathy"]))), $effect(_templateObject104 || (_templateObject104 = mustard_service_taggedTemplateLiteral(["Leash of Linguini"]))), $effect(_templateObject105 || (_templateObject105 = mustard_service_taggedTemplateLiteral(["Drescher's Annoying Noise"])))];

    for (var _i2 = 0, _effs = effs; _i2 < _effs.length; _i2++) {
      var effect = _effs[_i2];

      if (!have(effect)) {
        (0,external_kolmafia_namespaceObject.useSkill)(1, (0,external_kolmafia_namespaceObject.toSkill)(effect));
      }
    }

    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject106 || (_templateObject106 = mustard_service_taggedTemplateLiteral(["Pair of Stomping Boots"]))));
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject107 || (_templateObject107 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject108 || (_templateObject108 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));
    ...
    while ((0,external_kolmafia_namespaceObject.getProperty)("questG09Muscle") !== "step1" && (0,external_kolmafia_namespaceObject.getProperty)("questG09Muscle") !== "finished") {
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject109 || (_templateObject109 = mustard_service_taggedTemplateLiteral(["The Outskirts of Cobb's Knob"]))), -1, "runaway; abort;");
    }

    if (have($effect(_templateObject110 || (_templateObject110 = mustard_service_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))))) {
      uneffect($effect(_templateObject111 || (_templateObject111 = mustard_service_taggedTemplateLiteral(["Carlweather's Cantata of Confrontation"]))));
    }
    ...
    (0,external_kolmafia_namespaceObject.visitUrl)("guild.php?place=scg");
    (0,external_kolmafia_namespaceObject.useFamiliar)(famRoute);
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject112 || (_templateObject112 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject113 || (_templateObject113 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));
  }
  ...
  if ((0,external_kolmafia_namespaceObject.myAdventures)() < 61 && !have(template_string_$item(_templateObject114 || (_templateObject114 = mustard_service_taggedTemplateLiteral(["distilled fortified wine"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject115 || (_templateObject115 = mustard_service_taggedTemplateLiteral(["11-leaf clover"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject116 || (_templateObject116 = mustard_service_taggedTemplateLiteral(["11-leaf clover"]))));
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject117 || (_templateObject117 = mustard_service_taggedTemplateLiteral(["The Sleazy Back Alley"]))));
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject118 || (_templateObject118 = mustard_service_taggedTemplateLiteral(["The Ode to Booze"]))));
    (0,external_kolmafia_namespaceObject.drink)(1, template_string_$item(_templateObject119 || (_templateObject119 = mustard_service_taggedTemplateLiteral(["distilled fortified wine"]))));
    uneffect($effect(_templateObject120 || (_templateObject120 = mustard_service_taggedTemplateLiteral(["Ode to Booze"]))));
  }
...
function levellingPrep() {
  ...
  if (!have($effect(_templateObject121 || (_templateObject121 = mustard_service_taggedTemplateLiteral(["HGH-charged"]))))) {//cliExecute(`genie effect HGH-charged`);
    //CursedMonkeyPaw.wishFor($effect`HGH-charged`);
  }

  if ((0,external_kolmafia_namespaceObject.mySpleenUse)() === 0 && have(template_string_$item(_templateObject122 || (_templateObject122 = mustard_service_taggedTemplateLiteral(["abstraction: purpose"]))))) {
    (0,external_kolmafia_namespaceObject.chew)(1, template_string_$item(_templateObject123 || (_templateObject123 = mustard_service_taggedTemplateLiteral(["abstraction: purpose"]))));
  }
  ...
  if (have(template_string_$item(_templateObject124 || (_templateObject124 = mustard_service_taggedTemplateLiteral(["a ten-percent bonus"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject125 || (_templateObject125 = mustard_service_taggedTemplateLiteral(["a ten-percent bonus"]))));
  }
  ...
  if (property_get("calzoneOfLegendEaten") === false) {
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject126 || (_templateObject126 = mustard_service_taggedTemplateLiteral(["Calzone of Legend"]))));
  }

  if (property_get("deepDishOfLegendEaten") === false && have(template_string_$item(_templateObject127 || (_templateObject127 = mustard_service_taggedTemplateLiteral(["Deep Dish of Legend"]))))) {
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject128 || (_templateObject128 = mustard_service_taggedTemplateLiteral(["Deep Dish of Legend"]))));
  }
  ...
  if (!have($effect(_templateObject129 || (_templateObject129 = mustard_service_taggedTemplateLiteral(["New and Improved"]))))) {
  ...
  if (have(template_string_$item(_templateObject130 || (_templateObject130 = mustard_service_taggedTemplateLiteral(["wasabi marble soda"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject131 || (_templateObject131 = mustard_service_taggedTemplateLiteral(["wasabi marble soda"]))));
  }

  if (!have($effect(_templateObject132 || (_templateObject132 = mustard_service_taggedTemplateLiteral(["A Contender"])))) && famRoute === template_string_$familiar(_templateObject133 || (_templateObject133 = mustard_service_taggedTemplateLiteral(["Melodramedary"])))) {
    //CursedMonkeyPaw.wishFor($effect`A Contender`);
    (0,external_kolmafia_namespaceObject.cliExecute)("genie effect A Contender");
  }

  var _iterator4 = mustard_service_createForOfIteratorHelper(template_string_$items(_templateObject198 || (_templateObject198 = mustard_service_taggedTemplateLiteral(["Ben-Gal\u2122 Balm, hair spray, glittery mascara"])))),
      _step4;
  ...
  if (property_get("reagentSummons") === 0) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject134 || (_templateObject134 = mustard_service_taggedTemplateLiteral(["Advanced Saucecrafting"]))));
  }

  if (property_get("_preventScurvy") === false) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject135 || (_templateObject135 = mustard_service_taggedTemplateLiteral(["Prevent Scurvy and Sobriety"]))));
  }

  if (!have($effect(_templateObject136 || (_templateObject136 = mustard_service_taggedTemplateLiteral(["Phorcefullness"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject137 || (_templateObject137 = mustard_service_taggedTemplateLiteral(["philter of phorce"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject138 || (_templateObject138 = mustard_service_taggedTemplateLiteral(["philter of phorce"]))));
  }

  if (!have($effect(_templateObject139 || (_templateObject139 = mustard_service_taggedTemplateLiteral(["Stabilizing Oiliness"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject140 || (_templateObject140 = mustard_service_taggedTemplateLiteral(["oil of stability"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject141 || (_templateObject141 = mustard_service_taggedTemplateLiteral(["oil of stability"]))));
  }

  if (!have($effect(_templateObject142 || (_templateObject142 = mustard_service_taggedTemplateLiteral(["Mystically Oiled"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject143 || (_templateObject143 = mustard_service_taggedTemplateLiteral(["ointment of the occult"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject144 || (_templateObject144 = mustard_service_taggedTemplateLiteral(["ointment of the occult"]))));
  }

  (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject145 || (_templateObject145 = mustard_service_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))));

  if (have($effect(_templateObject146 || (_templateObject146 = mustard_service_taggedTemplateLiteral(["Everything Looks Red"]))))) {
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject147 || (_templateObject147 = mustard_service_taggedTemplateLiteral(["Pizza of Legend"]))));
  }

  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject148 || (_templateObject148 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject149 || (_templateObject149 = mustard_service_taggedTemplateLiteral(["latte lovers member's mug"]))));
  ...
  if (property_get("_latteDrinkUsed") === false && property_get("_latteRefillsUsed") === 0) {
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject150 || (_templateObject150 = mustard_service_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1); //gulp, rockets, run
  ...
  if (property_get("_latteDrinkUsed") === false && property_get("_latteRefillsUsed") === 1) {
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject151 || (_templateObject151 = mustard_service_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1); //gulp, rockets, run

    (0,external_kolmafia_namespaceObject.setCcs)("default");
    fill("pumpkin", "cinnamon", "vanilla");
  }

  if (have($effect(_templateObject152 || (_templateObject152 = mustard_service_taggedTemplateLiteral(["Everything Looks Red"]))))) {
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject153 || (_templateObject153 = mustard_service_taggedTemplateLiteral(["Pizza of Legend"]))));
  } else {
    (0,external_kolmafia_namespaceObject.abort)("rocket fight: wrongy");
  }

  if (!have($effect(_templateObject154 || (_templateObject154 = mustard_service_taggedTemplateLiteral(["In a Lather"])))) && drinkSockdollager) {
    if (Clan.get().name !== "Bonus Adventures from Hell") {
      Clan.join("Bonus Adventures from Hell");
    }

    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject155 || (_templateObject155 = mustard_service_taggedTemplateLiteral(["The Ode to Booze"]))));
  ...
  var effects = [$effect(_templateObject156 || (_templateObject156 = mustard_service_taggedTemplateLiteral(["Bendin' Hell"]))), $effect(_templateObject157 || (_templateObject157 = mustard_service_taggedTemplateLiteral(["Song of the North"]))), $effect(_templateObject158 || (_templateObject158 = mustard_service_taggedTemplateLiteral(["Disco Fever"]))), $effect(_templateObject159 || (_templateObject159 = mustard_service_taggedTemplateLiteral(["Mariachi Mood"]))), $effect(_templateObject160 || (_templateObject160 = mustard_service_taggedTemplateLiteral(["Patience of the Tortoise"]))), $effect(_templateObject161 || (_templateObject161 = mustard_service_taggedTemplateLiteral(["Rage of the Reindeer"]))), $effect(_templateObject162 || (_templateObject162 = mustard_service_taggedTemplateLiteral(["Seal Clubbing Frenzy"]))), $effect(_templateObject163 || (_templateObject163 = mustard_service_taggedTemplateLiteral(["Saucemastery"]))), $effect(_templateObject164 || (_templateObject164 = mustard_service_taggedTemplateLiteral(["Stevedave's Shanty of Superiority"]))), $effect(_templateObject165 || (_templateObject165 = mustard_service_taggedTemplateLiteral(["Song of Bravado"]))), $effect(_templateObject166 || (_templateObject166 = mustard_service_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(_templateObject167 || (_templateObject167 = mustard_service_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(_templateObject168 || (_templateObject168 = mustard_service_taggedTemplateLiteral(["Carol of the Thrills"]))), $effect(_templateObject169 || (_templateObject169 = mustard_service_taggedTemplateLiteral(["Pride of the Puffin"]))), $effect(_templateObject170 || (_templateObject170 = mustard_service_taggedTemplateLiteral(["Ur-Kel's Aria of Annoyance"]))), $effect(_templateObject171 || (_templateObject171 = mustard_service_taggedTemplateLiteral(["Drescher's Annoying Noise"]))), $effect(_templateObject172 || (_templateObject172 = mustard_service_taggedTemplateLiteral(["The Magical Mojomuscular Melody"]))), $effect(_templateObject173 || (_templateObject173 = mustard_service_taggedTemplateLiteral(["Quiet Determination"]))), $effect(_templateObject174 || (_templateObject174 = mustard_service_taggedTemplateLiteral(["Big"]))), $effect(_templateObject175 || (_templateObject175 = mustard_service_taggedTemplateLiteral(["Empathy"]))), $effect(_templateObject176 || (_templateObject176 = mustard_service_taggedTemplateLiteral(["Leash of Linguini"]))), $effect(_templateObject177 || (_templateObject177 = mustard_service_taggedTemplateLiteral(["Blood Bond"]))), $effect(_templateObject178 || (_templateObject178 = mustard_service_taggedTemplateLiteral(["Feeling Excited"]))), $effect(_templateObject179 || (_templateObject179 = mustard_service_taggedTemplateLiteral(["Ghostly Shell"]))), $effect(_templateObject180 || (_templateObject180 = mustard_service_taggedTemplateLiteral(["Astral Shell"]))), $effect(_templateObject181 || (_templateObject181 = mustard_service_taggedTemplateLiteral(["Jalape\xF1o Saucesphere"]))), $effect(_templateObject182 || (_templateObject182 = mustard_service_taggedTemplateLiteral(["Elemental Saucesphere"]))), $effect(_templateObject183 || (_templateObject183 = mustard_service_taggedTemplateLiteral(["Scarysauce"]))), $effect(_templateObject184 || (_templateObject184 = mustard_service_taggedTemplateLiteral(["Feeling Peaceful"]))), $effect(_templateObject185 || (_templateObject185 = mustard_service_taggedTemplateLiteral(["Your Fifteen Minutes"]))), $effect(_templateObject186 || (_templateObject186 = mustard_service_taggedTemplateLiteral(["Frostbeard"]))), $effect(_templateObject187 || (_templateObject187 = mustard_service_taggedTemplateLiteral(["Takin' It Greasy"]))), $effect(_templateObject188 || (_templateObject188 = mustard_service_taggedTemplateLiteral(["Rotten Memories"]))), $effect(_templateObject189 || (_templateObject189 = mustard_service_taggedTemplateLiteral(["Pyromania"]))), $effect(_templateObject190 || (_templateObject190 = mustard_service_taggedTemplateLiteral(["Intimidating Mien"]))), $effect(_templateObject191 || (_templateObject191 = mustard_service_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject192 || (_templateObject192 = mustard_service_taggedTemplateLiteral(["Singer's Faithful Ocelot"])))];

  for (var _i3 = 0, _effects = effects; _i3 < _effects.length; _i3++) {
    var effect = _effects[_i3];
    ensureEffect(effect);
    /*
    if (!have(effect)) {
  ...
  if (!have($effect(_templateObject193 || (_templateObject193 = mustard_service_taggedTemplateLiteral(["Frostbeard"]))))) {
  ...
  if (!property_get("_latteDrinkUsed") && property_get("_latteRefillsUsed") === 2) {
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject194 || (_templateObject194 = mustard_service_taggedTemplateLiteral(["Uncle Gator's Country Fun-Time Liquid Waste Sluice"]))), -1, "skill 7303; skill 7301; abort;"); //gulp, run

    fill("pumpkin", "cinnamon", "vanilla");
  }

  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject195 || (_templateObject195 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject196 || (_templateObject196 = mustard_service_taggedTemplateLiteral(["unbreakable umbrella"]))));
  (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject197 || (_templateObject197 = mustard_service_taggedTemplateLiteral(["Blood Sugar Sauce Magic"]))));
  nextLevelling();
}
function riftConsult() {
  ...
  if (property_get("_fireExtinguisherCharge") > 10) {
    if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject199 || (_templateObject199 = mustard_service_taggedTemplateLiteral(["weapon"])))) !== template_string_$item(_templateObject200 || (_templateObject200 = mustard_service_taggedTemplateLiteral(["industrial fire extinguisher"])))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject201 || (_templateObject201 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject202 || (_templateObject202 = mustard_service_taggedTemplateLiteral(["industrial fire extinguisher"]))));
    }
    ...
    (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)());
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject203 || (_templateObject203 = mustard_service_taggedTemplateLiteral(["Jurassic Parka"]))));
    ...
    if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject204 || (_templateObject204 = mustard_service_taggedTemplateLiteral(["weapon"])))) !== template_string_$item(_templateObject205 || (_templateObject205 = mustard_service_taggedTemplateLiteral(["June cleaver"])))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject206 || (_templateObject206 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject207 || (_templateObject207 = mustard_service_taggedTemplateLiteral(["June cleaver"]))));
    }
...
function payphoneFights() {
  ...
  if (have(template_string_$item(_templateObject208 || (_templateObject208 = mustard_service_taggedTemplateLiteral(["porkpie-mounted popper"]))))) {
    (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject209 || (_templateObject209 = mustard_service_taggedTemplateLiteral(["porkpie-mounted popper"]))));
  }

  if (property_get("_shadowAffinityToday") === false) {
    (0,external_kolmafia_namespaceObject.setProperty)("choiceAdventure1497", "1");
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject210 || (_templateObject210 = mustard_service_taggedTemplateLiteral(["closed-circuit pay phone"]))));
    /*
  ...
  while (have($effect(_templateObject211 || (_templateObject211 = mustard_service_taggedTemplateLiteral(["Shadow Affinity"])))) && property_get("encountersUntilSRChoice") > 0) {
    preVenture();
    var riftStyle = riftConsult();
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject212 || (_templateObject212 = mustard_service_taggedTemplateLiteral(["Shadow Rift (The Misspelled Cemetary)"]))), -1, riftStyle);
  }

  if (property_get("questRufus") === "started" && property_get("encountersUntilSRChoice") === 0) {
    if ((0,external_kolmafia_namespaceObject.equippedItem)($slot(_templateObject213 || (_templateObject213 = mustard_service_taggedTemplateLiteral(["weapon"])))) !== template_string_$item(_templateObject214 || (_templateObject214 = mustard_service_taggedTemplateLiteral(["June cleaver"])))) {
      (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject215 || (_templateObject215 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject216 || (_templateObject216 = mustard_service_taggedTemplateLiteral(["June cleaver"]))));
    }

    preVenture();
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject217 || (_templateObject217 = mustard_service_taggedTemplateLiteral(["Machine Elf"]))));

    var _riftStyle3 = riftConsult();

    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject218 || (_templateObject218 = mustard_service_taggedTemplateLiteral(["Shadow Rift"]))), -1, _riftStyle3);
    (0,external_kolmafia_namespaceObject.useFamiliar)(famRoute);
  }

  if (property_get("questRufus") === "step1") {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject219 || (_templateObject219 = mustard_service_taggedTemplateLiteral(["closed-circuit pay phone"]))));
  }

  fallGuy();

  if (have($effect(_templateObject220 || (_templateObject220 = mustard_service_taggedTemplateLiteral(["Beaten Up"]))))) {
...
function snojoFights() {
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject221 || (_templateObject221 = mustard_service_taggedTemplateLiteral(["hat"]))), template_string_$item(_templateObject222 || (_templateObject222 = mustard_service_taggedTemplateLiteral(["porkpie-mounted popper"]))));
  (0,external_kolmafia_namespaceObject.cliExecute)("fold garbage shirt");
  (0,external_kolmafia_namespaceObject.equip)(template_string_$item(_templateObject223 || (_templateObject223 = mustard_service_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  var snojoMode = "attack; repeat;";

  while (property_get("_snojoFreeFights") < 10) {
    preVenture();
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject224 || (_templateObject224 = mustard_service_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, snojoMode);
  }
...
function oliverFights() {
  ...
  if (property_get("_monstersMapped") === 1) {
    preVenture();
    (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject225 || (_templateObject225 = mustard_service_taggedTemplateLiteral(["Nanorhino"]))));
    (0,external_kolmafia_namespaceObject.writeCcs)("[default]\nskill feel nostalgic\nskill feel envy\nskill lunging thrust-smack\nattack", "mustardservice");
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    mapMonster($location(_templateObject226 || (_templateObject226 = mustard_service_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), $monster(_templateObject227 || (_templateObject227 = mustard_service_taggedTemplateLiteral(["goblin flapper"]))));
    (0,external_kolmafia_namespaceObject.setCcs)("default");
    (0,external_kolmafia_namespaceObject.useFamiliar)(famRoute);
  }
  ...
  while (property_get("_speakeasyFreeFights") < 3) {
    preVenture();
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject228 || (_templateObject228 = mustard_service_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))), -1, barMode);
  }

  nextLevelling();
}
function sealFights() {
  var _iterator5 = mustard_service_createForOfIteratorHelper(template_string_$items(_templateObject236 || (_templateObject236 = mustard_service_taggedTemplateLiteral(["porkpie-mounted popper, seal-clubbing club"])))),
      _step5;
  ...
  while (property_get("_sealsSummoned") < 5) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject229 || (_templateObject229 = mustard_service_taggedTemplateLiteral(["figurine of an ancient seal"]))));
    (0,external_kolmafia_namespaceObject.retrieveItem)(3, template_string_$item(_templateObject230 || (_templateObject230 = mustard_service_taggedTemplateLiteral(["seal-blubber candle"]))));
    preVenture();
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject231 || (_templateObject231 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject232 || (_templateObject232 = mustard_service_taggedTemplateLiteral(["seal-clubbing club"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject233 || (_templateObject233 = mustard_service_taggedTemplateLiteral(["figurine of an ancient seal"]))));
  }

  (0,external_kolmafia_namespaceObject.setCcs)("default");
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject234 || (_templateObject234 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject235 || (_templateObject235 = mustard_service_taggedTemplateLiteral(["June cleaver"]))));
  nextLevelling();
}
function witchessFights() {
  (0,external_kolmafia_namespaceObject.setProperty)("_mustardServiceStage", "Levelling: Witchess");
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject237 || (_templateObject237 = mustard_service_taggedTemplateLiteral(["shirt"]))), template_string_$item(_templateObject238 || (_templateObject238 = mustard_service_taggedTemplateLiteral(["makeshift garbage shirt"]))));
  ...
  while (property_get("_witchessFights") < 4) {
    preVenture();
    fightPiece($monster(_templateObject239 || (_templateObject239 = mustard_service_taggedTemplateLiteral(["Witchess Bishop"]))));
  }
...
function backupFights() {
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject240 || (_templateObject240 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject241 || (_templateObject241 = mustard_service_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));

  if (property_get("_sausageFights") === 0) {
    preVenture();
    var sausageFights = "attack; repeat;";
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject242 || (_templateObject242 = mustard_service_taggedTemplateLiteral(["Barf Mountain"]))), -1, sausageFights);
  }
  ...
  if (property_get("_sausageFights") > 0) {
    ...
    while (property_get("_backUpUses") < 11) {
      preVenture();
      (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject243 || (_templateObject243 = mustard_service_taggedTemplateLiteral(["The Dire Warren"]))), -1, _backupFights);
    }
  }
...
function deepMachineFights() {
  ...
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject244 || (_templateObject244 = mustard_service_taggedTemplateLiteral(["Machine Elf"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject245 || (_templateObject245 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject246 || (_templateObject246 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));

  while (property_get("_machineTunnelsAdv") < 5) {
    preVenture();
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject247 || (_templateObject247 = mustard_service_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, deepFight);
  }
...
function freekillConsult() {
  ...
  if (property_get("_shatteringPunchUsed") < 3) {
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject250 || (_templateObject250 = mustard_service_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject251 || (_templateObject251 = mustard_service_taggedTemplateLiteral(["Cincho de Mayo"]))));
    ...
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject252 || (_templateObject252 = mustard_service_taggedTemplateLiteral(["acc3"]))), template_string_$item(_templateObject253 || (_templateObject253 = mustard_service_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"]))));
...
function freekillBonanza() {
  ...
  if (property_get("_witchessFights") === 4) {
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    preVenture();
    fightPiece($monster(_templateObject254 || (_templateObject254 = mustard_service_taggedTemplateLiteral(["Witchess Witch"]))));
    (0,external_kolmafia_namespaceObject.setCcs)("default");
  }

  var cookbatGoal = (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject255 || (_templateObject255 = mustard_service_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject256 || (_templateObject256 = mustard_service_taggedTemplateLiteral(["Yeast of Boris"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject257 || (_templateObject257 = mustard_service_taggedTemplateLiteral(["Vegetable of Jarlsberg"]))));
  var camelgoal = property_get("_gingerbreadMobHitUsed") && have($effect(_templateObject258 || (_templateObject258 = mustard_service_taggedTemplateLiteral(["Spit Upon"]))));
  ...
  while (cookbatGoal < 15 && !camelgoal) {
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("default");
    cookbatGoal = (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject259 || (_templateObject259 = mustard_service_taggedTemplateLiteral(["St. Sneaky Pete's Whey"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject260 || (_templateObject260 = mustard_service_taggedTemplateLiteral(["Yeast of Boris"])))) + (0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject261 || (_templateObject261 = mustard_service_taggedTemplateLiteral(["Vegetable of Jarlsberg"]))));
    camelgoal = property_get("_gingerbreadMobHitUsed") && have($effect(_templateObject262 || (_templateObject262 = mustard_service_taggedTemplateLiteral(["Spit Upon"]))));
  }

  if (famRoute === template_string_$familiar(_templateObject263 || (_templateObject263 = mustard_service_taggedTemplateLiteral(["Cookbookbat"])))) {
    /*
    ...
    */
    if (!have($effect(_templateObject264 || (_templateObject264 = mustard_service_taggedTemplateLiteral(["Inspired Chef"]))))) {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject265 || (_templateObject265 = mustard_service_taggedTemplateLiteral(["Boris's bread"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject266 || (_templateObject266 = mustard_service_taggedTemplateLiteral(["Boris's bread"]))));
    }

    if (!have($effect(_templateObject267 || (_templateObject267 = mustard_service_taggedTemplateLiteral(["Pretty Delicious"]))))) {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject268 || (_templateObject268 = mustard_service_taggedTemplateLiteral(["baked veggie ricotta casserole"]))));
      (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject269 || (_templateObject269 = mustard_service_taggedTemplateLiteral(["baked veggie ricotta casserole"]))));
    }
  }
...
function musTest() {
  ...
  if (!(0,external_kolmafia_namespaceObject.getProperty)("csServicesPerformed").includes("Feed The Children")) {
    ...
    if (!have($effect(_templateObject270 || (_templateObject270 = mustard_service_taggedTemplateLiteral(["Quiet Determination"]))))) {
      (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject271 || (_templateObject271 = mustard_service_taggedTemplateLiteral(["Quiet Determination"]))));
    }
...
function mysTest() {
  ...
  if (!(0,external_kolmafia_namespaceObject.getProperty)("csServicesPerformed").includes("Build Playground Mazes")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject272 || (_templateObject272 = mustard_service_taggedTemplateLiteral(["Quiet Judgement"]))));
...
function moxTest() {
  ...
  if (!(0,external_kolmafia_namespaceObject.getProperty)("csServicesPerformed").includes("Feed Conspirators")) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject273 || (_templateObject273 = mustard_service_taggedTemplateLiteral(["Quiet Desperation"]))));
...
function famwtTest() {
  ...
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject274 || (_templateObject274 = mustard_service_taggedTemplateLiteral(["Mini-Trainbot"]))));

  if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject275 || (_templateObject275 = mustard_service_taggedTemplateLiteral(["box of Familiar Jacks"])))) === 1) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject276 || (_templateObject276 = mustard_service_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject277 || (_templateObject277 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject278 || (_templateObject278 = mustard_service_taggedTemplateLiteral(["overloaded Yule battery"]))));
  }

  for (var _i4 = 0, _arr = ["Empathy", "Leash of Linguini", "Blood Bond"]; _i4 < _arr.length; _i4++) {
    var eff = _arr[_i4];
  ...
  if ((0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject279 || (_templateObject279 = mustard_service_taggedTemplateLiteral(["Billiards Belligerence"])))) === 0) {
...
function noncomTest() {
  ...
  if (!have($effect(_templateObject280 || (_templateObject280 = mustard_service_taggedTemplateLiteral(["Shadow Waters"]))))) {
    (0,external_kolmafia_namespaceObject.setProperty)("choiceAdventure1500", "2"); //shadow waters

    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject281 || (_templateObject281 = mustard_service_taggedTemplateLiteral(["Shadow Rift"]))), -1, "abort;");
  }

  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject282 || (_templateObject282 = mustard_service_taggedTemplateLiteral(["Disgeist"]))));
  ...
  for (var _i5 = 0, _arr2 = ["squeaky rose", "shady shades"]; _i5 < _arr2.length; _i5++) {
    var item = _arr2[_i5];
  ...
  if (!have($effect(_templateObject283 || (_templateObject283 = mustard_service_taggedTemplateLiteral(["Silent Running"]))))) {
    (0,external_kolmafia_namespaceObject.cliExecute)("swim noncombat");
  }

  for (var _i6 = 0, _arr3 = ["The Sonata of Sneakiness", "Smooth Movement", "Feel Lonely"]; _i6 < _arr3.length; _i6++) {
    var skill = _arr3[_i6];
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject284 || (_templateObject284 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject285 || (_templateObject285 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject286 || (_templateObject286 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject287 || (_templateObject287 = mustard_service_taggedTemplateLiteral(["unbreakable umbrella"]))));
...
function itemTest() {
  ...
  if ((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject288 || (_templateObject288 = mustard_service_taggedTemplateLiteral(["cyclops eyedrops"])))) < 1 && (0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject289 || (_templateObject289 = mustard_service_taggedTemplateLiteral(["One Very Clear Eye"])))) === 0) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject290 || (_templateObject290 = mustard_service_taggedTemplateLiteral(["11-leaf clover"]))));
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject291 || (_templateObject291 = mustard_service_taggedTemplateLiteral(["11-leaf clover"]))));
    (0,external_kolmafia_namespaceObject.adv1)($location(_templateObject292 || (_templateObject292 = mustard_service_taggedTemplateLiteral(["The Limerick Dungeon"]))), -1, "abort;");
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject293 || (_templateObject293 = mustard_service_taggedTemplateLiteral(["cyclops eyedrops"]))));
  }
  /*
  ...
  */
  ...
  if (!have($effect(_templateObject294 || (_templateObject294 = mustard_service_taggedTemplateLiteral(["Feeling Lost"]))))) {
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject295 || (_templateObject295 = mustard_service_taggedTemplateLiteral(["Feel Lost"]))));
  }
  ...
  if ((0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject296 || (_templateObject296 = mustard_service_taggedTemplateLiteral(["Infernal Thirst"])))) === 0) {
    wishFor($effect(_templateObject297 || (_templateObject297 = mustard_service_taggedTemplateLiteral(["Infernal Thirst"]))));
  }
  ...
  (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject298 || (_templateObject298 = mustard_service_taggedTemplateLiteral(["autumn leaf"]))));
  (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject299 || (_templateObject299 = mustard_service_taggedTemplateLiteral(["bag of grain"]))));

  for (var _i7 = 0, _arr4 = [$effect(_templateObject300 || (_templateObject300 = mustard_service_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject301 || (_templateObject301 = mustard_service_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), $effect(_templateObject302 || (_templateObject302 = mustard_service_taggedTemplateLiteral(["Steely-Eyed Squint"]))), $effect(_templateObject303 || (_templateObject303 = mustard_service_taggedTemplateLiteral(["Spice Haze"])))]; _i7 < _arr4.length; _i7++) {
    var eff = _arr4[_i7];
    ensureEffect(eff);
  }
...
function hotresTest() {
  ...
  (0,external_kolmafia_namespaceObject.useFamiliar)(template_string_$familiar(_templateObject304 || (_templateObject304 = mustard_service_taggedTemplateLiteral(["Exotic Parrot"]))));

  if (!have($effect(_templateObject305 || (_templateObject305 = mustard_service_taggedTemplateLiteral(["Fireproof Foam Suit"])))) && property_get("_fireExtinguisherCharge") > 0) {
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject306 || (_templateObject306 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject307 || (_templateObject307 = mustard_service_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject308 || (_templateObject308 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject309 || (_templateObject309 = mustard_service_taggedTemplateLiteral(["industrial fire extinguisher"]))));
    ...
    (0,external_kolmafia_namespaceObject.setCcs)("mustardservice");
    (0,external_kolmafia_namespaceObject.setProperty)("choiceAdventure1387", "3");
    reminisce($monster(_templateObject310 || (_templateObject310 = mustard_service_taggedTemplateLiteral(["ungulith"]))));
    (0,external_kolmafia_namespaceObject.setCcs)("default");

    if (!have($effect(_templateObject311 || (_templateObject311 = mustard_service_taggedTemplateLiteral(["Fireproof Foam Suit"]))))) {
  ...
  for (var _i8 = 0, _arr5 = ["Elemental Saucesphere", "Feel Peaceful", "Astral Shell", "Blood Bond", "Empathy of the Newt", "Leash of Linguini"]; _i8 < _arr5.length; _i8++) {
    var skill = _arr5[_i8];
  ...
  (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject312 || (_templateObject312 = mustard_service_taggedTemplateLiteral(["familiar"]))), template_string_$item(_templateObject313 || (_templateObject313 = mustard_service_taggedTemplateLiteral(["tiny stillsuit"]))));

  if ((0,external_kolmafia_namespaceObject.numericModifier)("hot resistance") < 59) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject314 || (_templateObject314 = mustard_service_taggedTemplateLiteral(["pocket maze"]))));
  }
...
function wdmgTest() {
  ...
  if ((0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject315 || (_templateObject315 = mustard_service_taggedTemplateLiteral(["Billiards Belligerence"])))) === 0) {
    if (Clan.get().name !== "Bonus Adventures from Hell") {
      Clan.join("Bonus Adventures from Hell");
    }
  ...
  while ((0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject316 || (_templateObject316 = mustard_service_taggedTemplateLiteral(["Inner Elf"])))) === 0 && (0,external_kolmafia_namespaceObject.getProperty)("_snokebombUsed") !== "3") {
    preVenture();
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject317 || (_templateObject317 = mustard_service_taggedTemplateLiteral(["weapon"]))), external_kolmafia_namespaceObject.Item.none);
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject318 || (_templateObject318 = mustard_service_taggedTemplateLiteral(["off-hand"]))), external_kolmafia_namespaceObject.Item.none);
    motherSlime();
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject319 || (_templateObject319 = mustard_service_taggedTemplateLiteral(["weapon"]))), template_string_$item(_templateObject320 || (_templateObject320 = mustard_service_taggedTemplateLiteral(["ebony epee"]))));
    (0,external_kolmafia_namespaceObject.equip)($slot(_templateObject321 || (_templateObject321 = mustard_service_taggedTemplateLiteral(["off-hand"]))), template_string_$item(_templateObject322 || (_templateObject322 = mustard_service_taggedTemplateLiteral(["Stick-Knife of Loathing"]))));
  }

  fallGuy();
  (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject323 || (_templateObject323 = mustard_service_taggedTemplateLiteral(["potion of potency"])))); //attempt deep dark visions of course :slightsmile: must be done before cowrruption, must last until spelltest

  deepDarkVisions();

  var _iterator6 = mustard_service_createForOfIteratorHelper(template_string_$items(_templateObject333 || (_templateObject333 = mustard_service_taggedTemplateLiteral(["Punching Potion, potion of potency, corrupted marrow, imported taffy, red eye"])))),
      _step6;
  ...
  if ((0,external_kolmafia_namespaceObject.haveEffect)($effect(_templateObject324 || (_templateObject324 = mustard_service_taggedTemplateLiteral(["Weapon of Mass Destruction"])))) === 0) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject325 || (_templateObject325 = mustard_service_taggedTemplateLiteral(["goofily-plumed helmet"]))));
    (0,external_kolmafia_namespaceObject.cliExecute)("hatter goofily-plumed helmet");
  }

  var effs = [$effect(_templateObject326 || (_templateObject326 = mustard_service_taggedTemplateLiteral(["Bow-Legged Swagger"]))), $effect(_templateObject327 || (_templateObject327 = mustard_service_taggedTemplateLiteral(["Scowl of the Auk"]))), $effect(_templateObject328 || (_templateObject328 = mustard_service_taggedTemplateLiteral(["Rage of the Reindeer"]))), $effect(_templateObject329 || (_templateObject329 = mustard_service_taggedTemplateLiteral(["Song of the North"]))), $effect(_templateObject330 || (_templateObject330 = mustard_service_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(_templateObject331 || (_templateObject331 = mustard_service_taggedTemplateLiteral(["Tenacity of the Snapper"]))), $effect(_templateObject332 || (_templateObject332 = mustard_service_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"])))];

  for (var _i9 = 0, _effs2 = effs; _i9 < _effs2.length; _i9++) {
    var e = _effs2[_i9];
    ensureEffect(e);
  }
...
function sdmgTest() {
  ...
  preVenture();
  var effs = [$effect(_templateObject334 || (_templateObject334 = mustard_service_taggedTemplateLiteral(["Simmering"]))), $effect(_templateObject335 || (_templateObject335 = mustard_service_taggedTemplateLiteral(["Song of Sauce"]))), $effect(_templateObject336 || (_templateObject336 = mustard_service_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(_templateObject337 || (_templateObject337 = mustard_service_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"])))];

  for (var _i10 = 0, _effs3 = effs; _i10 < _effs3.length; _i10++) {
    var e = _effs3[_i10];
    ensureEffect(e);
  }

  if (!have(template_string_$item(_templateObject338 || (_templateObject338 = mustard_service_taggedTemplateLiteral(["obsidian nutcracker"]))))) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject339 || (_templateObject339 = mustard_service_taggedTemplateLiteral(["obsidian nutcracker"]))));
  }

  if (have(template_string_$item(_templateObject340 || (_templateObject340 = mustard_service_taggedTemplateLiteral(["tobiko marble soda"]))))) {
    (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject341 || (_templateObject341 = mustard_service_taggedTemplateLiteral(["tobiko marble soda"]))));
  }

  while (!have($effect(_templateObject342 || (_templateObject342 = mustard_service_taggedTemplateLiteral(["Inner Elf"])))) && (0,external_kolmafia_namespaceObject.getProperty)("_snokebombUsed") !== "3") {
    preVenture();
    motherSlime();
  }

  if (!have($effect(_templateObject343 || (_templateObject343 = mustard_service_taggedTemplateLiteral(["Mental A-cue-ity"]))))) {
    if (Clan.get().name !== "Bonus Adventures from Hell") {
      Clan.join("Bonus Adventures from Hell");
    }
...
function finale() {
  ...
  if (have($effect(_templateObject344 || (_templateObject344 = mustard_service_taggedTemplateLiteral(["Feeling Lost"]))))) {
    uneffect($effect(_templateObject345 || (_templateObject345 = mustard_service_taggedTemplateLiteral(["Feeling Lost"]))));
  }

  if (yachtzeeChaining) {
    (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject346 || (_templateObject346 = mustard_service_taggedTemplateLiteral(["Deep Dish of Legend"]))));
    (0,external_kolmafia_namespaceObject.eat)(1, template_string_$item(_templateObject347 || (_templateObject347 = mustard_service_taggedTemplateLiteral(["Deep Dish of Legend"]))));
    (0,external_kolmafia_namespaceObject.useSkill)(1, template_string_$skill(_templateObject348 || (_templateObject348 = mustard_service_taggedTemplateLiteral(["The Ode to Booze"]))));
    (0,external_kolmafia_namespaceObject.drink)((0,external_kolmafia_namespaceObject.availableAmount)(template_string_$item(_templateObject349 || (_templateObject349 = mustard_service_taggedTemplateLiteral(["astral pilsner"])))), template_string_$item(_templateObject350 || (_templateObject350 = mustard_service_taggedTemplateLiteral(["astral pilsner"]))));
  }

  var mpSpendy = [$effect(_templateObject351 || (_templateObject351 = mustard_service_taggedTemplateLiteral(["Empathy"]))), $effect(_templateObject352 || (_templateObject352 = mustard_service_taggedTemplateLiteral(["Leash of Linguini"]))), $effect(_templateObject353 || (_templateObject353 = mustard_service_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), $effect(_templateObject354 || (_templateObject354 = mustard_service_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), $effect(_templateObject355 || (_templateObject355 = mustard_service_taggedTemplateLiteral(["Disco Leer"]))), $effect(_templateObject356 || (_templateObject356 = mustard_service_taggedTemplateLiteral(["Polka of Plenty"]))), $effect(_templateObject357 || (_templateObject357 = mustard_service_taggedTemplateLiteral(["Big"]))), $effect(_templateObject358 || (_templateObject358 = mustard_service_taggedTemplateLiteral(["Carol of the Bulls"]))), $effect(_templateObject359 || (_templateObject359 = mustard_service_taggedTemplateLiteral(["Carol of the Hells"]))), $effect(_templateObject360 || (_templateObject360 = mustard_service_taggedTemplateLiteral(["Carol of the Thrills"])))];

  for (var _i11 = 0, _mpSpendy = mpSpendy; _i11 < _mpSpendy.length; _i11++) {
    var eff = _mpSpendy[_i11];
