...
function maximizeCached(objectives) {
  ...
  var cacheKey = [objective].concat(maximize_toConsumableArray(untouchedSlots.map(slot => "".concat(slot, ":").concat((0,external_kolmafia_namespaceObject.equippedItem)(slot))).sort()), [have(template_string_$effect(_templateObject49 || (_templateObject49 = maximize_taggedTemplateLiteral(["Offhand Remarkable"]))))]).join("; ");
...
CommunityService_defineProperty(CommunityService, "FamiliarWeight", new _class(5, "Familiar Weight", "Breed More Collies", () => 60 - Math.floor((baseWeight() + (0,external_kolmafia_namespaceObject.weightAdjustment)()) / 5), new Requirement(["Familiar Weight"], {})));
CommunityService_defineProperty(CommunityService, "WeaponDamage", new _class(6, "Weapon Damage", "Reduce Gazelle Population", () => {
...
CommunityService_defineProperty(CommunityService, "SpellDamage", new _class(7, "Spell Damage", "Make Sausage", () => {
...
CommunityService_defineProperty(CommunityService, "Noncombat", new _class(8, "Non-Combat", "Be a Living Statue", () => {
...
CommunityService_defineProperty(CommunityService, "BoozeDrop", new _class(9, "Item Drop", "Make Margaritas", () => {
...
CommunityService_defineProperty(CommunityService, "HotRes", new _class(10, "Hot Resistance", "Clean Steam Tunnels", () => 60 - modifier_get("Hot Resistance"), new Requirement(["Hot Resistance"], {})));
...
CommunityService_defineProperty(CommunityService, "path", $path(CommunityService_templateObject28 || (CommunityService_templateObject28 = CommunityService_taggedTemplateLiteral(["Community Service"]))));
...
var boozeQuest = {
  ...
  tasks: [{
    ...
    completed: () => have(template_string_$effect(booze_templateObject4 || (booze_templateObject4 = booze_taggedTemplateLiteral(["One Very Clear Eye"])))) || have(template_string_$item(booze_templateObject5 || (booze_templateObject5 = booze_taggedTemplateLiteral(["cyclops eyedrops"])))),
    ...
    name: "Use Eyedrops",
    completed: () => have(template_string_$effect(booze_templateObject7 || (booze_templateObject7 = booze_taggedTemplateLiteral(["One Very Clear Eye"])))),
    ...
    name: "Feel Lost",
    completed: () => have(template_string_$effect(booze_templateObject9 || (booze_templateObject9 = booze_taggedTemplateLiteral(["Feeling Lost"])))) || property_get("_feelLostUsed") >= 1,
    ...
    completed: () => have(template_string_$effect(booze_templateObject11 || (booze_templateObject11 = booze_taggedTemplateLiteral(["Fortune of the Wheel"])))) || property_get("_deckCardsDrawn") > 0,
    do: () => cheatCard("X - The Wheel of Fortune")
  }, {
    name: "Infernal Thirst Wish",
    completed: () => property_get("_genieWishesUsed") >= 3 || have(template_string_$effect(booze_templateObject12 || (booze_templateObject12 = booze_taggedTemplateLiteral(["Infernal Thirst"])))),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("genie effect Infernal Thirst")
  }, {
    name: "Bag of Grain",
    completed: () => have(template_string_$effect(booze_templateObject13 || (booze_templateObject13 = booze_taggedTemplateLiteral(["Nearly All-Natural"])))) || !have(template_string_$item(booze_templateObject14 || (booze_templateObject14 = booze_taggedTemplateLiteral(["bag of grain"])))),
    ...
    name: "Autumn Leaf",
    completed: () => have(template_string_$effect(booze_templateObject16 || (booze_templateObject16 = booze_taggedTemplateLiteral(["Crunching Leaves"])))) || !have(template_string_$item(booze_templateObject17 || (booze_templateObject17 = booze_taggedTemplateLiteral(["autumn leaf"])))),
    ...
    effects: [template_string_$effect(booze_templateObject19 || (booze_templateObject19 = booze_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), template_string_$effect(booze_templateObject20 || (booze_templateObject20 = booze_taggedTemplateLiteral(["Singer's Faithful Ocelot"]))), template_string_$effect(booze_templateObject21 || (booze_templateObject21 = booze_taggedTemplateLiteral(["Steely-Eyed Squint"]))), template_string_$effect(booze_templateObject22 || (booze_templateObject22 = booze_taggedTemplateLiteral(["Spice Haze"])))],
    limit: {
      tries: 1
    }
  }]
...
var famwtQuest = {
  ...
  tasks: [{
    ...
    outfit: {
      modifier: "familiar weight, switch left-hand man, ".concat(have(template_string_$item(famwt_templateObject21 || (famwt_templateObject21 = famwt_taggedTemplateLiteral(["overloaded Yule battery"])))) ? "switch Mini-Trainbot," : "", " switch ").concat(bestFam)
    },
    limit: {
      tries: 1
    },
    effects: [template_string_$effect(famwt_templateObject22 || (famwt_templateObject22 = famwt_taggedTemplateLiteral(["Empathy"]))), template_string_$effect(famwt_templateObject23 || (famwt_templateObject23 = famwt_taggedTemplateLiteral(["Blood Bond"]))), template_string_$effect(famwt_templateObject24 || (famwt_templateObject24 = famwt_taggedTemplateLiteral(["Leash of Linguini"])))]
  }]
};
...
var levellingQuest = {
  ...
  tasks: [loss, {
    ...
    effects: [(0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject86 || (_templateObject86 = levelling_taggedTemplateLiteral(["Sauceror"]))) ? template_string_$effect(_templateObject87 || (_templateObject87 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"]))) : template_string_$effect(_templateObject88 || (_templateObject88 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))]
  }, {
    ...
    completed: () => !have(template_string_$effect(_templateObject163 || (_templateObject163 = levelling_taggedTemplateLiteral(["[1457]Blood Sugar Sauce Magic"])))) && !have(template_string_$effect(_templateObject164 || (_templateObject164 = levelling_taggedTemplateLiteral(["[1458]Blood Sugar Sauce Magic"])))),
    ...
    outfit: () => oomfieOutfit({
      offhandOverride: template_string_$item(_templateObject169 || (_templateObject169 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().macro(Macro.ifHolidayWanderer(Macro.attack().repeat()).trySkill(template_string_$skill(_templateObject170 || (_templateObject170 = levelling_taggedTemplateLiteral(["Feel Envy"])))).attack().repeat())
  }, {
    name: "Oliver's Place (Nanorhino)",
    completed: () => property_get("_speakeasyFreeFights") >= 3 || !have(template_string_$familiar(_templateObject171 || (_templateObject171 = levelling_taggedTemplateLiteral(["Nanorhino"])))) || [template_string_$effect(_templateObject172 || (_templateObject172 = levelling_taggedTemplateLiteral(["Nanobrawny"]))), template_string_$effect(_templateObject173 || (_templateObject173 = levelling_taggedTemplateLiteral(["Nanobrainy"])))].some(ef => have(ef)) || args.fam,
    do: () => $location(_templateObject174 || (_templateObject174 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit({
    ...
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject176 || (_templateObject176 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject177 || (_templateObject177 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"])))).attack().repeat())
  }, {
    name: "Oliver's Place",
    completed: () => property_get("_speakeasyFreeFights") === 3,
    do: $location(_templateObject178 || (_templateObject178 = levelling_taggedTemplateLiteral(["An Unusually Quiet Barroom Brawl"]))),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject179 || (_templateObject179 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Pick up a club!",
    completed: () => args.fam || have(template_string_$item(_templateObject180 || (_templateObject180 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject181 || (_templateObject181 = levelling_taggedTemplateLiteral(["seal-clubbing club"]))))
  }, {
    name: "Seal Fights - Sweet and Red",
    completed: () => !have(template_string_$skill(_templateObject182 || (_templateObject182 = levelling_taggedTemplateLiteral(["Just the Facts"])))) || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject183 || (_templateObject183 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5 || have(template_string_$effect(_templateObject184 || (_templateObject184 = levelling_taggedTemplateLiteral(["Sweet and Red"])))),
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject185 || (_templateObject185 = levelling_taggedTemplateLiteral(["figurine of a cute baby seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(5, template_string_$item(_templateObject186 || (_templateObject186 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject187 || (_templateObject187 = levelling_taggedTemplateLiteral(["figurine of a cute baby seal"]))));
    },
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject188 || (_templateObject188 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject189 || (_templateObject189 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Seal Fights - Scrolls!",
    completed: () => !have(template_string_$skill(_templateObject190 || (_templateObject190 = levelling_taggedTemplateLiteral(["Just the Facts"])))) || (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject191 || (_templateObject191 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject192 || (_templateObject192 = levelling_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject193 || (_templateObject193 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject194 || (_templateObject194 = levelling_taggedTemplateLiteral(["figurine of a wretched-looking seal"]))));
    },
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject195 || (_templateObject195 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject196 || (_templateObject196 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Seal Fights",
    completed: () => (0,external_kolmafia_namespaceObject.myClass)() !== $class(_templateObject197 || (_templateObject197 = levelling_taggedTemplateLiteral(["Seal Clubber"]))) || property_get("_sealsSummoned") >= 5,
    do: () => {
      (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(_templateObject198 || (_templateObject198 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
      (0,external_kolmafia_namespaceObject.retrieveItem)(3, template_string_$item(_templateObject199 || (_templateObject199 = levelling_taggedTemplateLiteral(["seal-blubber candle"]))));
      (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject200 || (_templateObject200 = levelling_taggedTemplateLiteral(["figurine of an ancient seal"]))));
    },
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject201 || (_templateObject201 = levelling_taggedTemplateLiteral(["seal-clubbing club"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject202 || (_templateObject202 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Get Payphone Quest",
    completed: () => property_get("_shadowAffinityToday"),
    do: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(_templateObject203 || (_templateObject203 = levelling_taggedTemplateLiteral(["closed-circuit pay phone"])))),
    choices: {
      1497: 1
    }
  }, {
    name: "Payphone Freefights (extingo)",
    ready: () => have(template_string_$effect(_templateObject204 || (_templateObject204 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject205 || (_templateObject205 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("_fireExtinguisherCharge") <= 10,
    do: shadowRiftChoice,
    outfit: () => oomfieOutfit({
      weaponOverride: template_string_$item(_templateObject206 || (_templateObject206 = levelling_taggedTemplateLiteral(["industrial fire extinguisher"]))),
      modesOverride: {
        umbrella: "broken"
      }
    }),
    combat: new CombatStrategy().autoattack(() => customMacro.if_(shadowRiftPocketTarget(), customMacro.polarpocket(9 - (100 - property_get("_fireExtinguisherCharge")) / 10).trySkill(template_string_$skill(_templateObject207 || (_templateObject207 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).trySkill(template_string_$skill(_templateObject208 || (_templateObject208 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject209 || (_templateObject209 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).attack().repeat())
  }, {
    name: "Payphone Freefights (cleaver)",
    ready: () => have(template_string_$effect(_templateObject210 || (_templateObject210 = levelling_taggedTemplateLiteral(["Shadow Affinity"])))),
    completed: () => property_get("encountersUntilSRChoice") === 0 || have(template_string_$item(_templateObject211 || (_templateObject211 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit(),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject212 || (_templateObject212 = levelling_taggedTemplateLiteral(["Sing Along"])))).if_(shadowRiftPocketTarget(), Macro.trySkill(template_string_$skill(_templateObject213 || (_templateObject213 = levelling_taggedTemplateLiteral(["Perpetrate Mild Evil"]))))).trySkill(template_string_$skill(_templateObject214 || (_templateObject214 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).attack().repeat())
  }, {
    ...
    completed: () => have(template_string_$item(_templateObject215 || (_templateObject215 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))) || property_get("questRufus") === "step1",
    do: () => shadowRiftChoice(),
    outfit: () => oomfieOutfit({
      familiarOverride: template_string_$familiar(_templateObject216 || (_templateObject216 = levelling_taggedTemplateLiteral(["Machine Elf"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.if_($monster(_templateObject217 || (_templateObject217 = levelling_taggedTemplateLiteral(["shadow matrix"]))), Macro.trySkill(template_string_$skill(_templateObject218 || (_templateObject218 = levelling_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkillRepeat(template_string_$skill(_templateObject219 || (_templateObject219 = levelling_taggedTemplateLiteral(["Saucegeyser"]))))).trySkillRepeat(template_string_$skill(_templateObject220 || (_templateObject220 = levelling_taggedTemplateLiteral(["Northern Explosion"])))))
  }, {
    name: "Retrieve Spooky Lodestone",
    ready: () => property_get("questRufus") === "step1",
    completed: () => have(template_string_$item(_templateObject221 || (_templateObject221 = levelling_taggedTemplateLiteral(["Rufus's shadow lodestone"])))),
    ...
    completed: () => property_get("snojoSetting") === $stat(_templateObject223 || (_templateObject223 = levelling_taggedTemplateLiteral(["Moxie"]))),
    do: () => {
    ...
    do: $location(_templateObject224 || (_templateObject224 = levelling_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject225 || (_templateObject225 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject226 || (_templateObject226 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject227 || (_templateObject227 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Visit Hottub",
    completed: () => [template_string_$effect(_templateObject228 || (_templateObject228 = levelling_taggedTemplateLiteral(["Snowballed"]))), template_string_$effect(_templateObject229 || (_templateObject229 = levelling_taggedTemplateLiteral(["Bruised"]))), template_string_$effect(_templateObject230 || (_templateObject230 = levelling_taggedTemplateLiteral(["Relaxed Muscles"]))), template_string_$effect(_templateObject231 || (_templateObject231 = levelling_taggedTemplateLiteral(["Hypnotized"]))), template_string_$effect(_templateObject232 || (_templateObject232 = levelling_taggedTemplateLiteral(["Bad Haircut"])))].every(ef => !have(ef)),
    ...
    do: () => fightPiece($monster(_templateObject233 || (_templateObject233 = levelling_taggedTemplateLiteral(["Witchess Bishop"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject234 || (_templateObject234 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject235 || (_templateObject235 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject236 || (_templateObject236 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Deep Machine Fights",
    completed: () => args.fam && args.familiar !== template_string_$familiar(_templateObject237 || (_templateObject237 = levelling_taggedTemplateLiteral(["Machine Elf"]))) || property_get("_machineTunnelsAdv") >= 5,
    do: () => $location(_templateObject238 || (_templateObject238 = levelling_taggedTemplateLiteral(["The Deep Machine Tunnels"]))),
    outfit: {
      offhand: template_string_$item(_templateObject239 || (_templateObject239 = levelling_taggedTemplateLiteral(["unbreakable umbrella"]))),
      familiar: template_string_$familiar(_templateObject240 || (_templateObject240 = levelling_taggedTemplateLiteral(["Machine Elf"]))),
      famequip: template_string_$item(_templateObject241 || (_templateObject241 = levelling_taggedTemplateLiteral(["tiny stillsuit"]))),
      modes: {
        umbrella: "broken"
      }
    },
    combat: new CombatStrategy().autoattack(() => Macro.externalIf(property_get("lastCopyableMonster") === $monster(_templateObject242 || (_templateObject242 = levelling_taggedTemplateLiteral(["Witchess Bishop"]))), Macro.trySkill(template_string_$skill(_templateObject243 || (_templateObject243 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).if_($monster(_templateObject244 || (_templateObject244 = levelling_taggedTemplateLiteral(["Perceiver of Sensations"]))), Macro.tryItem(template_string_$item(_templateObject245 || (_templateObject245 = levelling_taggedTemplateLiteral(["abstraction: thought"]))))).if_($monster(_templateObject246 || (_templateObject246 = levelling_taggedTemplateLiteral(["Thinker of Thoughts"]))), Macro.tryItem(template_string_$item(_templateObject247 || (_templateObject247 = levelling_taggedTemplateLiteral(["abstraction: action"]))))).trySkill(template_string_$skill(_templateObject248 || (_templateObject248 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat())
  }, {
    name: "Neverending Free Fights",
    completed: () => property_get("_neverendingPartyFreeTurns") >= 10,
    do: $location(_templateObject249 || (_templateObject249 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(() => Macro.trySkill(template_string_$skill(_templateObject250 || (_templateObject250 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject251 || (_templateObject251 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).externalIf(property_get("lastCopyableMonster") === $monster(_templateObject252 || (_templateObject252 = levelling_taggedTemplateLiteral(["sausage goblin"]))), Macro.trySkill(template_string_$skill(_templateObject253 || (_templateObject253 = levelling_taggedTemplateLiteral(["Feel Nostalgic"]))))).trySkill(template_string_$skill(_templateObject254 || (_templateObject254 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject255 || (_templateObject255 = levelling_taggedTemplateLiteral(["Recall Facts: %phylum Circadian Rhythms"])))).trySkillRepeat(template_string_$skill(_templateObject256 || (_templateObject256 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
    ...
    name: "Witchess Witch",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject258 || (_templateObject258 = levelling_taggedTemplateLiteral(["battle broom"])))),
    do: () => fightPiece($monster(_templateObject259 || (_templateObject259 = levelling_taggedTemplateLiteral(["Witchess Witch"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject260 || (_templateObject260 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject261 || (_templateObject261 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkillRepeat(template_string_$skill(_templateObject262 || (_templateObject262 = levelling_taggedTemplateLiteral(["Lunging Thrust-Smack"]))))),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject263 || (_templateObject263 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Witchess Queen",
    prepare: () => (0,external_kolmafia_namespaceObject.restoreHp)((0,external_kolmafia_namespaceObject.myMaxhp)()),
    completed: () => have(template_string_$item(_templateObject264 || (_templateObject264 = levelling_taggedTemplateLiteral(["very pointy crown"])))) || fightsDone() >= 5,
    do: () => fightPiece($monster(_templateObject265 || (_templateObject265 = levelling_taggedTemplateLiteral(["Witchess Queen"])))),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject266 || (_templateObject266 = levelling_taggedTemplateLiteral(["Sing Along"])))).attack().repeat()),
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject267 || (_templateObject267 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"])))
    })
  }, {
    name: "Shattering Punches",
    completed: () => property_get("_shatteringPunchUsed") >= 3,
    do: $location(_templateObject268 || (_templateObject268 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: () => oomfieOutfit({
      shirtOverride: template_string_$item(_templateObject269 || (_templateObject269 = levelling_taggedTemplateLiteral(["makeshift garbage shirt"]))),
      weaponOverride: have(template_string_$item(_templateObject270 || (_templateObject270 = levelling_taggedTemplateLiteral(["fish hatchet"])))) ? template_string_$item(_templateObject271 || (_templateObject271 = levelling_taggedTemplateLiteral(["fish hatchet"]))) : template_string_$item(_templateObject272 || (_templateObject272 = levelling_taggedTemplateLiteral(["June cleaver"]))),
      acc2Override: template_string_$item(_templateObject273 || (_templateObject273 = levelling_taggedTemplateLiteral(["Cincho de Mayo"]))),
      modesOverride: {
        umbrella: "broken",
        backupcamera: "ml"
      }
    }),
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject274 || (_templateObject274 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject275 || (_templateObject275 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject276 || (_templateObject276 = levelling_taggedTemplateLiteral(["Feel Pride"])))).trySkill(template_string_$skill(_templateObject277 || (_templateObject277 = levelling_taggedTemplateLiteral(["Cincho: Confetti Extravaganza"])))).trySkill(template_string_$skill(_templateObject278 || (_templateObject278 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject279 || (_templateObject279 = levelling_taggedTemplateLiteral(["Shattering Punch"])))).abort())
  }, {
    name: "Chest X-rays",
    completed: () => property_get("_chestXRayUsed") >= 3,
    do: $location(_templateObject280 || (_templateObject280 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    ...
    outfit: {
      acc2: template_string_$item(_templateObject281 || (_templateObject281 = levelling_taggedTemplateLiteral(["Lil' Doctor\u2122 bag"])))
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject282 || (_templateObject282 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject283 || (_templateObject283 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject284 || (_templateObject284 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject285 || (_templateObject285 = levelling_taggedTemplateLiteral(["Chest X-Ray"])))).abort())
  }, {
    name: "Mob-Hit",
    completed: () => property_get("_gingerbreadMobHitUsed"),
    do: $location(_templateObject286 || (_templateObject286 = levelling_taggedTemplateLiteral(["The Neverending Party"]))),
    choices: {
      1322: 2,
      1324: 5,
      1326: 2
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(_templateObject287 || (_templateObject287 = levelling_taggedTemplateLiteral(["%fn, spit on me!"])))).trySkill(template_string_$skill(_templateObject288 || (_templateObject288 = levelling_taggedTemplateLiteral(["Bowl Sideways"])))).trySkill(template_string_$skill(_templateObject289 || (_templateObject289 = levelling_taggedTemplateLiteral(["Sing Along"])))).trySkill(template_string_$skill(_templateObject290 || (_templateObject290 = levelling_taggedTemplateLiteral(["Gingerbread Mob Hit"])))).abort())
  }]
};
...
var noncombatQuest = {
  ...
  tasks: [{
    ...
    outfit: () => ({
      hat: have(template_string_$item(noncombat_templateObject11 || (noncombat_templateObject11 = noncombat_taggedTemplateLiteral(["very pointy crown"])))) ? template_string_$item(noncombat_templateObject12 || (noncombat_templateObject12 = noncombat_taggedTemplateLiteral(["very pointy crown"]))) : undefined,
      offhand: template_string_$item(noncombat_templateObject13 || (noncombat_templateObject13 = noncombat_taggedTemplateLiteral(["unbreakable umbrella"]))),
    ...
    name: "Silent Running",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(noncombat_templateObject20 || (noncombat_templateObject20 = noncombat_taggedTemplateLiteral(["Silent Running"])))) || property_get("_olympicSwimmingPool") || CommunityService.Noncombat.actualCost() === 1,
...
var runStartQuest = {
  ...
  tasks: [loss, {
    ...
    outfit: {
      offhand: template_string_$item(preSkeletons_templateObject36 || (preSkeletons_templateObject36 = preSkeletons_taggedTemplateLiteral(["familiar scrapbook"])))
    },
    choices: {
      1334: 2,
      1336: 1
    ...
    prepare: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(preSkeletons_templateObject37 || (preSkeletons_templateObject37 = preSkeletons_taggedTemplateLiteral(["model train set"])))),
    completed: () => (0,external_kolmafia_namespaceObject.getWorkshed)() === template_string_$item(preSkeletons_templateObject38 || (preSkeletons_templateObject38 = preSkeletons_taggedTemplateLiteral(["model train set"]))) && property_get("trainsetConfiguration") !== "",
...
var sdmgQuest = {
  ...
  tasks: [{
    ...
    do: () => (0,external_kolmafia_namespaceObject.myBasestat)($stat(sdmg_templateObject6 || (sdmg_templateObject6 = sdmg_taggedTemplateLiteral(["Mysticality"])))) >= 125 ? (0,external_kolmafia_namespaceObject.takeStorage)(1, template_string_$item(sdmg_templateObject7 || (sdmg_templateObject7 = sdmg_taggedTemplateLiteral(["Staff of Simmering Hatred"])))) : (0,external_kolmafia_namespaceObject.takeStorage)(1, template_string_$item(sdmg_templateObject8 || (sdmg_templateObject8 = sdmg_taggedTemplateLiteral(["tobiko marble soda"]))))
  }, {
    ...
    completed: () => have(template_string_$item(sdmg_templateObject12 || (sdmg_templateObject12 = sdmg_taggedTemplateLiteral(["Staff of Simmering Hatred"])))) || have(template_string_$item(sdmg_templateObject13 || (sdmg_templateObject13 = sdmg_taggedTemplateLiteral(["obsidian nutcracker"])))),
    do: () => (0,external_kolmafia_namespaceObject.retrieveItem)(1, template_string_$item(sdmg_templateObject14 || (sdmg_templateObject14 = sdmg_taggedTemplateLiteral(["obsidian nutcracker"]))))
  }, {
    name: "Cargo Handsoap!",
    completed: () => property_get("_cargoPocketEmptied") || have(template_string_$item(sdmg_templateObject15 || (sdmg_templateObject15 = sdmg_taggedTemplateLiteral(["Yeg's Motel hand soap"])))) || have(template_string_$effect(sdmg_templateObject16 || (sdmg_templateObject16 = sdmg_taggedTemplateLiteral(["Sigils of Yeg"])))),
    do: () => (0,external_kolmafia_namespaceObject.cliExecute)("cargo 177"),
    post: () => (0,external_kolmafia_namespaceObject.use)(1, template_string_$item(sdmg_templateObject17 || (sdmg_templateObject17 = sdmg_taggedTemplateLiteral(["Yeg's Motel hand soap"]))))
  }, {
    name: "Inner Elf",
    prepare: () => Clan.join("Beldungeon"),
    completed: () => args.fam || !have(template_string_$familiar(sdmg_templateObject18 || (sdmg_templateObject18 = sdmg_taggedTemplateLiteral(["Machine Elf"])))) || have(template_string_$effect(sdmg_templateObject19 || (sdmg_templateObject19 = sdmg_taggedTemplateLiteral(["Inner Elf"])))) || property_get("_snokebombUsed") >= 3,
    do: $location(sdmg_templateObject20 || (sdmg_templateObject20 = sdmg_taggedTemplateLiteral(["The Slime Tube"]))),
    outfit: {
      familiar: template_string_$familiar(sdmg_templateObject21 || (sdmg_templateObject21 = sdmg_taggedTemplateLiteral(["Machine Elf"])))
    },
    choices: {
      326: 1
    },
    combat: new CombatStrategy().autoattack(Macro.trySkill(template_string_$skill(sdmg_templateObject22 || (sdmg_templateObject22 = sdmg_taggedTemplateLiteral(["Snokebomb"])))).abort())
  }, {
    name: "Spell Damage Poolbuff",
    prepare: () => Clan.join("Bonus Adventures from Hell"),
    completed: () => have(template_string_$effect(sdmg_templateObject23 || (sdmg_templateObject23 = sdmg_taggedTemplateLiteral(["Mental A-cue-ity"])))),
    ...
    effects: [template_string_$effect(sdmg_templateObject24 || (sdmg_templateObject24 = sdmg_taggedTemplateLiteral(["Song of Sauce"]))), template_string_$effect(sdmg_templateObject25 || (sdmg_templateObject25 = sdmg_taggedTemplateLiteral(["Carol of the Hells"]))), template_string_$effect(sdmg_templateObject26 || (sdmg_templateObject26 = sdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), template_string_$effect(sdmg_templateObject27 || (sdmg_templateObject27 = sdmg_taggedTemplateLiteral(["Arched Eyebrow of the Archmage"])))],
    limit: {
      tries: 1
    }
  }]
...
var wdmgQuest = {
  ...
  tasks: [{
    ...
    effects: [template_string_$effect(wdmg_templateObject20 || (wdmg_templateObject20 = wdmg_taggedTemplateLiteral(["Bow-Legged Swagger"]))), template_string_$effect(wdmg_templateObject21 || (wdmg_templateObject21 = wdmg_taggedTemplateLiteral(["Scowl of the Auk"]))), template_string_$effect(wdmg_templateObject22 || (wdmg_templateObject22 = wdmg_taggedTemplateLiteral(["Rage of the Reindeer"]))), template_string_$effect(wdmg_templateObject23 || (wdmg_templateObject23 = wdmg_taggedTemplateLiteral(["Song of the North"]))), template_string_$effect(wdmg_templateObject24 || (wdmg_templateObject24 = wdmg_taggedTemplateLiteral(["Carol of the Bulls"]))), template_string_$effect(wdmg_templateObject25 || (wdmg_templateObject25 = wdmg_taggedTemplateLiteral(["Tenacity of the Snapper"]))), template_string_$effect(wdmg_templateObject26 || (wdmg_templateObject26 = wdmg_taggedTemplateLiteral(["Jackasses' Symphony of Destruction"]))), (0,external_kolmafia_namespaceObject.myClass)() === $class(wdmg_templateObject27 || (wdmg_templateObject27 = wdmg_taggedTemplateLiteral(["Turtle Tamer"]))) ? template_string_$effect(wdmg_templateObject28 || (wdmg_templateObject28 = wdmg_taggedTemplateLiteral(["Blessing of the War Snapper"]))) : template_string_$effect(wdmg_templateObject29 || (wdmg_templateObject29 = wdmg_taggedTemplateLiteral(["Disdain of the War Snapper"])))],
    limit: {
      tries: 1
    }
  }]
